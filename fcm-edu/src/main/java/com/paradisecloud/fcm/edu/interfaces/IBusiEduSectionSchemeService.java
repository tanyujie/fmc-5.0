...
/**
 * 课程节次方案，每个季节都可能有不同的节次方案Service接口
 * 
 * @author lilinhai
 * @date 2021-10-10
 */
public interface IBusiEduSectionSchemeService 
{
    /**
     ...
     */
    BusiEduSectionScheme selectBusiEduSectionSchemeById(Long id);
    
    List<BusiEduSectionScheme> getEduSectionSchemeByDept(Long deptId);
