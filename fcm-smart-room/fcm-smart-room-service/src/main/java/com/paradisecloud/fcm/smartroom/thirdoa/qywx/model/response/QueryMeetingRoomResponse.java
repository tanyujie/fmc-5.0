 ...
 * @author admin
 */
public class QueryMeetingRoomResponse extends CommonResponse {

    private List<MeetingroomListDTO> meetingroom_list;

    public List<MeetingroomListDTO> getMeetingroom_list() {
        return meetingroom_list;
    }

    public void setMeetingroom_list(List<MeetingroomListDTO> meetingroom_list) {
        this.meetingroom_list = meetingroom_list;
    }

    public static class MeetingroomListDTO {
        ...
        public void setNeed_approval(int need_approval) {
