...
public class UpdateDoorplateForMeetingRoomBookTask extends Task {

    private long meetingRoomId;

    public UpdateDoorplateForMeetingRoomBookTask(String id, long delayInMilliseconds, long meetingRoomId) {
