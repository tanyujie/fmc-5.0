 ...
 * @author admin
 */
public class OpsRestartTask extends Task {


    private static final Logger log = LoggerFactory.getLogger(OpsRestartTask.class);
    private String ip;

    public OpsRestartTask(String id, long delayInMilliseconds, String ip) {
