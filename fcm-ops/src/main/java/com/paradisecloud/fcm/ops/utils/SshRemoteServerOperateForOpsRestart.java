 ...
 * 只用于MTR探测
 */
public abstract class SshRemoteServerOperateForOpsRestart
{
	private static final Logger LOGGER = LoggerFactory.getLogger(SshRemoteServerOperateForOpsRestart.class);
	private Session session;// JSCH session
	private boolean logined = false;// 是否登陆

	private static final SshRemoteServerOperateForOpsRestart INSTANCE = new SshRemoteServerOperateForOpsRestart()
	{

	};

	public static SshRemoteServerOperateForOpsRestart getInstance()
	{
		return INSTANCE;
	}
