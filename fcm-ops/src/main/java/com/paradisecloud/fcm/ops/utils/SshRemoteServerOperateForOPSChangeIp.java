 ...
 * 只用于MTR探测
 */
public abstract class SshRemoteServerOperateForOPSChangeIp
{
	private static final Logger LOGGER = LoggerFactory.getLogger(SshRemoteServerOperateForOPSChangeIp.class);
	private Session session;// JSCH session
	private boolean logined = false;// 是否登陆

	private static final SshRemoteServerOperateForOPSChangeIp INSTANCE = new SshRemoteServerOperateForOPSChangeIp()
	{

	};

	public static SshRemoteServerOperateForOPSChangeIp getInstance()
	{
		return INSTANCE;
	}
