...
/**
 * 轮询方案对象 busi_template_polling_scheme
 * 
 * @author lilinhai
 * @date 2021-09-09
 */
@Schema(description = "轮询方案")
public class BusiTemplatePollingScheme extends BaseEntity
{
    ...
    /** 是否固定显示(1是，2否) */
    @Schema(description = "是否固定显示(1是，2否)")
    @Excel(name = "是否固定显示(1是，2否)")
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("isFill", getIsFill()).append("isFixSelf", getIsFixSelf())
            .toString();
    }
}