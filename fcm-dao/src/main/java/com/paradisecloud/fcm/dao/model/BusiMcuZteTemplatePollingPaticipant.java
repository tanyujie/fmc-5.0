...
/**
 * 中兴MCU轮询方案的参会者对象 busi_mcu_zte_template_polling_paticipant
 * 
 * @author lilinhai
 * @date 2024-04-09
 */
@Schema(description = "中兴MCU轮询方案的参会者")
public class BusiMcuZteTemplatePollingPaticipant extends BaseEntity
{
