...
/**
 * SMC3.0MCU默认视图的部门显示顺序对象 busi_mcu_smc3_template_conference_default_view_dept
 * 
 * @author lilinhai
 * @date 2023-09-19
 */
@Schema(description = "SMC3.0MCU默认视图的部门显示顺序")
public class BusiMcuTencentTemplateConferenceDefaultViewDept extends BaseEntity
{
