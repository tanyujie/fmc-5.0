...
/**
 * SMC3.0MCU会议预约记录对象 busi_mcu_smc3_conference_appointment
 * 
 * @author lilinhai
 * @date 2023-09-19
 */
@Schema(description = "SMC3.0MCU会议预约记录")
public class BusiMcuHwcloudConferenceAppointment extends  BusiConferenceAppointment
{
    ...
    /** 房间预约ID */
    @Schema(description = "房间预约ID")
    @Excel(name = "房间预约ID")
    private Long roomBookId;

    /** OPS的ID(云端使用) */
    @Schema(description = "OPS的ID(云端使用)")
    @Excel(name = "OPS的ID(云端使用)")
    private Long opsId;

    /** 是否云会议(ops端使用) */
    @Schema(description = "是否云会议(ops端使用)")
    @Excel(name = "是否云会议(ops端使用)")
    private Integer isCloudConference;

    /** 云会议ID(ops端使用) */
    @Schema(description = "云会议ID(ops端使用)")
    @Excel(name = "云会议ID(ops端使用)")
    private String cloudConferenceId;
    ...
    public Integer getIsCloudConference() {
        return isCloudConference;
    }

    public void setIsCloudConference(Integer isCloudConference) {
        this.isCloudConference = isCloudConference;
    }

    public String getCloudConferenceId() {
        return cloudConferenceId;
    }

    public void setCloudConferenceId(String cloudConferenceId) {
        this.cloudConferenceId = cloudConferenceId;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("roomBookId", getRoomBookId())
            .append("opsId", getOpsId())
            .append("isCloudConference", getIsCloudConference())
            .append("cloudConferenceId", getCloudConferenceId())
            .toString();
    }
}
