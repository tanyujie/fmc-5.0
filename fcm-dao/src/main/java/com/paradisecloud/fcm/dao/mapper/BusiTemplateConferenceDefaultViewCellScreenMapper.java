 ...
 * @date 2021-04-08
 */
public interface BusiTemplateConferenceDefaultViewCellScreenMapper 
{
    /**
     * 查询默认视图下指定的多分频单元格
     * 
     ...
     * @return int
     */
    public int deleteBusiTemplateConferenceDefaultViewCellScreenByTemplateConferenceId(Long conferenceTemplateId);
