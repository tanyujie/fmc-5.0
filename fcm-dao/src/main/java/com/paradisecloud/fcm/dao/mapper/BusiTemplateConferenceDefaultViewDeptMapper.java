 ...
 * @date 2021-04-08
 */
public interface BusiTemplateConferenceDefaultViewDeptMapper 
{
    /**
     * 查询默认视图的部门显示顺序
     * 
     ...
     * @return int
     */
    public int deleteBusiTemplateConferenceDefaultViewDeptByTemplateConferenceId(Long templateConferenceId);
    
    int deleteBusiTemplateConferenceDefaultViewDeptByTemplateConferenceIdAndDeptId(@Param("templateConferenceId") Long templateConferenceId, @Param("deptId") Long deptId);
