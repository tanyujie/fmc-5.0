...
/**
 * SMC3.0MCU会议模板的参会者对象 busi_mcu_smc3_template_participant
 * 
 * @author lilinhai
 * @date 2023-09-19
 */
@Schema(description = "SMC3.0MCU会议模板的参会者")
public class BusiMcuTencentTemplateParticipant extends BaseEntity
{
