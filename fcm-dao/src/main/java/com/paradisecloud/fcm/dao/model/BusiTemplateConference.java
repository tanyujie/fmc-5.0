...
/**
 * 会议模板对象 busi_template_conference
 * 
 * @author lilinhai
 * @date 2021-10-25
 */
@Schema(description = "会议模板")
public class BusiTemplateConference extends BaseEntity
{
    ...
    @Excel(name = "入会方案配置ID", readConverterExp = "关=联FME里面的入会方案记录ID，会控端不存")
    ...
    /** 是否启用会议纪要：1是，2否 */
    @Schema(description = "是否启用会议纪要：1是，2否")
    @Excel(name = "是否启用会议纪要：1是，2否")
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("conferenceMode", getConferenceMode())
            .append("minutesEnabled", getMinutesEnabled())
            .toString();
    }
}