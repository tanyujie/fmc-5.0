...
/**
 * SMC3.0MCU轮询方案的部门对象 busi_mcu_smc3_template_polling_dept
 * 
 * @author lilinhai
 * @date 2023-09-19
 */
@Schema(description = "SMC3.0MCU轮询方案的部门")
public class BusiMcuTencentTemplatePollingDept extends BaseEntity
{
    ...
    /** 部门ID（部门也是FME终端，一种与会者） */
    @Schema(description = "部门ID（部门也是FME终端，一种与会者）")
    @Excel(name = "部门ID", readConverterExp = "部=门也是FME终端，一种与会者")
    private Long deptId;
