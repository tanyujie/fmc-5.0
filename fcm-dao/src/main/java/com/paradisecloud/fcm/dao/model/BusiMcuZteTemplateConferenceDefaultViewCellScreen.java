...
/**
 * 中兴MCU默认视图下指定的多分频单元格对象 busi_mcu_zte_template_conference_default_view_cell_screen
 * 
 * @author lilinhai
 * @date 2024-04-09
 */
@Schema(description = "中兴MCU默认视图下指定的多分频单元格")
public class BusiMcuZteTemplateConferenceDefaultViewCellScreen extends BaseEntity
{
