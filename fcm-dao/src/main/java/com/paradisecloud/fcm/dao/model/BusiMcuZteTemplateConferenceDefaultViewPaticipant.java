...
/**
 * 中兴MCU默认视图的参会者对象 busi_mcu_zte_template_conference_default_view_paticipant
 * 
 * @author lilinhai
 * @date 2024-04-09
 */
@Schema(description = "中兴MCU默认视图的参会者")
public class BusiMcuZteTemplateConferenceDefaultViewPaticipant extends BaseEntity
{
