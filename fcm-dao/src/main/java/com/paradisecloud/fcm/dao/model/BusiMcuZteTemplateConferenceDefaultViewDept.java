...
/**
 * 中兴MCU默认视图的部门显示顺序对象 busi_mcu_zte_template_conference_default_view_dept
 * 
 * @author lilinhai
 * @date 2024-04-09
 */
@Schema(description = "中兴MCU默认视图的部门显示顺序")
public class BusiMcuZteTemplateConferenceDefaultViewDept extends BaseEntity
{
