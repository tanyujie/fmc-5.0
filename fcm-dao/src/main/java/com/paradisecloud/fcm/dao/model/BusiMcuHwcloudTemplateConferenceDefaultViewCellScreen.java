...
/**
 * SMC3.0MCU默认视图下指定的多分频单元格对象 busi_mcu_smc3_template_conference_default_view_cell_screen
 * 
 * @author lilinhai
 * @date 2023-09-19
 */
@Schema(description = "SMC3.0MCU默认视图下指定的多分频单元格")
public class BusiMcuHwcloudTemplateConferenceDefaultViewCellScreen extends BaseEntity
{
