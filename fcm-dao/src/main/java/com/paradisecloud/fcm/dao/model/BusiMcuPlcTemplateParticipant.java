...
/**
 * 宝利通MCU会议模板的参会者对象 busi_mcu_plc_template_participant
 * 
 * @author lilinhai
 * @date 2021-11-19
 */
@Schema(description = "宝利通MCU会议模板的参会者")
public class BusiMcuPlcTemplateParticipant extends BaseEntity
{
    ...
    /** 参会类型：1入会，2直播 */
    @Schema(description = "参会类型：1入会，2直播")
    @Excel(name = "参会类型：1入会，2直播")
