...
/**
 * 默认视图下指定的多分频单元格对象 busi_mcu_plc_template_conference_default_view_cell_screen
 * 
 * @author lilinhai
 * @date 2021-04-08
 */
@Schema(description = "默认视图下指定的多分频单元格")
public class BusiMcuPlcTemplateConferenceDefaultViewCellScreen extends BaseEntity
{
