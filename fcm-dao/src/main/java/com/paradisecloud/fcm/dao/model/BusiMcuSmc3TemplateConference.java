...
public class BusiMcuSmc3TemplateConference extends BaseEntity
{
    ...
    @Excel(name = "预设画面")
    private  Map<String,Object> confPresetParam;
    ...
    /** 接入号 */
    @Schema(description = "接入号")
    @Excel(name = "接入号")
    private String tenantId;

    /** 多级会议ID */
    @Schema(description = "多级会议ID")
    @Excel(name = "多级会议ID")
    private String cascadeId;

    /** 多级会议节点 */
    @Schema(description = "多级会议节点")
    @Excel(name = "多级会议节点")
    private String cascadeNodes;

    /** 多级会议类型 */
    @Schema(description = "多级会议类型")
    @Excel(name = "多级会议类型")
    private String category;

    /** 多级会议节点（临时） */
    @Schema(description = "多级会议节点（临时）")
    @Excel(name = "多级会议节点（临时）")
    private String cascadeNodesTemp;
    ...
    public Map<String, Object> getConfPresetParam() {
        return confPresetParam;
    }

    public void setConfPresetParam(Map<String, Object> confPresetParam) {
    ...
    public String getCascadeNodes() {
        return cascadeNodes;
    }

    public void setCascadeNodes(String cascadeNodes) {
    ...
    public String getCascadeNodesTemp() {
        return cascadeNodesTemp;
    }

    public void setCascadeNodesTemp(String cascadeNodesTemp) {
        this.cascadeNodesTemp = cascadeNodesTemp;
    }

    @Override
    public String toString() {
        return "BusiMcuSmc3TemplateConference{" +
                "id=" + id +
                ", createUserId=" + createUserId +
                ", createUserName='" + createUserName + '\'' +
                ", name='" + name + '\'' +
                ", deptId=" + deptId +
                ", callLegProfileId='" + callLegProfileId + '\'' +
                ", callProfileId='" + callProfileId + '\'' +
                ", callBrandingProfileId='" + callBrandingProfileId + '\'' +
                ", streamUrl='" + streamUrl + '\'' +
                ...
                ", isAutoCreateConferenceNumber=" + isAutoCreateConferenceNumber +
                ", createType=" + createType +
                ", type=" + type +
                ", viewType=" + viewType +
                ", conferenceNumber=" + conferenceNumber +
                ", masterParticipantId=" + masterParticipantId +
                ", defaultViewLayout='" + defaultViewLayout + '\'' +
                ", defaultViewIsBroadcast=" + defaultViewIsBroadcast +
                ", defaultViewIsDisplaySelf=" + defaultViewIsDisplaySelf +
                ", defaultViewIsFill=" + defaultViewIsFill +
                ", pollingInterval=" + pollingInterval +
                ", conferencePassword='" + conferencePassword + '\'' +
                ", remarks='" + remarks + '\'' +
                ", cover='" + cover + '\'' +
                ", businessFieldType=" + businessFieldType +
                ", businessProperties=" + businessProperties +
                ", durationEnabled=" + durationEnabled +
                ", durationTime=" + durationTime +
                ", conferenceCtrlPassword='" + conferenceCtrlPassword + '\'' +
                ", lastConferenceId='" + lastConferenceId + '\'' +
                ", muteType=" + muteType +
                ", isAutoCreateStreamUrl=" + isAutoCreateStreamUrl +
                ", presenter=" + presenter +
                ...
                ", confType='" + confType + '\'' +
                ", confPresetParam=" + confPresetParam +
                ", maxParticipantNum=" + maxParticipantNum +
                ", upCascadeType=" + upCascadeType +
                ", upCascadeId=" + upCascadeId +
                ", upCascadeMcuType='" + upCascadeMcuType + '\'' +
                ", upCascadeIndex=" + upCascadeIndex +
                ", tenantId='" + tenantId + '\'' +
                ", cascadeId='" + cascadeId + '\'' +
                ", cascadeNodes='" + cascadeNodes + '\'' +
                ", category='" + category + '\'' +
                ", cascadeNodesTemp='" + cascadeNodesTemp + '\'' +
                '}';
    }
}
