...
/**
 * 紫荆MCU终端信息对象 busi_mcu_zj
 * 
 * @author lilinhai
 * @date 2022-10-10
 */
@Schema(description = "紫荆MCU终端信息")
public class BusiMcuZj extends BaseEntity
{
