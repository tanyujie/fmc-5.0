...
/**
 * 宝利通MCU会议模板对象 busi_mcu_plc_template_conference
 * 
 * @author lilinhai
 * @date 2021-10-25
 */
@Schema(description = "宝利通MCU会议模板")
public class BusiMcuPlcTemplateConference extends BaseEntity
{
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("hdResolution", getHdResolution())
