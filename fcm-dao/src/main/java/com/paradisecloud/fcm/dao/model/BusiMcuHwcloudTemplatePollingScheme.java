...
/**
 * SMC3.0MCU轮询方案对象 busi_mcu_smc3_template_polling_scheme
 * 
 * @author lilinhai
 * @date 2023-09-19
 */
@Schema(description = "SMC3.0MCU轮询方案")
public class BusiMcuHwcloudTemplatePollingScheme extends BaseEntity
{
