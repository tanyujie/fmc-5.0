...
public class McuPlcMuteStatusCheckTask extends DelayTask {

    private McuPlcConferenceContext conferenceContext;

    public McuPlcMuteStatusCheckTask(String id, long delayInMilliseconds, McuPlcConferenceContext conferenceContext) {
    ...
    public void run() {
        if (conferenceContext != null) {
            ...
            if (conferenceContext.getMasterAttendee() != null) {
                AttendeeForMcuPlc attendee = conferenceContext.getMasterAttendee();
