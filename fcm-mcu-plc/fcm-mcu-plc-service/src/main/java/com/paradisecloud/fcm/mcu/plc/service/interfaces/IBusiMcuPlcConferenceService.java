 ...
 * @date 2021-02-02
 */
public interface IBusiMcuPlcConferenceService
{
     ...
     */
    McuPlcConferenceContext buildTemplateConferenceContext(long templateConferenceId);
     ...
     */
    @Transactional
    BusiMcuPlcConferenceAppointment extendMinutes(String conferenceId, int minutes);
     ...
     */
    void stream(McuPlcConferenceContext mainConferenceContext, Boolean streaming, String streamUrl);
