...
public class CmStartMrRequest extends CommonRequest {
    ...
    // 分辨率 hd_720,hd_1080
    private String hdResolution;
    // 传输率 1024(带宽1M),2048(2M)...
    ...
    public void setCtrlPassword(String ctrlPassword) {
     ...
     *                 </MESSAGE_OVERLAY>
     *                 <SITE_NAME>
     *                     <SITE_NAME_DISPLAY_MODE>On</SITE_NAME_DISPLAY_MODE>
     *                     <SITE_NAME_FONT_SIZE>12</SITE_NAME_FONT_SIZE>
     *                     <SITE_NAME_COLOR>white_font_on_black_background</SITE_NAME_COLOR>
     *                     <SITE_NAME_DISPLAY_POSITION>Bottom</SITE_NAME_DISPLAY_POSITION>
     *                     <SITE_NAME_TRANSPARENCE>100</SITE_NAME_TRANSPARENCE>
     *                     <SITE_NAME_HORIZONTAL_POSITION>50</SITE_NAME_HORIZONTAL_POSITION>
     *                     <SITE_NAME_VERTICAL_POSITION>100</SITE_NAME_VERTICAL_POSITION>
     ...
     *                 <!-- <DISPLAY_NAME>Factory_Mix_Video_Profile</DISPLAY_NAME> -->
    ...
    public String buildToXml() {
        ...
        if (StringUtils.isEmpty(ctrlPassword)) {
            ctrlPassword = "";
        }
        String xml = "" +
                "<TRANS_RES_1>" +
                ...
                "<START>" +
                "<RESERVATION>" +
                "<NAME>" + conferenceNum + "</NAME>" +
                "<NUMERIC_ID>" + conferenceNum + "</NUMERIC_ID>" +
                "<DISPLAY_NAME>" + name + "</DISPLAY_NAME>" +
                "<PASSWORD>" + ctrlPassword + "</PASSWORD>" +
                "<CORRELATION_ID></CORRELATION_ID>" +
                "<NETWORK>h323</NETWORK>" +
                "<MEDIA>video_audio</MEDIA>" +
                "<VIDEO_SESSION>continuous_presence</VIDEO_SESSION>" +
                "<VIDEO_PROTOCOL>auto</VIDEO_PROTOCOL>" +
                "<TRANSFER_RATE>" + transferRate + "</TRANSFER_RATE>" +
                "<AUDIO_RATE>auto</AUDIO_RATE>" +
                "<VIDEO_FORMAT>auto</VIDEO_FORMAT>" +
                "<FRAME_RATE>auto</FRAME_RATE>" +
                "<EXTERNAL_IVR_CONTROL>false</EXTERNAL_IVR_CONTROL>" +
                ...
                "<CASCADED_LINKS_NUMBER>0</CASCADED_LINKS_NUMBER>" +
                "</CASCADE>" +
                "<MUTE_PARTIES_IN_LECTURE>" + mute + "</MUTE_PARTIES_IN_LECTURE>" +
                "<MUTE_ALL_PARTIES_AUDIO_EXCEPT_LEADER>false</MUTE_ALL_PARTIES_AUDIO_EXCEPT_LEADER>" +
                "<MUTE_ALL_PARTIES_VIDEO_EXCEPT_LEADER>false</MUTE_ALL_PARTIES_VIDEO_EXCEPT_LEADER>" +
                "<LECTURE_MODE>" +
                "<ON>false</ON>" +
                ...
                "<ENTRY_QUEUE>false</ENTRY_QUEUE>" +
                "<MEET_ME_PER_ENTRY_QUEUE>true</MEET_ME_PER_ENTRY_QUEUE>" +
                "<ENTRY_PASSWORD>" + password + "</ENTRY_PASSWORD>" +
                "<VIDEO_PLUS>true</VIDEO_PLUS>" +
                "<VISUAL_EFFECTS>" +
                "<BACKGROUND_COLOR>" +
                "<RED>0</RED>" +
                ...
                "<ON>false</ON>" +
                "</CONFERENCE_TEMPLATE>" +
                "<HD_RESOLUTION>" + hdResolution + "</HD_RESOLUTION>" +
                "<H264_VSW_HIGH_PROFILE_PREFERENCE>base_line_only</H264_VSW_HIGH_PROFILE_PREFERENCE>" +
                "<VIDEO_CLARITY>false</VIDEO_CLARITY>" +
                "<AUTO_REDIAL>false</AUTO_REDIAL>" +
                "<EXCLUSIVE_CONTENT_MODE>false</EXCLUSIVE_CONTENT_MODE>" +
