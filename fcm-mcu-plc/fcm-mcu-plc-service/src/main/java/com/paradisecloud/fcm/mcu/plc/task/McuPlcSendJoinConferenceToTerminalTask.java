...
public class McuPlcSendJoinConferenceToTerminalTask extends DelayTask {

    private McuPlcConferenceContext conferenceContext;
    private AttendeeForMcuPlc attendee;

    public McuPlcSendJoinConferenceToTerminalTask(String id, long delayInMilliseconds, McuPlcConferenceContext conferenceContext, AttendeeForMcuPlc attendee) {
