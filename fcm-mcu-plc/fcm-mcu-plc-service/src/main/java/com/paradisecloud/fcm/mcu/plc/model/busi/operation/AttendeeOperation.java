 ...
 * @version  V1.0
 */ 
package com.paradisecloud.fcm.mcu.plc.model.busi.operation;
...
public abstract class AttendeeOperation extends BaseAttendeeOperation implements Serializable
{
     ...
     */
    @JsonIgnore
    protected volatile McuPlcConferenceContext conferenceContext;
     ...
     */
    protected volatile List<AttendeeForMcuPlc> attendees;
    ...
    @JsonIgnore
    protected List<AttendeeForMcuPlc> operatedAttendees = new ArrayList<>();
     ...
     */
    protected AttendeeOperation(McuPlcConferenceContext conferenceContext)
    {
        super();
     ...
     * @param splitScreen 
     */
    protected AttendeeOperation(McuPlcConferenceContext conferenceContext, SplitScreen splitScreen)
    {
     ...
     * @param attendees 
     */
    protected AttendeeOperation(McuPlcConferenceContext conferenceContext, SplitScreen splitScreen, List<AttendeeForMcuPlc> attendees)
    {
     ...
     */
    public List<AttendeeForMcuPlc> getOperatedAttendees()
    {
        return operatedAttendees;
    }
    ...
    public void addOperatedAttendee(AttendeeForMcuPlc a)
    {
