...
public enum AttendeeImportance
{
    ...
    {
        public void processAttendeeWebsocketMessage(AttendeeForMcuPlc attendee)
        {
    ...
    MASTER(7500000, 7500000, "主会场")
    {
        public void processAttendeeWebsocketMessage(AttendeeForMcuPlc attendee)
        {
            ...
            if (!(attendee instanceof McuAttendeeForMcuPlc))
            {
                McuPlcConferenceContext mainConferenceContext = McuPlcConferenceContextCache.getInstance().getMainConferenceContext(attendee.getConferenceNumber());
                if (mainConferenceContext != null && mainConferenceContext.getMasterAttendee() != attendee)
                {
                    AttendeeForMcuPlc oldMasterAttendee = mainConferenceContext.getMasterAttendee();
     ...
     * @param attendee void
     */
    public abstract void processAttendeeWebsocketMessage(AttendeeForMcuPlc attendee);
