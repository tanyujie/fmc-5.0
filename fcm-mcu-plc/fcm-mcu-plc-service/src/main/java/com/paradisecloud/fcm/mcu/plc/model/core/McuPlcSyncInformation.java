 ...
 * @version V1.0  
 */
public class McuPlcSyncInformation
{
     ...
     * 待同步的当前call的所属MCU
     */
    private volatile String currentCallMcuIp;
     ...
     */
    public String getCurrentCallMcuIp()
    {
        return currentCallMcuIp;
    }

    /**
     * <p>Set Method   :   currentCallFmeIp int</p>
     * @param currentCallMcuIp
     */
    public void setCurrentCallMcuIp(String currentCallMcuIp)
    {
        this.currentCallMcuIp = currentCallMcuIp;
    }
