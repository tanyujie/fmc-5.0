 ...
 * @version V1.0
 */
public abstract class AttendeeForMcuPlc extends BaseAttendee implements Serializable, Comparable<AttendeeForMcuPlc>
{
     ...
     * @param attendee void
     */
    public void syncTo(AttendeeForMcuPlc attendee)
    {
        ...
        // 已配置的终端与会者
        if (attendee instanceof TerminalAttendeeForMcuPlc && this instanceof TerminalAttendeeForMcuPlc)
        {
            TerminalAttendeeForMcuPlc terminalAttendee = (TerminalAttendeeForMcuPlc) attendee;
            TerminalAttendeeForMcuPlc thisTerminalAttendee = (TerminalAttendeeForMcuPlc) this;
    ...
    @Override
    public int compareTo(AttendeeForMcuPlc o)
    {
