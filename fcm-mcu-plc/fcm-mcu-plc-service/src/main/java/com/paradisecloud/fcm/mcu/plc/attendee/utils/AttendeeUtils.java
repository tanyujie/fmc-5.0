...
public class AttendeeUtils
{
    ...
    public static TerminalAttendeeForMcuPlc packTerminalAttendee(long terminalId, AttendType attendType, Map<String, Object> businessProperties, int weight, String uuid)
    {
        BusiTerminal terminal = TerminalCache.getInstance().get(terminalId);
        TerminalAttendeeForMcuPlc ta = new TerminalAttendeeForMcuPlc();
    ...
    public static TerminalAttendeeForMcuPlc packTerminalAttendee(long terminalId)
    {
        return packTerminalAttendee(terminalId, null, null, 1, UUID.randomUUID().toString());
    }
    
    public static TerminalAttendeeForMcuPlc packTerminalAttendee(BusiMcuPlcTemplateParticipant busiMcuPlcTemplateParticipant)
    {
        return packTerminalAttendee(busiMcuPlcTemplateParticipant.getTerminalId(), AttendType.convert(busiMcuPlcTemplateParticipant.getAttendType()), busiMcuPlcTemplateParticipant.getBusinessProperties(), busiMcuPlcTemplateParticipant.getWeight(), busiMcuPlcTemplateParticipant.getUuid());
    }
