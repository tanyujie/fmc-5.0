...
public abstract class AttendeePollingStrategy
{
     ...
     */
    public abstract List<PollingAttendee> parse(McuPlcConferenceContext conferenceContext, List<DeptPollingAttendees> deptPollingAttendeesList, SplitScreen splitScreen);
    
    protected List<PollingAttendee> parseSpecifiedRangeAndDeptFirst(McuPlcConferenceContext conferenceContext, List<DeptPollingAttendees> deptPollingAttendeesList)
    {
     ...
     * @return List<PollingAttendee>
     */
    protected List<PollingAttendee> parseGlobalPolling(McuPlcConferenceContext conferenceContext, Map<String, PollingAttendee> m, SplitScreen splitScreen)
    {
        List<PollingAttendee> pollingAttendeeList = new ArrayList<>();
        if (conferenceContext.getMasterAttendee() != null)
        {
            ...
            {
                List<AttendeeForMcuPlc> as = conferenceContext.getCascadeAttendeesMap().get(conferenceContext.getMasterAttendee().getDeptId());
                if (as != null)
                {
                    for (AttendeeForMcuPlc attendee : new ArrayList<>(as))
                    {
        ...
        {
            add(pollingAttendeeList, attendee, m, splitScreen);
            List<AttendeeForMcuPlc> as = conferenceContext.getCascadeAttendeesMap().get(attendee.getDeptId());
            if (as != null)
            {
                for (AttendeeForMcuPlc a : new ArrayList<>(as))
                {
     ...
     * @return List<PollingAttendee>
     */
    protected List<PollingAttendee> parseGlobalPollingAndDeptFirst(McuPlcConferenceContext conferenceContext, Map<String, PollingAttendee> m, SplitScreen splitScreen)
    {
        List<PollingAttendee> pollingAttendeeList = new ArrayList<>();
        if (conferenceContext.getMasterAttendee() != null)
        {
        ...
        for (AttendeeForMcuPlc attendee : new ArrayList<>(conferenceContext.getMasterAttendees()))
        {
            add(pollingAttendeeList, attendee, m, splitScreen);
        }
    ...
    private void add(List<PollingAttendee> pollingAttendeeList, AttendeeForMcuPlc a, Map<String, PollingAttendee> m, SplitScreen splitScreen)
    {
