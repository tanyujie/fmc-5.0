 ...
 * @version V1.0  
 */
public interface IAttendeeForMcuPlcService
{
     ...
     * @since 2021-02-09 11:32  void
     */
    void defaultChooseSee(McuPlcConferenceContext mainConferenceContext);
     ...
     */
    void cancelCurrentOperation(McuPlcConferenceContext conferenceContext);
     ...
     * @param conferenceId
     * @param attendeeId
     * @see IAttendeeForMcuPlcService#callTheRoll(String, String)
     */
     ...
     * @since 2021-02-22 18:07
     */
    void openMixing(McuPlcConferenceContext cc);
     ...
     * @param cc void
     */
    void closeMixing(McuPlcConferenceContext cc, AttendeeForMcuPlc... excludes);
     ...
     * @param attendee void
     */
    JSONObject detail(McuPlcConferenceContext conferenceContext, AttendeeForMcuPlc attendee);
