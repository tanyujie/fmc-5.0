 ...
 */
@Service
public class BusiRecordsServiceForMcuPlcImpl implements IBusiRecordsForMcuPlcService {
    ...
    @Resource
    private IBusiMcuPlcConferenceService iBusiMcuPlcConferenceService;
    ...
    public int updateBusiRecords(boolean recording, String contextKey) {
        ...
        boolean success = iBusiMcuPlcConferenceService.updateCallRecordStatus(contextKey, recording);
    ...
    public int getRecordSpaceStatus() {
        ...
        Collection<McuPlcConferenceContext> values = McuPlcConferenceContextCache.getInstance().values();
        int i = 1;
        if (values != null && values.size() > 0) {
            for (McuPlcConferenceContext value : values) {
                if (value.isRecorded()) {
                    i++;
                }
            }
     ...
     * @param path
     */
    private void readRecordFileName(McuPlcConferenceContext conferenceContext, BusiRecords busiRecords, String path) {
