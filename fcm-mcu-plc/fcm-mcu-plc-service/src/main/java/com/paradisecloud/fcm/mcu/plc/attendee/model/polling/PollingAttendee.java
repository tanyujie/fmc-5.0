 ...
 * @version  V1.0
 */ 
package com.paradisecloud.fcm.mcu.plc.attendee.model.polling;
...
public class PollingAttendee implements Comparable<PollingAttendee>
{
     ...
     * 参会者
     */
    private BaseAttendee downCascadeAttendee;
     ...
     * @param attendee 
     */
    public PollingAttendee(AttendeeForMcuPlc attendee)
    {
        super();
     ...
     * @author sinhy
     * @since 2021-09-09 21:41
     * @param downCascadeAttendee
     */
    public PollingAttendee(BaseAttendee downCascadeAttendee)
    {
        super();
        this.downCascadeAttendee = downCascadeAttendee;
    }
     ...
     * @param attendee
     */
    public void setAttendee(AttendeeForMcuPlc attendee)
    {
        this.attendee = attendee;
    }

    public BaseAttendee getDownCascadeAttendee() {
        return downCascadeAttendee;
    }

    public void setDownCascadeAttendee(BaseAttendee downCascadeAttendee) {
        this.downCascadeAttendee = downCascadeAttendee;
    }
