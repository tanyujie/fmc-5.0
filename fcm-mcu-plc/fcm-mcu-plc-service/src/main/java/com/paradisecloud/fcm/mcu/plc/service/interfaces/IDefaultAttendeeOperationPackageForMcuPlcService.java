 ...
 * @version V1.0  
 */
public interface IDefaultAttendeeOperationPackageForMcuPlcService
{
     ...
     */
    DefaultAttendeeOperation packing(McuPlcConferenceContext conferenceContext, BusiMcuPlcTemplateConference tc, Map<Long, BusiMcuPlcTemplateParticipant> busiTemplateParticipantMap);
