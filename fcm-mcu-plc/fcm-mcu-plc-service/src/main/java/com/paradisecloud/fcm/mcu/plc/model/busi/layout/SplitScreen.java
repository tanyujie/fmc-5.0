...
public abstract class SplitScreen implements Serializable
{
     ...
     * 分屏需要渲染的参会者
     */
    protected List<AttendeeForMcuPlc> attendees = new ArrayList<>();
     ...
     */
    public void processImportance(List<AttendeeForMcuPlc> as, ImportanceProcessor importanceProcessor)
    {
