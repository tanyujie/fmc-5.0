...
public class McuPlcSendLeftConferenceToTerminalTask extends DelayTask {

    private McuPlcConferenceContext conferenceContext;
    private AttendeeForMcuPlc attendee;

    public McuPlcSendLeftConferenceToTerminalTask(String id, long delayInMilliseconds, McuPlcConferenceContext conferenceContext, AttendeeForMcuPlc attendee) {
