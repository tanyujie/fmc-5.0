...
public class BusiSmc2AppointmentConferenceRequest {
    ...
    public List<TemplateTerminal> getTemplateTerminalList() {
        return templateTerminalList;
    }

    public void setTemplateTerminalList(List<TemplateTerminal> templateTerminalList) {
