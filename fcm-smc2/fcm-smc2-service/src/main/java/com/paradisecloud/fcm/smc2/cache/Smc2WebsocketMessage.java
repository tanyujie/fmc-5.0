...
public class Smc2WebsocketMessage {
    /**
     * 消息类型
     */
    private String type;
     ...
     * @param data
     */
    public Smc2WebsocketMessage(String type, Object data)
    {
        this.type = type;
        this.data = data;
    }
     ...
     * @param destination
     */
    public Smc2WebsocketMessage(String type, Object data, String destination)
    {
        super();
        this.type = type;
        this.data = data;
