...
public class AttendeeCountingStatistics
{
    ...
    public AttendeeCountingStatistics(Smc2ConferenceContext cc)
    {
        ...
        for (AttendeeSmc2 terminalAttendee : cc.getAttendees())
        {
            total++;
        ...
        for (AttendeeSmc2 masterAttendee0 : cc.getMasterAttendees())
        {
            total++;
