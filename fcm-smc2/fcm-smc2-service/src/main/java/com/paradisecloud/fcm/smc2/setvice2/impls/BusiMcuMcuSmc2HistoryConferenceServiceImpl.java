...
@Transactional
@Service
public class BusiMcuMcuSmc2HistoryConferenceServiceImpl implements IBusiMcuSmc2HistoryConferenceService {
    
    private Logger logger = LoggerFactory.getLogger(BusiMcuMcuSmc2HistoryConferenceServiceImpl.class);
    ...
    @Override
    public BusiHistoryConference saveHistory(CoSpace cosapce, Call call, Smc2ConferenceContext conferenceContext)
    {
        try
        {
    ...
    public BusiHistoryConference saveHistory(Smc2ConferenceContext conferenceContext) {
        ...
        StatisticalConferenceTaskSmc2 statisticalConferenceTask=new StatisticalConferenceTaskSmc2(busiHistoryConference.getDeptId().toString(),1000,busiHistoryConference.getDeptId());
        smc2DelayTaskService.addTask(statisticalConferenceTask);
        return busiHistoryConference;
    }
     ...
     */
    @Override
    public void updateBusiHistoryParticipant(Smc2ConferenceContext conferenceContext, AttendeeSmc2 attendee, boolean updateMediaInfo) {
    ...
    public List<BusiHistoryConference> selectBusiHistoryConferenceListNotEnd() {
        return busiHistoryConferenceMapper.selectNotEndHistoryConferenceList(McuType.SMC2.getCode());
    }
}
