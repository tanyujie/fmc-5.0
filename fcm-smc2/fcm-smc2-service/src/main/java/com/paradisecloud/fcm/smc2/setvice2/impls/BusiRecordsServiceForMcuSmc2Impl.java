 ...
 */
@Service
public class BusiRecordsServiceForMcuSmc2Impl implements IBusiRecordsForMcuSmc2Service {
    ...
    @Resource
    private IBusiSmc2ConferenceService iBusiSmc2ConferenceService;
    ...
    public int updateBusiRecords(boolean recording, String contextKey) {
        ...
        boolean success = iBusiSmc2ConferenceService.updateCallRecordStatus(contextKey, recording);
     ...
     * @param path
     */
    private void readRecordFileName(String conferenceNumber, Smc2ConferenceContext conferenceContext, BusiRecords busiRecords, String path) {
