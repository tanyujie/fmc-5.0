 ...
 * @version  V1.0
 */ 
package com.paradisecloud.fcm.smc2.model.attendee.operation.polling;
...
public class PollingAttendee implements Comparable<PollingAttendee>
{
     ...
     * @param attendee 
     */
    public PollingAttendee(AttendeeSmc2 attendee)
    {
        super();
     ...
     * @return attendee
     */
    public AttendeeSmc2 getAttendee()
    {
        return attendee;
    }
     ...
     * @param attendee
     */
    public void setAttendee(AttendeeSmc2 attendee)
    {
        this.attendee = attendee;
    }
