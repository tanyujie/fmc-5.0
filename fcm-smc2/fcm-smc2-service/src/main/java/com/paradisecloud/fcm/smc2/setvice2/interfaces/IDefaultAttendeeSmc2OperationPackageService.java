 ...
 * @version V1.0  
 */
public interface IDefaultAttendeeSmc2OperationPackageService
{
     ...
     */
    DefaultAttendeeOperation packing(Smc2ConferenceContext conferenceContext, BusiMcuSmc2TemplateConference tc, Map<Long, BusiMcuSmc2TemplateParticipant> busiTemplateParticipantMap);
