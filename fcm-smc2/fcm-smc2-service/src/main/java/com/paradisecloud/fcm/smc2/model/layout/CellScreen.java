...
public class CellScreen implements Serializable
{
     ...
     */
    @JsonIgnore
    private AttendeeSmc2 lastOperationAttendee;
    ...
    public void addAttendee(AttendeeSmc2 a)
    {
        attendees.add(a);
    }
     ...
     */
    public AttendeeSmc2 getLastOperationAttendee()
    {
        return lastOperationAttendee;
    }
     ...
     */
    public void setLastOperationAttendee(AttendeeSmc2 lastOperationAttendee)
    {
     ...
     */
    @JsonIgnore
    public AttendeeSmc2 getPollingAttendee()
    {
