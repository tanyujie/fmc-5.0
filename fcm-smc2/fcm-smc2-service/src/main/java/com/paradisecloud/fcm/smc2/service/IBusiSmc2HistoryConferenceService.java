 ...
 * @date 2021-01-20
 */
public interface IBusiSmc2HistoryConferenceService
{
    /**
     * 查询历史会议，每次挂断会保存该历史记录
     * 
     ...
     * @param attendee
     */
    void updateBusiHistoryParticipant(Smc2ConferenceContext conferenceContext, SmcParitipantsStateRep.ContentDTO contentDTO, boolean updateMediaInfo);
