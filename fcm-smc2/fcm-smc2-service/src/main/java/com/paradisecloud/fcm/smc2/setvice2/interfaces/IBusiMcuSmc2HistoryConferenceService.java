 ...
 * @date 2021-01-20
 */
public interface IBusiMcuSmc2HistoryConferenceService
{
    /**
     * 查询历史会议，每次挂断会保存该历史记录
     * 
     ...
     */
    BusiHistoryConference saveHistory(CoSpace cosapce, Call call, Smc2ConferenceContext conferenceContext);
    
    BusiHistoryConference saveHistory(BusiHistoryConference busiHistoryConference, Smc2ConferenceContext conferenceContext);
    ...
    BusiHistoryConference saveHistory(Smc2ConferenceContext conferenceContext);
     ...
     * @param attendee
     */
    void updateBusiHistoryParticipant(Smc2ConferenceContext conferenceContext, AttendeeSmc2 attendee, boolean updateMediaInfo);
