...
public class StatisticalConferenceTaskDing extends DingDelayTask {

    private static final Logger LOGGER = LoggerFactory.getLogger(StatisticalConferenceTaskDing.class);

    private Long deptId;

    public StatisticalConferenceTaskDing(String id, long delayInMilliseconds, Long deptId) {
