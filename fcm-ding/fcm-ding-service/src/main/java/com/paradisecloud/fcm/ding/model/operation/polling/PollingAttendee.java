 ...
 * @version  V1.0
 */ 
package com.paradisecloud.fcm.ding.model.operation.polling;
...
public class PollingAttendee implements Comparable<PollingAttendee>
{
     ...
     * @param attendee 
     */
    public PollingAttendee(AttendeeDing attendee)
    {
        super();
     ...
     * @return attendee
     */
    public AttendeeDing getAttendee()
    {
        return attendee;
    }
     ...
     * @param attendee
     */
    public void setAttendee(AttendeeDing attendee)
    {
        this.attendee = attendee;
    }
