...
@Service
@Transactional
public class BusiConferenceNumberDingServiceImpl implements IBusiConferenceNumberDingService
{
    ...
    {
        long cn = busiConferenceNumberSectionService.autoGenerate(deptId,"Ding");
    ...
    {
        busiConferenceNumberSectionService.validNumber(busiConferenceNumber.getId(), busiConferenceNumber.getDeptId(),"Ding");
