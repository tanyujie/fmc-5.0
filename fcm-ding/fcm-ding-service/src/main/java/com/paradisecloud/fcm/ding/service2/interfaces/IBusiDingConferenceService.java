 ...
 * @date 2021-02-02
 */
public interface IBusiDingConferenceService
{
     ...
     */
    DingConferenceContext buildTemplateConferenceContext(long templateConferenceId);
     ...
     */
    @Transactional
    BusiMcuDingConferenceAppointment extendMinutes(String conferenceId, int minutes);
     ...
     */
    void stream(DingConferenceContext mainConferenceContext, Boolean streaming, String streamUrl);
