...
import com.paradisecloud.fcm.ding.task.StatisticalConferenceTaskDing;
...
@Transactional
@Service
public class BusiMcuDingHistoryConferenceServiceImpl implements IBusiMcuDingHistoryConferenceService {

    private Logger logger = LoggerFactory.getLogger(BusiMcuDingHistoryConferenceServiceImpl.class);
    ...
    @Override
    public BusiHistoryConference saveHistory(BusiHistoryConference busiHistoryConference, DingConferenceContext conferenceContext) {
        return null;
    }
    ...
    @Override
    public BusiHistoryConference saveHistory(DingConferenceContext conferenceContext) {
        ...
        StatisticalConferenceTaskDing statisticalConferenceTask=new StatisticalConferenceTaskDing(busiHistoryConference.getDeptId().toString(),1000,busiHistoryConference.getDeptId());
        dingDelayTaskService.addTask(statisticalConferenceTask);
     ...
     */
    @Override
    public void updateBusiHistoryParticipant(DingConferenceContext conferenceContext, AttendeeDing attendee, boolean updateMediaInfo) {
    ...
    public List<BusiHistoryConference> selectBusiHistoryConferenceListNotEnd() {
        return busiHistoryConferenceMapper.selectNotEndHistoryConferenceList(McuType.MCU_DING.getCode());
    }
}
