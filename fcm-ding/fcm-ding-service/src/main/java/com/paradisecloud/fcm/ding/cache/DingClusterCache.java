 ...
 * @version V1.0  
 */
public class DingClusterCache extends JavaCache<Long, BusiMcuDingCluster>
{
    ...
    private static final DingClusterCache INSTANCE = new DingClusterCache();
     ...
     */
    private DingClusterCache()
    {
    }
    
    public static DingClusterCache getInstance()
    {
        return INSTANCE;
    }
}
