...
import com.paradisecloud.fcm.ding.busi.attende.RemotePartyAttendeesMap;
...
import com.paradisecloud.fcm.ding.model.event.ParticipantJoined;
...
public class DingConferenceContext extends BaseConferenceContext<AttendeeDing> implements Serializable {
     ...
     * 直播终端
     */
    private volatile AttendeeDing streamingAttendee;
     ...
     * 主会场与会者
     */
    private volatile AttendeeDing masterAttendee;
    /**
     * 会议主导方的参会者
     */
    private volatile List<AttendeeDing> attendees = new ArrayList<>();

    /**
     * 所有级联子会议的主会场集合
     */
    private volatile List<AttendeeDing> masterAttendees = new ArrayList<>();

    /**
     * FME自身充当的参会者
     */
    private volatile List<AttendeeDing> fmeAttendees = new ArrayList<>();
     ...
     * 级联方的参会者映射表，key为部门ID
     */
    private volatile Map<Long, List<AttendeeDing>> cascadeAttendeesMap = new ConcurrentHashMap<>();
     ...
     */
    @JsonIgnore
    private volatile Map<String, AttendeeDing> attendeeMap = new ConcurrentHashMap<>();

    /**
     * 直播终端列表
     */
    @JsonIgnore
    private volatile List<TerminalAttendeeDing> liveTerminals = new ArrayList<>();

    /**
     * 直播终端Map key:sn
     */
    private volatile Map<String, TerminalAttendeeDing> liveTerminalMap = new ConcurrentHashMap();
     ...
     */
    @JsonIgnore
    private volatile Map<Long, TerminalAttendeeDing> terminalAttendeeMap = new ConcurrentHashMap<>();

    /**
     * 终端ID映射
     */
    @JsonIgnore
    private volatile Map<Long, AttendeeDing> terminalAttendeeAllMap = new ConcurrentHashMap<>();

    /**
     * 终端ID映射
     */
    @JsonIgnore
    private volatile Map<String, AttendeeDing> participantAttendeeAllMap = new ConcurrentHashMap<>();
    /**
     * 清空主会场
     *
     * @author lilinhai
    ...
    private BusiMcuDingConferenceAppointment conferenceAppointment;
    ...
    @Override
    public List<AttendeeDing> getAttendees() {
        return attendees;
    }

    public void setAttendees(List<AttendeeDing> attendees) {
    ...
    @Override
    public AttendeeDing getAttendeeByPUuid(String smcPid) {
        return getAttendeeBySmcId(smcPid);
    }


    public Map<String, AttendeeDing> getUuidAttendeeMapByMsOpenId(String msopenid)
    {
        return remotePartyAttendeesMap.get(msopenid);
    }

    public AttendeeDing getUuidAttendeeByMsOpenId(String msopenid)
    {
        Map<String, AttendeeDing> attendeeDingMap = remotePartyAttendeesMap.get(msopenid);
        if(attendeeDingMap==null){
            return null;
        }
        for (Map.Entry<String, AttendeeDing> attendeeDingEntry : attendeeDingMap.entrySet()) {
            AttendeeDing value = attendeeDingEntry.getValue();
            return value;
        }
        return null;
    }

    public AttendeeDing getAttendeeBySmcId(String participantId) {
        return this.participantAttendeeAllMap.get(participantId);
    }


    public DingConferenceContext( ) {
        this.version="Ding4.0";
    }

    public DingConferenceContext(DingBridge dingBridge) {
        this.dingBridge = dingBridge;
        this.version="4.0";
        this.setMcuTypeObject(McuType.MCU_DING);
    }
     ...
     * @param attendee
     */
    public void addMcuAttendee(McuAttendeeDing attendee) {
    ...
    public DingBridge getDingBridge() {
        return dingBridge;
    }

    public void setDingBridge(DingBridge dingBridge) {
        this.dingBridge = dingBridge;
    }

    @Override
    public BusiMcuDingConferenceAppointment getConferenceAppointment() {
        return conferenceAppointment;
    }

    public void setConferenceAppointment(BusiMcuDingConferenceAppointment conferenceAppointment) {
    ...
    @Override
    public Map<Long, List<AttendeeDing>> getCascadeAttendeesMap() {
        return cascadeAttendeesMap;
    }

    public void setCascadeAttendeesMap(Map<Long, List<AttendeeDing>> cascadeAttendeesMap) {
    ...
    @Override
    public AttendeeDing getStreamingAttendee() {
        return streamingAttendee;
    }
    @Override
    public void setStreamingAttendee(AttendeeDing streamingAttendee) {
    ...
    @Override
    public List<AttendeeDing> getMasterAttendees() {
        return masterAttendees;
    }

    public void setMasterAttendees(List<AttendeeDing> masterAttendees) {
        this.masterAttendees = masterAttendees;
    }

    public List<AttendeeDing> getFmeAttendees() {
        return fmeAttendees;
    }

    public void setFmeAttendees(List<AttendeeDing> fmeAttendees) {
    ...
    public Map<String, AttendeeDing> getAttendeeMap() {
        return attendeeMap;
    }

    public void setAttendeeMap(Map<String, AttendeeDing> attendeeMap) {
        this.attendeeMap = attendeeMap;
    }

    @Override
    public List<TerminalAttendeeDing> getLiveTerminals() {
        return liveTerminals;
    }

    public void setLiveTerminals(List<TerminalAttendeeDing> liveTerminals) {
        this.liveTerminals = liveTerminals;
    }

    public Map<String, TerminalAttendeeDing> getLiveTerminalMap() {
        return liveTerminalMap;
    }

    public void setLiveTerminalMap(Map<String, TerminalAttendeeDing> liveTerminalMap) {
    ...
    @Override
    public Map<Long, TerminalAttendeeDing> getTerminalAttendeeMap() {
        return terminalAttendeeMap;
    }

    public void setTerminalAttendeeMap(Map<Long, TerminalAttendeeDing> terminalAttendeeMap) {
        this.terminalAttendeeMap = terminalAttendeeMap;
    }

    public Map<Long, AttendeeDing> getTerminalAttendeeAllMap() {
        return terminalAttendeeAllMap;
    }

    public void setTerminalAttendeeAllMap(Map<Long, AttendeeDing> terminalAttendeeAllMap) {
        this.terminalAttendeeAllMap = terminalAttendeeAllMap;
    }

    public Map<String, AttendeeDing> getParticipantAttendeeAllMap() {
        return participantAttendeeAllMap;
    }

    public void setParticipantAttendeeAllMap(Map<String, AttendeeDing> participantAttendeeAllMap) {
    ...
    @Override
    public AttendeeDing getMasterAttendee() {
    ...
    public synchronized void setMasterAttendee(AttendeeDing masterAttendee)
    {
        ...
        if (this.masterAttendee != null)
        {
            ...
            else
            {
                ...
                {
                    List<AttendeeDing> as = this.cascadeAttendeesMap.get(this.masterAttendee.getDeptId());
                    if (as != null)
                    {
        ...
        if (masterAttendee.getDeptId() != deptId.longValue())
        {
            ...
            {
                List<AttendeeDing> as = this.cascadeAttendeesMap.get(masterAttendee.getDeptId());
     ...
     * @param attendee
     */
    public synchronized void addAttendee(AttendeeDing attendee)
    {
        ...
        if (attendee instanceof TerminalAttendeeDing)
        {
            ...
            TerminalAttendeeDing old = terminalAttendeeMap.get(terminalAttendee.getTerminalId());
            if (old != null)
            {
    ...
    @Override
    public void updateAttendeeToRemotePartyMap(String oldRemoteParty, AttendeeDing attendee) {
        if (StringUtils.hasText(oldRemoteParty)) {
            Map<String, AttendeeDing> uuidAttendeeMap = remotePartyAttendeesMap.get(oldRemoteParty);
    ...
    public void addAttendeeToIdMap(AttendeeDing attendee)
    {
        this.attendeeMap.put(attendee.getId(), attendee);
    }

    public void addAttendeeToRemotePartyMap(AttendeeDing attendee)
    {
        remotePartyAttendeesMap.addAttendee(attendee);
    }

    public void addAttendeeToTerminalAllMap(AttendeeDing attendee) {
     ...
     * MCU自身充当的参会者
     */
    private volatile List<McuAttendeeDing> mcuAttendees = new ArrayList<>();
    /**
     * 删除MCU类型参会终端
     *
     * @param mcuAttendee
     */
    public void removeMcuAttendee(McuAttendeeDing mcuAttendee) {
        this.mcuAttendees.remove(mcuAttendee);
        this.removeAttendeeById(mcuAttendee.getId());
    }
    public synchronized AttendeeDing removeAttendeeById(String id)
    {
        AttendeeDing attendee = this.attendeeMap.remove(id);
        if (attendee != null)
        {
            ...
            List<AttendeeDing> as = cascadeAttendeesMap.get(attendee.getDeptId());
            if (as != null)
            {
                as.remove(attendee);
            }
            ...
            if (attendee instanceof TerminalAttendeeDing) {
                TerminalAttendeeDing ta = (TerminalAttendeeDing) attendee;
    ...
    public Long removeRecallAttendeeBeginTime(AttendeeDing attendee)
    {
        return recallAttendeeBeginTimeMap.remove(attendee.getId());
    }

    public void removeAttendeeFromTerminalAllMap(AttendeeDing attendee) {
        if (attendee.getTerminalId() != null) {
    ...
    @Override
    public AttendeeDing getAttendeeById(String attendeeId)
    {
    ...
    @Override
    public List<McuAttendeeDing> getMcuAttendees() {
        return mcuAttendees;
    }

    public void setMcuAttendees(List<McuAttendeeDing> mcuAttendees) {
    ...
    @Override
    public AttendeeDing getAttendeeByRemoteParty(String remoteParty) {
        Map<String, AttendeeDing> stringAttendeeDingMap = remotePartyAttendeesMap.get(remoteParty);
        if(stringAttendeeDingMap==null){
            return null;
        }
        for (AttendeeDing value : stringAttendeeDingMap.values()) {
            return  value;
        }
        return null;
    }
