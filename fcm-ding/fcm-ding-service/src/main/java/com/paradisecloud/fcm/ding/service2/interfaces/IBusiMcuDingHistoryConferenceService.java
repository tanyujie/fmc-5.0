 ...
 * @date 2021-01-20
 */
public interface IBusiMcuDingHistoryConferenceService
{
    /**
     * 查询历史会议，每次挂断会保存该历史记录
     * 
    ...
    BusiHistoryConference saveHistory(BusiHistoryConference busiHistoryConference, DingConferenceContext conferenceContext);
    ...
    BusiHistoryConference saveHistory(DingConferenceContext conferenceContext);
     ...
     * @param attendee
     */
    void updateBusiHistoryParticipant(DingConferenceContext conferenceContext, AttendeeDing attendee, boolean updateMediaInfo);
