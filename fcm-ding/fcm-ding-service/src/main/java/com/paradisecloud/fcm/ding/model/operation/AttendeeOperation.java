...
public abstract class AttendeeOperation extends BaseAttendeeOperation implements Serializable
{
     ...
     */
    @JsonIgnore
    protected volatile DingConferenceContext conferenceContext;
     ...
     */
    protected volatile List<AttendeeDing> attendeeDings;
     ...
     */
    public AttendeeOperation(DingConferenceContext conferenceContext) {
        super();
     ...
     * @param splitScreen 
     */
    protected AttendeeOperation(DingConferenceContext conferenceContext, SplitScreen splitScreen)
    {
     ...
     * @param attendees 
     */
    protected AttendeeOperation(DingConferenceContext conferenceContext, SplitScreen splitScreen, List<SmcParitipantsStateRep.ContentDTO> attendees)
    {
