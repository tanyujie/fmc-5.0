...
public class DingWebsocketMessage {
    /**
     * 消息类型
     */
    private String type;
     ...
     * @param data
     */
    public DingWebsocketMessage(String type, Object data)
    {
        this.type = type;
        this.data = data;
    }
     ...
     * @param destination
     */
    public DingWebsocketMessage(String type, Object data, String destination)
    {
        super();
        this.type = type;
        this.data = data;
