 ...
 * @version V1.0  
 */
public interface IAttendeeDingService
{
     ...
     * @since 2021-02-09 11:22  void
     */
    void defaultChooseSee(DingConferenceContext mainConferenceContext);
    ...
    void cancelCurrentOperation(DingConferenceContext conferenceContext);
     ...
     * @param conferenceId
     * @param attendeeId
     * @see IAttendeeDingService#callTheRoll(String, String)
     */
     ...
     * @since 2021-02-22 18:07
     */
    void openMixing(DingConferenceContext cc);
     ...
     * @param cc void
     */
    void closeMixing(DingConferenceContext cc, AttendeeDing... excludes);
     ...
     * @param attendee void
     */
    JSONObject detail(DingConferenceContext conferenceContext, AttendeeDing attendee);
