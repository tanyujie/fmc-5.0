...
public abstract class AttendeeProcessor
{
    ...
    protected DingConferenceContext conferenceContext;
     ...
     */
    protected AttendeeProcessor(SmcParitipantsStateRep.ContentDTO participant, DingConferenceContext conferenceContext)
    {
        super();
