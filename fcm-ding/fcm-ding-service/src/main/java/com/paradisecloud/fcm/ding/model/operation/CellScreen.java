...
public class CellScreen implements Serializable
{
     ...
     * 分屏单元格需要渲染的参会者
     */
    private List<AttendeeDing> attendeeDings = new ArrayList<>();
    /**
     * 轮询索引下标
     */
    ...
    @JsonIgnore
    private AttendeeDing lastOperationAttendeeDing;
    /**
     * 单元格参会者操作枚举选项
     */
    ...
    public void addAttendeeDing(AttendeeDing a)
    {
        attendeeDings.add(a);
    }
    ...
    public AttendeeDing getLastOperationAttendeeDing()
    {
        return lastOperationAttendeeDing;
    }
    /**
    ...
    @JsonIgnore
    public AttendeeDing getPollingAttendeeDing()
    {
        if (ObjectUtils.isEmpty(attendeeDings))
        {
            return null;
        }

        if (pollingIndex >= attendeeDings.size())
        {
            pollingIndex = 0;
        }
        return attendeeDings.get(pollingIndex++);
    }

    public List<AttendeeDing> getAttendeeDings() {
        return attendeeDings;
    }

    public void setAttendeeDings(List<AttendeeDing> attendeeDings) {
        this.attendeeDings = attendeeDings;
    }
