 ...
 * @version V1.0  
 */
public interface IDefaultAttendeeDingOperationPackageService
{
     ...
     */
    DefaultAttendeeOperation packing(DingConferenceContext conferenceContext, BusiMcuDingTemplateConference tc, Map<Long, BusiMcuDingTemplateParticipant> busiTemplateParticipantMap);
