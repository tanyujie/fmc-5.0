...
public class SshRemoteServerOperateOrdinary
{
	private static final Logger LOGGER = LoggerFactory.getLogger(SshRemoteServerOperateOrdinary.class);
	private Session session;// JSCH session
	private boolean logined = false;// 是否登陆

	private static final SshRemoteServerOperateOrdinary INSTANCE = new SshRemoteServerOperateOrdinary()
	{

	};

	public static SshRemoteServerOperateOrdinary getInstance()
	{
		return INSTANCE;
	}
