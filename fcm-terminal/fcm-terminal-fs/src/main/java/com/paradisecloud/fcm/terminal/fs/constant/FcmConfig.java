...
public interface FcmConfig {
	...
	String XML_PARENT = "/tmp/xmlFiles/";
	...
	String FREE_SWITCH_PATH = "/usr/local/freeswitch/bin/";
	
	String UPDATE_LOAD_XML = "fs_cli -x \"reloadxml\"";
	...
	String XML_PROPERTY = "<?xml version='1.0'encoding='UTF-8'?>";
	
	String REGISTER_FCM_USER = "sofia status profile internal reg";
}
