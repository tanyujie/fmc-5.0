 ...
 * @version V1.0  
 */
public class FreeSwitchClusterCache extends JavaCache<Long, BusiFreeSwitchCluster>
{
    ...
    private static final FreeSwitchClusterCache INSTANCE = new FreeSwitchClusterCache();
     ...
     */
    private FreeSwitchClusterCache()
    {
    }
    
    public static FreeSwitchClusterCache getInstance()
    {
        return INSTANCE;
    }
}
