...
) ENGINE = InnoDB AUTO_INCREMENT = 161 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '入会方案配置，控制参会者进入会议的方案' ROW_FORMAT = Dynamic;
...
INSERT INTO `busi_call_leg_profile` VALUES (160, '2021-04-27 17:29:44', NULL, '35c7a424-e62a-497b-8202-83de21a4a77f', NULL, 220, 61);
...
-- ----------------------------
INSERT INTO `busi_conference_number` VALUES (11111, '2021-04-26 19:22:28', NULL, 1, 'superAdmin', 220, 2, 100, NULL);
INSERT INTO `busi_conference_number` VALUES (100000, '2021-04-27 17:29:44', NULL, 100, 'admin', 220, 2, 100, NULL);
...
-- Records of busi_fme
-- ----------------------------
INSERT INTO `busi_fme` VALUES (61, '2021-04-26 19:14:08', '2021-04-28 19:05:29', 'admin', 'P@rad1se', '192.166.1.3', '192.166.1.3', NULL, 9443, 1, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'FME集群' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'FME-终端组中间表（多对多）' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 78 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '会议模板表' ROW_FORMAT = Dynamic;
...
INSERT INTO `busi_template_conference` VALUES (77, '2021-04-27 17:30:28', '2021-04-27 18:27:24', 100, 'admin', '测试', 220, '35c7a424-e62a-497b-8202-83de21a4a77f', 2, 2, 2, 2, 100000, 19903, 'speakerOnly', 2, 2, 1, 10);
...
) ENGINE = InnoDB AUTO_INCREMENT = 277 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '默认视图下指定的多分频单元格' ROW_FORMAT = Dynamic;
...
INSERT INTO `busi_template_conference_default_view_cell_screen` VALUES (276, NULL, NULL, 77, 1, 101, 2);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1385 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '默认视图的部门显示顺序' ROW_FORMAT = Dynamic;
...
INSERT INTO `busi_template_conference_default_view_dept` VALUES (1383, NULL, NULL, 77, 220, 2);
INSERT INTO `busi_template_conference_default_view_dept` VALUES (1384, NULL, NULL, 77, 221, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 11588 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '默认视图的参会者' ROW_FORMAT = Dynamic;
...
INSERT INTO `busi_template_conference_default_view_paticipant` VALUES (11582, NULL, NULL, 77, 19901, 5, NULL);
INSERT INTO `busi_template_conference_default_view_paticipant` VALUES (11583, NULL, NULL, 77, 19902, 4, NULL);
INSERT INTO `busi_template_conference_default_view_paticipant` VALUES (11584, NULL, NULL, 77, 19903, 1, NULL);
INSERT INTO `busi_template_conference_default_view_paticipant` VALUES (11585, NULL, NULL, 77, 19904, 6, NULL);
INSERT INTO `busi_template_conference_default_view_paticipant` VALUES (11586, NULL, NULL, 77, 19905, 3, NULL);
INSERT INTO `busi_template_conference_default_view_paticipant` VALUES (11587, NULL, NULL, 77, 19906, 0, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 3185 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '会议模板的级联部门' ROW_FORMAT = Dynamic;
...
INSERT INTO `busi_template_dept` VALUES (3184, '2021-04-27 18:27:24', NULL, '744bbc53-5ca1-4c01-9936-18430bb19868', 77, 221, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 19907 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '会议模板的参会者' ROW_FORMAT = Dynamic;
...
INSERT INTO `busi_template_participant` VALUES (19901, '2021-04-27 18:27:24', NULL, '8144b529-76cc-46f5-86ea-e516155e6134', 77, 290, 5);
INSERT INTO `busi_template_participant` VALUES (19902, '2021-04-27 18:27:24', NULL, '04284e7e-301a-4217-8763-27b8467bf68d', 77, 291, 4);
INSERT INTO `busi_template_participant` VALUES (19903, '2021-04-27 18:27:24', NULL, '46e70045-4d4e-40cd-9f8b-85c3e9944039', 77, 299, 1);
INSERT INTO `busi_template_participant` VALUES (19904, '2021-04-27 18:27:24', NULL, '8c8515ee-693b-44e6-b85b-259ea53e5c04', 77, 300, 6);
INSERT INTO `busi_template_participant` VALUES (19905, '2021-04-27 18:27:24', NULL, 'ad3ec39c-92b8-4219-8115-6b0403f6e1a3', 77, 294, 3);
INSERT INTO `busi_template_participant` VALUES (19906, '2021-04-27 18:27:24', NULL, 'd7a18855-47e0-417d-84d0-ba10265c5b22', 77, 292, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '轮询方案的部门' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '轮询方案的参会者' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '轮询方案' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 301 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '终端信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of busi_terminal
-- ----------------------------
INSERT INTO `busi_terminal` VALUES (290, '2021-04-26 19:18:13', NULL, 1, 'superAdmin', 220, '192.166.1.12', NULL, NULL, '192.166.1.12', 310, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `busi_terminal` VALUES (291, '2021-04-26 19:18:31', '2021-04-26 20:22:25', 1, 'superAdmin', 220, '192.166.1.21', NULL, NULL, '192.166.1.21', 310, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `busi_terminal` VALUES (293, '2021-04-26 19:19:06', NULL, 1, 'superAdmin', 221, '192.166.2.21', NULL, NULL, '192.166.2.21', 310, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `busi_terminal` VALUES (294, '2021-04-26 19:19:47', '2021-04-27 18:26:41', 1, 'superAdmin', 220, '192.166.1.13', NULL, NULL, '192.166.1.13', 310, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `busi_terminal` VALUES (295, '2021-04-27 09:59:03', NULL, 100, 'admin', 220, '218.28.249.132', NULL, NULL, 'VHD-CS', 1100, 2, '10001', '10001', 13, 'SIP', 'Cisco/SPA504G-7.4.9c', '2021-04-28 16:15:15', '193.46.255.110', 35521, 'TCP;OB');
INSERT INTO `busi_terminal` VALUES (299, '2021-04-27 17:31:26', '2021-04-27 17:34:52', 100, 'admin', 220, '192.166.0.98', NULL, NULL, '192.166.0.98', 310, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `busi_terminal` VALUES (300, '2021-04-27 18:24:35', '2021-04-27 18:26:45', 1, 'superAdmin', 220, '192.166.0.22', NULL, NULL, '192.166.0.22', 310, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 815 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_logininfor` VALUES (809, 'admin', '127.0.0.1', '内网IP', 'Firefox 8', 'Windows 10', '0', '退出成功', '2021-04-27 17:40:23');
INSERT INTO `sys_logininfor` VALUES (810, 'superadmin', '127.0.0.1', '内网IP', 'Firefox 8', 'Windows 10', '0', '登录成功', '2021-04-27 17:40:34');
INSERT INTO `sys_logininfor` VALUES (811, 'superadmin', '127.0.0.1', '内网IP', 'Firefox 8', 'Windows 10', '0', '登录成功', '2021-04-28 10:04:46');
INSERT INTO `sys_logininfor` VALUES (812, 'admin', '172.16.101.249', '内网IP', 'Chrome 9', 'Mac OS X', '0', '登录成功', '2021-04-29 14:09:09');
INSERT INTO `sys_logininfor` VALUES (813, 'admin', '172.16.101.249', '内网IP', 'Chrome 9', 'Mac OS X', '0', '退出成功', '2021-04-29 14:09:19');
INSERT INTO `sys_logininfor` VALUES (814, 'superAdmin', '172.16.101.249', '内网IP', 'Chrome 9', 'Mac OS X', '0', '登录成功', '2021-04-29 14:09:26');
...
INSERT INTO `sys_menu` VALUES (2010, '入会方案配置', 2009, 1, 'project', 'config/project/index', 1, 0, 'C', '0', '0', '', 'example', 'superAdmin', '2021-01-26 11:21:56', 'superAdmin', '2021-04-29 14:10:28', '');
...
INSERT INTO `sys_menu` VALUES (2023, '直播录制配置', 2009, 8, 'liveRecording', 'config/liveRecording/index', 1, 0, 'C', '0', '0', NULL, 'radio', 'superAdmin', '2021-04-29 14:10:19', '', NULL, '');
