...
) ENGINE = InnoDB AUTO_INCREMENT = 157 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '入会方案配置，控制参会者进入会议的方案' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 61 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'FME终端信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of busi_fme
-- ----------------------------
INSERT INTO `busi_fme` VALUES (58, '2021-04-26 18:43:36', '2021-04-26 19:04:50', 'admin', NULL, 'FME集群节点2', '192.168.100.31', NULL, 9443, 2, NULL);
INSERT INTO `busi_fme` VALUES (59, '2021-04-26 18:43:53', '2021-04-26 19:04:45', 'admin', NULL, 'FME集群节点3', '192.168.100.32', NULL, 9443, 2, NULL);
INSERT INTO `busi_fme` VALUES (60, '2021-04-26 18:44:11', '2021-04-26 19:04:46', 'admin', NULL, 'FME集群节点1', '192.168.100.30', NULL, 9443, 2, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 66 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'FME集群' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of busi_fme_cluster
-- ----------------------------
INSERT INTO `busi_fme_cluster` VALUES (65, '2021-04-26 18:45:19', NULL, '三门峡FME集群', NULL, NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 100033 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'FME-终端组中间表（多对多）' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of busi_fme_cluster_map
-- ----------------------------
INSERT INTO `busi_fme_cluster_map` VALUES (100030, '2021-04-26 18:47:00', NULL, 65, 60, 10);
INSERT INTO `busi_fme_cluster_map` VALUES (100031, '2021-04-26 18:47:08', NULL, 65, 58, 20);
INSERT INTO `busi_fme_cluster_map` VALUES (100032, '2021-04-26 18:47:14', NULL, 65, 59, 30);
...
) ENGINE = InnoDB AUTO_INCREMENT = 46 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'FME组分配租户的中间表（一个FME组可以分配给多个租户，一对多）' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of busi_fme_dept
-- ----------------------------
INSERT INTO `busi_fme_dept` VALUES (45, '2021-04-26 18:47:39', NULL, 220, 100, 65);
...
) ENGINE = InnoDB AUTO_INCREMENT = 76 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '会议模板表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 254 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '默认视图下指定的多分频单元格' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1334 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '默认视图的部门显示顺序' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 11491 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '默认视图的参会者' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3168 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '会议模板的级联部门' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 19852 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '会议模板的参会者' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 290 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '终端信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of busi_terminal
-- ----------------------------
INSERT INTO `busi_terminal` VALUES (285, '2021-04-26 18:50:21', NULL, 1, 'superAdmin', 220, '218.28.249.132', NULL, NULL, 'VHD-CS', 1000, 1, '10001', '10001', 13, 'SIP', 'VHD/V2.3.2-200704.1157', '2021-04-26 10:26:28', '10.18.14.163', 5061, 'TLS');
INSERT INTO `busi_terminal` VALUES (286, '2021-04-26 18:50:59', NULL, 1, 'superAdmin', 220, '218.28.249.132', NULL, NULL, 'AVA-CS', 1000, 1, '10002', '10002', 13, 'SIP', 'AVAEndPoint 1.0', '2021-04-26 17:59:40', '10.18.14.145', 5060, 'TCP');
INSERT INTO `busi_terminal` VALUES (287, '2021-04-26 18:51:25', NULL, 1, 'superAdmin', 220, '218.28.249.132', NULL, NULL, 'BLT-CS', 1000, 1, '10004', '10004', 13, 'H323', 'Polycom', '2021-04-26 14:26:51', '10.18.14.93', 1720, NULL);
INSERT INTO `busi_terminal` VALUES (288, '2021-04-26 18:51:50', NULL, 1, 'superAdmin', 220, '218.28.249.132', NULL, NULL, 'HC-CS', 1000, 1, '10005', '10005', 13, 'SIP', 'BizConfEdu VCT200/1.3.461.5', '2021-04-26 18:13:03', '61.178.98.97', 34062, 'TCP');
INSERT INTO `busi_terminal` VALUES (289, '2021-04-26 18:52:07', NULL, 1, 'superAdmin', 220, '218.28.249.132', NULL, NULL, 'WD-CS', 1000, 2, '10003', '10003', 13, 'H323', 'Unknown', '2021-04-26 17:58:23', '10.18.14.139', 1720, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 774 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_role` VALUES (6, '用户管理员', 'userAdmin', 4, '1', 1, 1, 100, '0', '0', 'superAdmin', '2021-04-26 10:20:04', 'superAdmin', '2021-04-26 15:11:59', NULL);
