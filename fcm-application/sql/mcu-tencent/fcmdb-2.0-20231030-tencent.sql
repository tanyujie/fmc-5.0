...
DROP TABLE IF EXISTS `busi_mcu_tencent`;
CREATE TABLE `busi_mcu_tencent`  (
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'smc2信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for busi_mcu_tencent_cluster
-- ----------------------------
DROP TABLE IF EXISTS `busi_mcu_tencent_cluster`;
CREATE TABLE `busi_mcu_tencent_cluster`  (
                                             `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
                                             `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
                                             `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
                                             ...
                                             `spare_mcu_id` bigint(20) NULL DEFAULT NULL COMMENT '当mcu_type为1是，指向busi_mcu_tencent的id字段，为100指向busi_mcu_tencent_cluster的id字段',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'TENCENT_MCU集群' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for busi_mcu_tencent_cluster_map
-- ----------------------------
DROP TABLE IF EXISTS `busi_mcu_tencent_cluster_map`;
CREATE TABLE `busi_mcu_tencent_cluster_map`  (
                                                 `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
                                                 `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
                                                 `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
                                                 ...
                                                 CONSTRAINT `busi_mcu_tencent_cluster_map_ibfk_1` FOREIGN KEY (`cluster_id`) REFERENCES `busi_mcu_tencent_cluster` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
                                                 CONSTRAINT `busi_mcu_tencent_cluster_map_ibfk_2` FOREIGN KEY (`mcu_id`) REFERENCES `busi_mcu_tencent` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'TENCENT_MCU-终端组中间表（多对多）' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for busi_mcu_tencent_conference_appointment
-- ----------------------------
DROP TABLE IF EXISTS `busi_mcu_tencent_conference_appointment`;
CREATE TABLE `busi_mcu_tencent_conference_appointment`  (
                                                            ...
                                                            CONSTRAINT `busi_mcu_tencent_conference_appointment_ibfk_1` FOREIGN KEY (`dept_id`) REFERENCES `sys_dept` (`dept_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
                                                            CONSTRAINT `busi_mcu_tencent_conference_appointment_ibfk_2` FOREIGN KEY (`template_id`) REFERENCES `busi_mcu_tencent_template_conference` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'TENCENT_MCU会议预约记录' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for busi_mcu_tencent_dept
-- ----------------------------
DROP TABLE IF EXISTS `busi_mcu_tencent_dept`;
CREATE TABLE `busi_mcu_tencent_dept`  (
                                          `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
                                          `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
                                          `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
                                          `dept_id` bigint(20) NULL DEFAULT NULL COMMENT '分配给的租户',
                                          `mcu_type` int(11) NULL DEFAULT NULL COMMENT '1单节点，100集群',
                                          `mcu_id` bigint(20) NULL DEFAULT NULL COMMENT '当mcu_type为1是，指向busi_mcu_tencent的id字段，为100指向busi_mcu_tencent_cluster的id字段',
                                          PRIMARY KEY (`id`) USING BTREE,
                                          UNIQUE INDEX `busi_mcu_tencent_group_dept_ibfk_1`(`dept_id`) USING BTREE,
                                          INDEX `mcu_group_id`(`mcu_id`) USING BTREE,
                                          CONSTRAINT `busi_mcu_tencent_dept_ibfk_1` FOREIGN KEY (`dept_id`) REFERENCES `sys_dept` (`dept_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'tencent_组分配租户的中间表（一个MCU组可以分配给多个租户，一对多）' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for busi_mcu_tencent_template_conference
-- ----------------------------
DROP TABLE IF EXISTS `busi_mcu_tencent_template_conference`;
CREATE TABLE `busi_mcu_tencent_template_conference`  (
                                                         `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
                                                         `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
                                                         `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
                                                         ...
                                                         `smc_template_id` varchar(70) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'tencent模板ID',
                                                         ...
                                                         `conf_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'tencent会议ID',
                                                         ...
                                                         CONSTRAINT `busi_mcu_tencent_template_conference_ibfk_1` FOREIGN KEY (`dept_id`) REFERENCES `sys_dept` (`dept_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
                                                         CONSTRAINT `busi_mcu_tencent_template_conference_ibfk_3` FOREIGN KEY (`create_user_id`) REFERENCES `sys_user` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
                                                         CONSTRAINT `busi_mcu_tencent_template_conference_ibfk_4` FOREIGN KEY (`master_participant_id`) REFERENCES `busi_mcu_tencent_template_participant` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'TENCENT_MCU会议模板表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for busi_mcu_tencent_template_conference_default_view_cell_screen
-- ----------------------------
DROP TABLE IF EXISTS `busi_mcu_tencent_template_conference_default_view_cell_screen`;
CREATE TABLE `busi_mcu_tencent_template_conference_default_view_cell_screen`  (
                                                                                  `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                                                  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
                                                                                  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
                                                                                  ...
                                                                                  CONSTRAINT `busi_mcu_tencent_default_view_cell_screen_ibfk_1` FOREIGN KEY (`template_conference_id`) REFERENCES `busi_mcu_tencent_template_conference` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'TENCENT_MCU默认视图下指定的多分频单元格' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for busi_mcu_tencent_template_conference_default_view_dept
-- ----------------------------
DROP TABLE IF EXISTS `busi_mcu_tencent_template_conference_default_view_dept`;
CREATE TABLE `busi_mcu_tencent_template_conference_default_view_dept`  (
                                                                           `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                                           `create_time` datetime(0) NULL DEFAULT NULL,
                                                                           `update_time` datetime(0) NULL DEFAULT NULL,
                                                                           `template_conference_id` bigint(20) NULL DEFAULT NULL COMMENT '关联的会议模板ID',
                                                                           ...
                                                                           CONSTRAINT `busi_mcu_tencent_default_view_dept_ibfk_1` FOREIGN KEY (`template_conference_id`) REFERENCES `busi_mcu_tencent_template_conference` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
                                                                           CONSTRAINT `busi_mcu_tencent_default_view_dept_ibfk_2` FOREIGN KEY (`dept_id`) REFERENCES `sys_dept` (`dept_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'TENCENT_MCU默认视图的部门显示顺序' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for busi_mcu_tencent_template_conference_default_view_paticipant
-- ----------------------------
DROP TABLE IF EXISTS `busi_mcu_tencent_template_conference_default_view_paticipant`;
CREATE TABLE `busi_mcu_tencent_template_conference_default_view_paticipant`  (
                                                                                 `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                                                 `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
                                                                                 `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
                                                                                 `template_conference_id` bigint(20) NULL DEFAULT NULL COMMENT '关联的会议模板ID',
                                                                                 ...
                                                                                 INDEX `cell_sequence_number`(`cell_sequence_number`) USING BTREE,
                                                                                 CONSTRAINT `busi_mcu_tencent_default_view_paticipant_ibfk_3` FOREIGN KEY (`template_conference_id`) REFERENCES `busi_mcu_tencent_template_conference` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
                                                                                 CONSTRAINT `busi_mcu_tencent_default_view_paticipant_ibfk_4` FOREIGN KEY (`template_participant_id`) REFERENCES `busi_mcu_tencent_template_participant` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'TENCENT_MCU默认视图的参会者' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for busi_mcu_tencent_template_dept
-- ----------------------------
DROP TABLE IF EXISTS `busi_mcu_tencent_template_dept`;
CREATE TABLE `busi_mcu_tencent_template_dept`  (
                                                   `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
                                                   `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
                                                   ...
                                                   CONSTRAINT `busi_mcu_tencent_template_dept_ibfk_1` FOREIGN KEY (`dept_id`) REFERENCES `sys_dept` (`dept_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
                                                   CONSTRAINT `busi_mcu_tencent_template_dept_ibfk_2` FOREIGN KEY (`template_conference_id`) REFERENCES `busi_mcu_tencent_template_conference` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'TENCENT_MCU会议模板的级联部门' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for busi_mcu_tencent_template_participant
-- ----------------------------
DROP TABLE IF EXISTS `busi_mcu_tencent_template_participant`;
CREATE TABLE `busi_mcu_tencent_template_participant`  (
                                                          `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
                                                          `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
                                                          `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
                                                          ...
                                                          INDEX `template_conference_id`(`template_conference_id`, `weight`) USING BTREE,
                                                          CONSTRAINT `busi_mcu_tencent_template_participant_ibfk_2` FOREIGN KEY (`terminal_id`) REFERENCES `busi_terminal` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
                                                          CONSTRAINT `busi_mcu_tencent_template_participant_ibfk_3` FOREIGN KEY (`template_conference_id`) REFERENCES `busi_mcu_tencent_template_conference` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'TENCENT_MCU会议模板的参会者' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for busi_mcu_tencent_template_polling_dept
-- ----------------------------
DROP TABLE IF EXISTS `busi_mcu_tencent_template_polling_dept`;
CREATE TABLE `busi_mcu_tencent_template_polling_dept`  (
                                                           ...
                                                           CONSTRAINT `busi_mcu_tencent_template_polling_dept_ibfk_1` FOREIGN KEY (`template_conference_id`) REFERENCES `busi_mcu_tencent_template_conference` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
                                                           CONSTRAINT `busi_mcu_tencent_template_polling_dept_ibfk_2` FOREIGN KEY (`polling_scheme_id`) REFERENCES `busi_mcu_tencent_template_polling_scheme` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'TENCENT_MCU轮询方案的部门' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for busi_mcu_tencent_template_polling_paticipant
-- ----------------------------
DROP TABLE IF EXISTS `busi_mcu_tencent_template_polling_paticipant`;
CREATE TABLE `busi_mcu_tencent_template_polling_paticipant`  (
                                                                 `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
                                                                 `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
                                                                 `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
                                                                 `template_conference_id` bigint(20) NULL DEFAULT NULL COMMENT '会议模板ID',
                                                                 ...
                                                                 CONSTRAINT `busi_mcu_tencent_template_polling_paticipant_ibfk_1` FOREIGN KEY (`template_conference_id`) REFERENCES `busi_mcu_tencent_template_conference` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
                                                                 CONSTRAINT `busi_mcu_tencent_template_polling_paticipant_ibfk_2` FOREIGN KEY (`polling_scheme_id`) REFERENCES `busi_mcu_tencent_template_polling_scheme` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'TENCENT_MCU轮询方案的参会者' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for busi_mcu_tencent_template_polling_scheme
-- ----------------------------
DROP TABLE IF EXISTS `busi_mcu_tencent_template_polling_scheme`;
CREATE TABLE `busi_mcu_tencent_template_polling_scheme`  (
                                                             `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
                                                             `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
                                                             `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
                                                             `template_conference_id` bigint(20) NULL DEFAULT NULL COMMENT '会议模板ID',
                                                             ...
                                                             CONSTRAINT `busi_mcu_tencent_template_polling_scheme_ibfk_1` FOREIGN KEY (`template_conference_id`) REFERENCES `busi_mcu_tencent_template_conference` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'TENCENT_MCU轮询方案' ROW_FORMAT = Dynamic;
