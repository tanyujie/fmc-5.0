...
select 'fme'     mcu_type, id, create_time, update_time, dept_id, template_id, is_auto_create_template, start_time, end_time, status, extend_minutes, repeat_rate, is_hang_up, repeat_date, password, attendee_limit, is_start, start_failed_reason, type
from busi_conference_appointment
union all
select 'mcu-zj'  mcu_type, id, create_time, update_time, dept_id, template_id, is_auto_create_template, start_time, end_time, status, extend_minutes, repeat_rate, is_hang_up, repeat_date, password, attendee_limit, is_start, start_failed_reason, type
from busi_mcu_zj_conference_appointment
union all
select 'mcu-plc' mcu_type, id, create_time, update_time, dept_id, template_id, is_auto_create_template, start_time, end_time, status, extend_minutes, repeat_rate, is_hang_up, repeat_date, password, attendee_limit, is_start, start_failed_reason, type
from busi_mcu_plc_conference_appointment
union all
select 'mcu-kdc' mcu_type, id, create_time, update_time, dept_id, template_id, is_auto_create_template, start_time, end_time, status, extend_minutes, repeat_rate, is_hang_up, repeat_date, password, attendee_limit, is_start, start_failed_reason, type
from busi_mcu_kdc_conference_appointment
union all
select 'smc3' mcu_type, id, create_time, update_time, dept_id, template_id, is_auto_create_template, start_time, end_time, status, extend_minutes, repeat_rate, is_hang_up, repeat_date, password, attendee_limit, is_start, start_failed_reason, type
from busi_mcu_smc3_conference_appointment
union all
select 'smc2' mcu_type, id, create_time, update_time, dept_id, template_id, is_auto_create_template, start_time, end_time, status, extend_minutes, repeat_rate, is_hang_up, repeat_date, password, attendee_limit, is_start, start_failed_reason, type
from busi_mcu_smc2_conference_appointment
union all
select 'mcu-tencent' mcu_type, id, create_time, update_time, dept_id, template_id, is_auto_create_template, start_time, end_time, status, extend_minutes, repeat_rate, is_hang_up, repeat_date, password, attendee_limit, is_start, start_failed_reason, type
from busi_mcu_tencent_conference_appointment
union all
select 'mcu-ding' mcu_type, id, create_time, update_time, dept_id, template_id, is_auto_create_template, start_time, end_time, status, extend_minutes, repeat_rate, is_hang_up, repeat_date, password, attendee_limit, is_start, start_failed_reason, type
from busi_mcu_ding_conference_appointment
union all
select 'mcu-hwcloud' mcu_type, id, create_time, update_time, dept_id, template_id, is_auto_create_template, start_time, end_time, status, extend_minutes, repeat_rate, is_hang_up, repeat_date, password, attendee_limit, is_start, start_failed_reason, type
