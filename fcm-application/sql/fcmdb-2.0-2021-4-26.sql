...
) ENGINE = InnoDB AUTO_INCREMENT = 154 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '入会方案配置，控制参会者进入会议的方案' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of busi_call_leg_profile
-- ----------------------------
INSERT INTO `busi_call_leg_profile` VALUES (153, '2021-04-26 11:51:06', NULL, 'ab48996b-221d-45be-a127-2994d0e7c039', NULL, 100, 54);
...
) ENGINE = InnoDB AUTO_INCREMENT = 55 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'FME终端信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of busi_fme
-- ----------------------------
INSERT INTO `busi_fme` VALUES (54, '2021-04-25 18:50:18', '2021-04-26 13:38:01', 'admin', 'P@rad1se', '192.166.1.3', '192.166.1.3', NULL, 9443, 1, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 44 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'FME组分配租户的中间表（一个FME组可以分配给多个租户，一对多）' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of busi_fme_dept
-- ----------------------------
INSERT INTO `busi_fme_dept` VALUES (42, '2021-04-25 18:50:25', NULL, 100, 1, 54);
INSERT INTO `busi_fme_dept` VALUES (43, '2021-04-26 10:13:44', NULL, 1, 1, 54);
...
CREATE TABLE `busi_fsbc_registration_server`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '终端FSBC注册服务器' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'FSBC服务器-部门映射' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 285 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '终端信息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 220 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '部门表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_dept` VALUES (219, 100, '0,1,100', 'XX公司', 1, NULL, NULL, NULL, '0', '0', 'admin', '2021-04-26 11:43:53', '', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 751 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_role` VALUES (6, '用户管理员', 'userAdmin', 4, '1', 1, 1, 100, '0', '0', 'superAdmin', '2021-04-26 10:20:04', 'superAdmin', '2021-04-26 10:21:15', NULL);
...
INSERT INTO `sys_user` VALUES (100, 100, 'admin', '管理员', '00', '', '', '0', '', '$2a$10$d1wmaSUmRR8bs.Djrx5Bouyb4bE9i/0tn5nfAdfjiMd41IZcqFSp2', '0', '0', '', NULL, 'superAdmin', '2021-01-19 11:38:00', 'superAdmin', '2021-04-26 11:39:11', NULL);
...
INSERT INTO `sys_user` VALUES (105, 219, 'xxAdmin', 'xxAdmin', '00', '', '', '0', '', '$2a$10$OTHLIPcIUp5a1Yj9CSyWKewdq0eoEtXs81iYje/LYSXlE0ZnUnfrq', '0', '0', '', NULL, 'admin', '2021-04-26 11:44:42', '', NULL, NULL);
