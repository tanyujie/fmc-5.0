package com.paradisecloud.fcm.web.controller.infodisplay;
 ...
 */
@RestController
@RequestMapping("/busi/infodisplay")
@Tag(name = "信息展示")
public class BusiInfoDisplayController extends BaseController
{
    @Resource
