 ...
 */
@RestController
@RequestMapping("/mobileWeb/history")
@Tag(name = "历史会议、参会者记录统计")
public class MobileWebHistoryController extends BaseController {
    private static final Logger log = LoggerFactory.getLogger(MobileWebHistoryController.class);
    @Autowired
