 ...
 */
@RestController
@RequestMapping("/busi/mcu/smc3/attendee")
@Tag(name = "参会者控制器")
public class AttendeeSmc3Controller extends BaseController
{
    ...
    {
        //attendeeSmc3Service.sendMessage(conferenceId, jsonObject);
        return success();
    }
    ...
    {
        attendeeSmc3Service.setMessageBannerText(conferenceId, jsonObject);
        return success();
    }
