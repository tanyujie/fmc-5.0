 ...
 * 只用于MTR探测
 */
public abstract class SshRemoteServerOperateForServerStart
{
	private static final Logger LOGGER = LoggerFactory.getLogger(SshRemoteServerOperateForServerStart.class);
	private Session session;// JSCH session
	private boolean logined = false;// 是否登陆

	private static final SshRemoteServerOperateForServerStart INSTANCE = new SshRemoteServerOperateForServerStart()
	{

	};

	public static SshRemoteServerOperateForServerStart getInstance()
	{
		return INSTANCE;
	}
