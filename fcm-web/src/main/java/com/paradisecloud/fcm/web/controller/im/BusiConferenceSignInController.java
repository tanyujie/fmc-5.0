...
public class BusiConferenceSignInController extends BaseController {
    ...
    @PostMapping("/user/signIn/add")
    public RestResponse add(@RequestBody BusiConferenceUserSignInVO userSignIn) {
    ...
    public RestResponse reinit(@RequestBody BusiConferenceSignInVO option) {
        ...
        try {
            // 1. 校验会议是否存在
            if (  StringUtils.isEmpty(option.getConfId())) {
