...
@Service
public class BusiAllConferenceAppointmentServiceImpl implements IBusiAllConferenceAppointmentService {

    private static final Logger logger = LoggerFactory.getLogger(BusiAllConferenceAppointmentServiceImpl.class);
