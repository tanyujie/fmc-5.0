 ...
 */
@RestController
@RequestMapping("/mobileWeb/mcu/all/templateConference")
@Tag(name = "会议模板")
public class MobileWebAllTemplateConferenceController extends BaseController {
    ...
    public RestResponse list(ViewTemplateConference viewTemplateConference) {
        ...
        viewTemplateConferenceAll.setMcuType(null);
