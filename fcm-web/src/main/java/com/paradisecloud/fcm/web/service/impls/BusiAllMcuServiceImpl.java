...
@Service
public class BusiAllMcuServiceImpl implements IBusiAllMcuService {
    ...
    public List<McuTypeVo> getMcuTypeList(Long deptId) {
        ...
        //zte
        {
            McuZteBridgeCollection mcuBridgeCollection = McuZteBridgeCache.getInstance().getAvailableMcuZteBridgesByDept(deptId);
            if (mcuBridgeCollection != null) {
                ...
                if (busiMcuZteDept != null) {
                    Long deptIdNew = busiMcuZteDept.getDeptId();
                    deptIdBind = deptIdNew;
                    SysDept sysDept = SysDeptCache.getInstance().get(deptIdNew);
                    if (sysDept != null) {
                        deptAncestors = sysDept.getAncestors();
     ...
     */
    @Override
    public List<McuTypeVo> getLiveMcuTypeList(Long deptId) {
        Assert.isTrue(deptId != null, "部门ID不能为空！");
        List<McuTypeVo> mcuTypeList = new ArrayList<>();
        //fme
        {
