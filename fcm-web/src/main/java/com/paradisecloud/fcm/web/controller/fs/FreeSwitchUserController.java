...
//        startPage();
    ...
    {
        return RestResponse.success(freeSwitchUserService.selectFreeSwitchUserById(userId.toString(), deptId));
    }
...
//     * 修改freeSwitch
//     */
//    @PutMapping("/updateFreeSwitch")
//    @Operation(summary = "修改freeSwitch")
//    public RestResponse edits(@RequestBody BusiTerminal busiTerminal)
//    {
//    	freeSwitchUserService.updateFreeSwitchUser(busiTerminal);
//        return success(busiTerminal);
//    }
