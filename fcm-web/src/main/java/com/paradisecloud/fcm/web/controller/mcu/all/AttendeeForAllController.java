...
import com.paradisecloud.fcm.web.model.ChangeConferenceRoomVo;
 ...
 */
@RestController
@RequestMapping("/busi/mcu/all/attendee")
@Tag(name = "参会者控制器")
public class AttendeeForAllController extends BaseController {
    ...
    @PutMapping("/changeConferenceRoom")
    @Operation(summary = "转移会议")
    public RestResponse changeConferenceRoom(@RequestBody ChangeConferenceRoomVo changeConferenceRoomVo) {
        String conferenceId = changeConferenceRoomVo.getConferenceIdOld();
        List<String> attendeeIds = changeConferenceRoomVo.getAttendeeIds();
        String conferenceIdNew = changeConferenceRoomVo.getConferenceIdNew();
        ConferenceIdVo conferenceIdVo = EncryptIdUtil.parasConferenceId(conferenceId);
        McuType mcuType = conferenceIdVo.getMcuType();
            ...
            case MCU_ZTE: {
                ...
                if (conferenceContext != null) {
                    ...
                    for (String attendeeId : attendeeIds) {
                        ...
                        attendeeForMcuZteService.remove(conferenceId, attendeeId);
                        logger.info("Removed attendeeId: " + attendeeId);

                        attendeeForMcuZteService.invite(conferenceIdNew, Arrays.asList(terminalId));
