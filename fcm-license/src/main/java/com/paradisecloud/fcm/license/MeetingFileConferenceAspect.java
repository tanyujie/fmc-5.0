...
public class MeetingFileConferenceAspect {
    ...
    public MeetingFileConferenceAspect() {
    }
    @Pointcut("execution (* com.paradisecloud.fcm.web.controller.mobile.web.MobileWebMeetingFileController.displayInConference(..))||execution(* com.paradisecloud.fcm.web.controller.mcu.all.BusiMeetingFileController.displayInConference(..))")
    ...
    public void before(JoinPoint joinPoint) throws Exception {
        ...
        boolean schedule = (boolean) extra.get("fileMeeting");
        if (!schedule) {
            throw new CustomException("文件入会没在授权范围内,请联系供应商授权后使用");
        }
