/**
 * GetVoiceRecordCtrlUrlRequest.java
 *
...
public class GetVoiceRecordCtrlUrlRequest  implements java.io.Serializable {
    private String conferenceIdentifier;

    public GetVoiceRecordCtrlUrlRequest() {
    }
    ...
    /**
     * Gets the conferenceIdentifier value for this GetVoiceRecordCtrlUrlRequest.
     * 
    ...
    /**
     * Sets the conferenceIdentifier value for this GetVoiceRecordCtrlUrlRequest.
     * 
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof GetVoiceRecordCtrlUrlRequest)) return false;
        GetVoiceRecordCtrlUrlRequest other = (GetVoiceRecordCtrlUrlRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetVoiceRecordCtrlUrlRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://request.m900.zte.com", "GetVoiceRecordCtrlUrlRequest"));
