...
public class PauseRecordRequest  extends com.zte.m900.request.Request  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://request.m900.zte.com", "PauseRecordRequest"));
    }
