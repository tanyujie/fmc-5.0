...
public class LogoutRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the userName value for this LogoutRequest.
     * 
     * @return userName
     */
    ...
    /**
     * Sets the userName value for this LogoutRequest.
     * 
     * @param userName
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://request.m900.zte.com", "LogoutRequest"));
