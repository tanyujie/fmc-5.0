/**
 * GetConferenceDraftListResponse.java
 *
...
public class GetConferenceDraftListResponse  extends com.zte.m900.response.ConferenceResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the conferenceList value for this GetConferenceDraftListResponse.
     * 
    ...
    /**
     * Sets the conferenceList value for this GetConferenceDraftListResponse.
     * 
    ...
    /**
     * Gets the counts value for this GetConferenceDraftListResponse.
     * 
     * @return counts
     */
    ...
    /**
     * Sets the counts value for this GetConferenceDraftListResponse.
     * 
     * @param counts
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof GetConferenceDraftListResponse)) return false;
        GetConferenceDraftListResponse other = (GetConferenceDraftListResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetConferenceDraftListResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://response.m900.zte.com", "GetConferenceDraftListResponse"));
