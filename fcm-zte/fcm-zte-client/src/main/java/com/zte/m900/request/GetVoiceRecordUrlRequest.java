...
public class GetVoiceRecordUrlRequest  implements java.io.Serializable {
    private String conferenceIdentifier;

    public GetVoiceRecordUrlRequest() {
    }
    ...
    /**
     * Gets the conferenceIdentifier value for this GetVoiceRecordUrlRequest.
     * 
    ...
    /**
     * Sets the conferenceIdentifier value for this GetVoiceRecordUrlRequest.
     * 
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof GetVoiceRecordUrlRequest)) return false;
        GetVoiceRecordUrlRequest other = (GetVoiceRecordUrlRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetVoiceRecordUrlRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://request.m900.zte.com", "GetVoiceRecordUrlRequest"));
