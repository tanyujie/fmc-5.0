...
public class CreateConferenceRequest  extends com.zte.m900.request.ConferenceRequest  implements java.io.Serializable {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof CreateConferenceRequest)) return false;
        CreateConferenceRequest other = (CreateConferenceRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateConferenceRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://request.m900.zte.com", "CreateConferenceRequest"));
    }
