...
public class LoginResponse  extends com.zte.m900.response.ConferenceResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the randomKey value for this LoginResponse.
     * 
     * @return randomKey
     */
    ...
    /**
     * Sets the randomKey value for this LoginResponse.
     * 
     * @param randomKey
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://response.m900.zte.com", "LoginResponse"));
