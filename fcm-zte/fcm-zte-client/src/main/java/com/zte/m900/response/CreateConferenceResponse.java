...
public class CreateConferenceResponse  extends com.zte.m900.response.ConferenceResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the conferenceIdentifier value for this CreateConferenceResponse.
     * 
    ...
    /**
     * Sets the conferenceIdentifier value for this CreateConferenceResponse.
     * 
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof CreateConferenceResponse)) return false;
        CreateConferenceResponse other = (CreateConferenceResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateConferenceResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://response.m900.zte.com", "CreateConferenceResponse"));
