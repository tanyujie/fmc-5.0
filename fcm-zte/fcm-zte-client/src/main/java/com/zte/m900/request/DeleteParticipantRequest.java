...
public class DeleteParticipantRequest  extends com.zte.m900.request.ParticipantRequest  implements java.io.Serializable {
    private String conferenceIdOption;

    private String terminalIdOption;

    public DeleteParticipantRequest() {
    }
    ...
    /**
     * Gets the conferenceIdOption value for this DeleteParticipantRequest.
     * 
    ...
    /**
     * Sets the conferenceIdOption value for this DeleteParticipantRequest.
     * 
    ...
    /**
     * Gets the terminalIdOption value for this DeleteParticipantRequest.
     * 
    ...
    /**
     * Sets the terminalIdOption value for this DeleteParticipantRequest.
     * 
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof DeleteParticipantRequest)) return false;
        DeleteParticipantRequest other = (DeleteParticipantRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DeleteParticipantRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://request.m900.zte.com", "DeleteParticipantRequest"));
