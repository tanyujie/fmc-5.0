/**
 * CancelMuteParticipantRequest.java
 *
...
public class CancelMuteParticipantRequest  extends com.zte.m900.request.TerCtrlRequest  implements java.io.Serializable {
    private String conferenceIdOption;

    private String terminalIdOption;

    public CancelMuteParticipantRequest() {
    }
    ...
    /**
     * Gets the conferenceIdOption value for this CancelMuteParticipantRequest.
     * 
    ...
    /**
     * Sets the conferenceIdOption value for this CancelMuteParticipantRequest.
     * 
    ...
    /**
     * Gets the terminalIdOption value for this CancelMuteParticipantRequest.
     * 
    ...
    /**
     * Sets the terminalIdOption value for this CancelMuteParticipantRequest.
     * 
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof CancelMuteParticipantRequest)) return false;
        CancelMuteParticipantRequest other = (CancelMuteParticipantRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CancelMuteParticipantRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://request.m900.zte.com", "CancelMuteParticipantRequest"));
