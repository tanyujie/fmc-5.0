 ...
 * @version V1.0  
 */
public class McuZteClusterCache extends JavaCache<Long, BusiMcuZteCluster>
{
    ...
    private static final McuZteClusterCache INSTANCE = new McuZteClusterCache();
     ...
     */
    private McuZteClusterCache()
    {
    }
    
    public static McuZteClusterCache getInstance()
    {
        return INSTANCE;
    }
}
