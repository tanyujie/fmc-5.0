...
public class McuZteMuteStatusCheckTask extends DelayTask {

    private McuZteConferenceContext conferenceContext;

    public McuZteMuteStatusCheckTask(String id, long delayInMilliseconds, McuZteConferenceContext conferenceContext) {
    ...
    public void run() {
        if (conferenceContext != null) {
            ...
            if (conferenceContext.getMasterAttendee() != null) {
                AttendeeForMcuZte attendee = conferenceContext.getMasterAttendee();
