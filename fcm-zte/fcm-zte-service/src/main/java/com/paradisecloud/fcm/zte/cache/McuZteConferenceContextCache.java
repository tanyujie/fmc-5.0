 ...
 * @version V1.0  
 */
public class McuZteConferenceContextCache extends BaseConferenceContextCache<McuZteConferenceContext>
{
    ...
    private static final McuZteConferenceContextCache INSTANCE = new McuZteConferenceContextCache();
    /**
     * key 会议名
     */
    private Map<String, McuZteConferenceContext> conferenceNameContextMap = new ConcurrentHashMap<>();
    
    /**
     * 用于缓存级联会议，方便根据级联ID快速查找所有级联在一起的会议
     */
    private Map<String, Map<String, McuZteConferenceContext>> cascadeConferenceContextsMap = new ConcurrentHashMap<>();
    
    private McuZteConferenceContextCache()
    {
        
    }
    
    public void addCascadeConferenceContext(String upContextKey, McuZteConferenceContext conferenceContext)
    {
        Map<String, McuZteConferenceContext> cascadeConferenceContexts = cascadeConferenceContextsMap.get(upContextKey);
    ...
    public void add(McuZteConferenceContext conferenceContext)
    {
    ...
    public void remove(String contextKey) {
        McuZteConferenceContext conferenceContext = super.remove(contextKey);
        if (conferenceContext != null) {
            conferenceNameContextMap.remove(conferenceContext.getName());
        }
    }

    public McuZteConferenceContext getByConferenceName(String conferenceName) {
     ...
     */
    public Map<String, McuZteConferenceContext> deleteCascadeConferenceContexts(String upContextKey)
    {
    ...
    {
        McuZteConferenceContext cc = get(upContextKey);
        if (cc != null)
        {
            conferenceContextProcessor.process(cc);
            Map<String, McuZteConferenceContext> cascadeConferenceContexts = deleteCascadeConferenceContexts(upContextKey);
            if (cascadeConferenceContexts != null)
            {
     ...
     */
    public McuZteConferenceContext getUpConferenceContext(McuZteConferenceContext cc)
    {
        for (Entry<String, Map<String, McuZteConferenceContext>> e : cascadeConferenceContextsMap.entrySet())
        {
            String upCn = e.getKey();
            Map<String, McuZteConferenceContext> ccMap = e.getValue();
    ...
    public void upwardProcessingConferenceContext(McuZteConferenceContext cc, ConferenceContextProcessor conferenceContextProcessor)
    {
        conferenceContextProcessor.process(cc);
    ...
    public void downwardProcessingConferenceContext(McuZteConferenceContext cc, ConferenceContextProcessor conferenceContextProcessor)
    {
        if (cc != null)
        {
            conferenceContextProcessor.process(cc);
            ...
            Map<String, McuZteConferenceContext> cascadeConferenceContexts = cascadeConferenceContextsMap.get(cc.getContextKey());
            if (cascadeConferenceContexts != null)
            {
                for (Entry<String, McuZteConferenceContext> e : cascadeConferenceContexts.entrySet())
                {
     ...
     * @param conferenceContextProcessor void
     */
    public void downwardProcessingCascadeConferenceContext(McuZteConferenceContext cc, ConferenceContextProcessor conferenceContextProcessor)
    {
        if (cc != null)
        {
            conferenceContextProcessor.process(cc);
...
//            }
    ...
    public McuZteConferenceContext getMainConferenceContext(String contextKey)
    {
        return getMainConferenceContext(get(contextKey));
    }
    
    public McuZteConferenceContext getMainConferenceContext(McuZteConferenceContext conferenceContext)
    {
        if (conferenceContext == null)
        {
            return null;
        ...
        GenericValue<McuZteConferenceContext> v = new GenericValue<>();
    ...
    {
        void process(McuZteConferenceContext conferenceContext);
    }
    ...
    public static McuZteConferenceContextCache getInstance()
    {
        return INSTANCE;
    }
}
