package com.paradisecloud.fcm.zte.monitor.ct;
    ...
    public void run() {
        ...
        while (true) {
            ...
            try {
                ...
                BusiMcuZteConferenceAppointmentMapper busiMcuZteConferenceAppointmentMapper = BeanFactory.getBean(BusiMcuZteConferenceAppointmentMapper.class);
                ...
                List<BusiHistoryConference> notEndConferences = busiHistoryConferenceMapper.selectNotEndHistoryConferenceList(McuType.MCU_ZTE.getCode());
                if (!ObjectUtils.isEmpty(notEndConferences)) {
                    for (BusiHistoryConference busiHistoryConference : notEndConferences) {
                        ...
                        busiMcuZteTemplateConferenceCon.setLastConferenceId(busiHistoryConference.getId());
                        ...
                        if (busiMcuZteTemplateConferenceList == null || busiMcuZteTemplateConferenceList.size() == 0) {
                            ...
                            busiMcuZteConferenceAppointmentCon.setTemplateId(busiMcuZteTemplateConference.getId());
                            ...
                            if (conferenceContext != null) {
                                if (conferenceContext.isAutoCallTerminal()) {
                                    ...
                                    McuZteConferenceContextUtils.eachAttendeeInConference(conferenceContext, (a) -> {
                                        ...
                                        } else if (a instanceof InvitedAttendeeForMcuZte) {
                                            InvitedAttendeeForMcuZte ia = (InvitedAttendeeForMcuZte) a;
