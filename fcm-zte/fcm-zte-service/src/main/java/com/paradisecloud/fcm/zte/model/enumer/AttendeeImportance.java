...
public enum AttendeeImportance
{
    ...
    {
        @Override
        public void processAttendeeWebsocketMessage(AttendeeForMcuZte attendee)
        {
    ...
    MASTER(7500000, 7500000, "主会场")
    {
        ...
        public void processAttendeeWebsocketMessage(AttendeeForMcuZte attendee)
        {
            ...
            if (!(attendee instanceof McuAttendeeForMcuZte))
            {
                McuZteConferenceContext mainConferenceContext = McuZteConferenceContextCache.getInstance().getMainConferenceContext(attendee.getConferenceNumber());
                if (mainConferenceContext != null && mainConferenceContext.getMasterAttendee() != attendee)
                {
                    AttendeeForMcuZte oldMasterAttendee = mainConferenceContext.getMasterAttendee();
     ...
     * @param attendee void
     */
    public abstract void processAttendeeWebsocketMessage(AttendeeForMcuZte attendee);
