...
public class McuZteSendJoinConferenceToTerminalTask extends DelayTask {

    private McuZteConferenceContext conferenceContext;
    private AttendeeForMcuZte attendee;

    public McuZteSendJoinConferenceToTerminalTask(String id, long delayInMilliseconds, McuZteConferenceContext conferenceContext, AttendeeForMcuZte attendee) {
