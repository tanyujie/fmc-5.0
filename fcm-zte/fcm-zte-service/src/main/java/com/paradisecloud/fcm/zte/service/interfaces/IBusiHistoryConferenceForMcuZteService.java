 ...
 * @date 2021-01-20
 */
public interface IBusiHistoryConferenceForMcuZteService
{
    /**
     * 查询历史会议，每次挂断会保存该历史记录
     * 
     ...
     */
    BusiHistoryConference saveHistory(McuZteConferenceContext conferenceContext);
     ...
     * @param conferenceContext void
     */
    BusiHistoryConference saveHistory(BusiHistoryConference busiHistoryConference, McuZteConferenceContext conferenceContext);
     ...
     * @param attendee
     */
    void updateBusiHistoryParticipant(McuZteConferenceContext conferenceContext, AttendeeForMcuZte attendee, boolean updateMediaInfo);
