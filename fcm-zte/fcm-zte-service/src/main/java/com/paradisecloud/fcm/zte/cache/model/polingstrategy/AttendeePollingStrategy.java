...
public abstract class AttendeePollingStrategy
{
     ...
     */
    public abstract List<PollingAttendee> parse(McuZteConferenceContext conferenceContext, List<DeptPollingAttendees> deptPollingAttendeesList, SplitScreen splitScreen);
    
    protected List<PollingAttendee> parseSpecifiedRangeAndDeptFirst(McuZteConferenceContext conferenceContext, List<DeptPollingAttendees> deptPollingAttendeesList)
    {
     ...
     * @return List<PollingAttendee>
     */
    protected List<PollingAttendee> parseGlobalPolling(McuZteConferenceContext conferenceContext, Map<String, PollingAttendee> m, SplitScreen splitScreen)
    {
        List<PollingAttendee> pollingAttendeeList = new ArrayList<>();
        if (conferenceContext.getMasterAttendee() != null)
        {
            ...
            {
                List<AttendeeForMcuZte> as = conferenceContext.getCascadeAttendeesMap().get(conferenceContext.getMasterAttendee().getDeptId());
                if (as != null)
                {
                    for (AttendeeForMcuZte attendee : new ArrayList<>(as))
                    {
        ...
        {
            add(pollingAttendeeList, attendee, m, splitScreen);
            List<AttendeeForMcuZte> as = conferenceContext.getCascadeAttendeesMap().get(attendee.getDeptId());
            if (as != null)
            {
                for (AttendeeForMcuZte a : new ArrayList<>(as))
                {
     ...
     * @return List<PollingAttendee>
     */
    protected List<PollingAttendee> parseGlobalPollingAndDeptFirst(McuZteConferenceContext conferenceContext, Map<String, PollingAttendee> m, SplitScreen splitScreen)
    {
        List<PollingAttendee> pollingAttendeeList = new ArrayList<>();
        if (conferenceContext.getMasterAttendee() != null)
        {
        ...
        for (AttendeeForMcuZte attendee : new ArrayList<>(conferenceContext.getMasterAttendees()))
        {
            add(pollingAttendeeList, attendee, m, splitScreen);
        }
    ...
    private void add(List<PollingAttendee> pollingAttendeeList, AttendeeForMcuZte a, Map<String, PollingAttendee> m, SplitScreen splitScreen)
    {
