...
public class CellScreen implements Serializable
{
     ...
     * 分屏单元格需要渲染的参会者
     */
    private List<AttendeeForMcuZte> attendees = new ArrayList<>();
     ...
     */
    @JsonIgnore
    private AttendeeForMcuZte lastOperationAttendee;
    ...
    public void addAttendee(AttendeeForMcuZte a)
    {
        attendees.add(a);
    }
     ...
     */
    public AttendeeForMcuZte getLastOperationAttendee()
    {
        return lastOperationAttendee;
    }
     ...
     */
    public void setLastOperationAttendee(AttendeeForMcuZte lastOperationAttendee)
    {
     ...
     */
    @JsonIgnore
    public AttendeeForMcuZte getPollingAttendee()
    {
