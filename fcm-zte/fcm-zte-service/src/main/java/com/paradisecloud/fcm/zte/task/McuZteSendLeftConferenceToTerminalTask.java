...
public class McuZteSendLeftConferenceToTerminalTask extends DelayTask {

    private McuZteConferenceContext conferenceContext;
    private AttendeeForMcuZte attendee;

    public McuZteSendLeftConferenceToTerminalTask(String id, long delayInMilliseconds, McuZteConferenceContext conferenceContext, AttendeeForMcuZte attendee) {
