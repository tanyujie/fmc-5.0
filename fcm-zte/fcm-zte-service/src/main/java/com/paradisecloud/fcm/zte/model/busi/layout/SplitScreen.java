...
public abstract class SplitScreen implements Serializable
{
     ...
     * 分屏需要渲染的参会者
     */
    protected List<AttendeeForMcuZte> attendees = new ArrayList<>();
     ...
     */
    public void processImportance(List<AttendeeForMcuZte> as, ImportanceProcessor importanceProcessor)
    {
