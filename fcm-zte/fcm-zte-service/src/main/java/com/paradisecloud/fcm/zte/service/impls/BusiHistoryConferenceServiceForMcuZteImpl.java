...
import com.paradisecloud.fcm.zte.task.EndConferenceTask;
import com.paradisecloud.fcm.zte.task.McuZteDelayTaskService;
import com.paradisecloud.fcm.zte.task.StatisticalConferenceTask;
import com.paradisecloud.fcm.zte.task.UpdateAttendeeMediaInfoTask;
...
@Transactional
@Service
public class BusiHistoryConferenceServiceForMcuZteImpl implements IBusiHistoryConferenceForMcuZteService {
     ...
     * @return
     */
    public BusiHistoryConference saveHistory(McuZteConferenceContext conferenceContext) {
        try {
            ...
            mcuZteDelayTaskService.addTask(statisticalConferenceTask);
    ...
    public BusiHistoryConference saveHistory(BusiHistoryConference busiHistoryConference, McuZteConferenceContext conferenceContext) {
        try {
            busiHistoryConference.setConferenceStartTime(conferenceContext.getStartTime());
            ...
            if (busiHistoryConference.getConferenceEndTime() != null) {
                ...
                mcuZteDelayTaskService.addTask(endConferenceTask);
            }
     ...
     */
    @Override
    public void updateBusiHistoryParticipant(McuZteConferenceContext conferenceContext, AttendeeForMcuZte attendee, boolean updateMediaInfo) {
            ...
            if (busiHistoryConference != null) {
                ...
                if (busiHistoryParticipant != null) {
                    if (busiHistoryParticipant.getJoined() == null || !busiHistoryParticipant.getJoined()) {
                        ...
                        if (updateMediaInfo) {
                            try {
                                JSONObject jsonObject = attendeeForMcuZteService.detail(conferenceContext, attendee);
                                if (jsonObject != null) {
                            ...
                            mcuZteDelayTaskService.addTask(updateAttendeeMediaInfoTask);
                        }
                    }
                } else {
