 ...
 * @version V1.0  
 */
public class ThreeSplitScreen extends SplitScreen
{
     ...
     * 布局
     */
    public static final String LAYOUT = "three";
     ...
     * @since 2021-02-09 14:38
     */
    public ThreeSplitScreen(int maxImportance)
    {
        super(3, maxImportance);
        this.layout = LAYOUT;
    }
}
