 ...
 * @version V1.0  
 */
public interface IAttendeeForMcuZteService
{
     ...
     * @since 2021-02-09 11:32  void
     */
    void defaultChooseSee(McuZteConferenceContext mainConferenceContext);
     ...
     * @param conferenceId
     */
    void cancelChooseSee(String conferenceId);
     ...
     */
    void cancelCurrentOperation(McuZteConferenceContext conferenceContext);
     ...
     * @param conferenceId
     * @param attendeeId
     * @see IAttendeeForMcuZteService#callTheRoll(String, String)
     */
     ...
     * @since 2021-02-22 18:07
     */
    void openMixing(McuZteConferenceContext cc);
     ...
     * @param cc void
     */
    void closeMixing(McuZteConferenceContext cc, AttendeeForMcuZte... excludes);
     ...
     * @param text void
     */
    void setMessageBannerText(String contextKey, String text);
     ...
     * @param attendee void
     */
    JSONObject detail(McuZteConferenceContext conferenceContext, AttendeeForMcuZte attendee);
    ...
    Object getCameraInfo(String conferenceId, String attendeeId);
