package com.paradisecloud.fcm.zte.model.busi.attendee;
 ...
 * @version V1.0
 */
public abstract class AttendeeForMcuZte extends BaseAttendee implements Serializable, Comparable<AttendeeForMcuZte>
{
     ...
     * 允许双流状态
     */
    private volatile int presentStatus_enable = YesOrNo.YES.getValue();
    ...
    public int getPresentStatus_enable() {
        return presentStatus_enable;
    }

    public void setPresentStatus_enable(int presentStatus) {
        if (this.presentStatus_enable != presentStatus) {
            this.presentStatus_enable = presentStatus;
            updatePresentStatus_enable();
        }
    }
    public synchronized void updatePresentStatus_enable() {
        updateMap.put("presentStatus_enable", presentStatus_enable);
    }
     ...
     * @param attendee void
     */
    public void syncTo(AttendeeForMcuZte attendee)
    {
        ...
        // 已配置的终端与会者
        if (attendee instanceof TerminalAttendeeForMcuZte && this instanceof TerminalAttendeeForMcuZte)
        {
            TerminalAttendeeForMcuZte terminalAttendee = (TerminalAttendeeForMcuZte) attendee;
            TerminalAttendeeForMcuZte thisTerminalAttendee = (TerminalAttendeeForMcuZte) this;
    ...
    @Override
    public int compareTo(AttendeeForMcuZte o)
    {
