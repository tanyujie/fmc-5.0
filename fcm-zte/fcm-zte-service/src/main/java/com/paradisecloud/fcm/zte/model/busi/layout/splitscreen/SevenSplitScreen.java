 ...
 * @version V1.0  
 */
public class SevenSplitScreen extends SplitScreen
{
     ...
     * 布局
     */
    public static final String LAYOUT = "seven";
     ...
     * @since 2021-02-09 14:38
     */
    public SevenSplitScreen(int maxImportance)
    {
        super(7, maxImportance);
        this.layout = LAYOUT;
    }
