...
import com.paradisecloud.fcm.mcu.kdc.task.EndConferenceTask;
import com.paradisecloud.fcm.mcu.kdc.task.StatisticalConferenceTask;
import com.paradisecloud.fcm.mcu.kdc.task.UpdateAttendeeMediaInfoTask;
...
@Transactional
@Service
public class BusiHistoryConferenceServiceForMcuKdcImpl implements IBusiHistoryConferenceForMcuKdcService {
     ...
     * @return
     */
    public BusiHistoryConference saveHistory(McuKdcConferenceContext conferenceContext) {
        try {
            ...
            mcuKdcDelayTaskService.addTask(statisticalConferenceTask);
    ...
    public BusiHistoryConference saveHistory(BusiHistoryConference busiHistoryConference, McuKdcConferenceContext conferenceContext) {
        try {
            busiHistoryConference.setConferenceStartTime(conferenceContext.getStartTime());
            ...
            if (busiHistoryConference.getConferenceEndTime() != null) {
                ...
                mcuKdcDelayTaskService.addTask(endConferenceTask);
            }
     ...
     */
    @Override
    public void updateBusiHistoryParticipant(McuKdcConferenceContext conferenceContext, AttendeeForMcuKdc attendee, boolean updateMediaInfo) {
            ...
            if (busiHistoryConference != null) {
                ...
                if (busiHistoryParticipant != null) {
                    if (busiHistoryParticipant.getJoined() == null || !busiHistoryParticipant.getJoined()) {
                        ...
                        if (updateMediaInfo) {
                            try {
                                JSONObject jsonObject = attendeeForMcuKdcService.detail(conferenceContext, attendee);
                                if (jsonObject != null) {
                            ...
                            mcuKdcDelayTaskService.addTask(updateAttendeeMediaInfoTask);
                        }
                    }
                } else {
