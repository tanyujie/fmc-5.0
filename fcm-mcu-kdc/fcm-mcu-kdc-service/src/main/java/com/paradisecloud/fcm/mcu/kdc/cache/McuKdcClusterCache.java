 ...
 * @version V1.0  
 */
public class McuKdcClusterCache extends JavaCache<Long, BusiMcuKdcCluster>
{
    ...
    private static final McuKdcClusterCache INSTANCE = new McuKdcClusterCache();
     ...
     */
    private McuKdcClusterCache()
    {
    }
    
    public static McuKdcClusterCache getInstance()
    {
        return INSTANCE;
    }
}
