 ...
 */
@Service
public class SimpleConferenceControlForMcuKdcServiceImpl implements ISimpleConferenceControlForMcuKdcService {

    @Resource
    IAttendeeForMcuKdcService attendeeForMcuKdcService;
     ...
     */
    @Override
    public RestResponse rollCall(McuKdcConferenceContext conferenceContext, String attendeeId) {
     ...
     */
    @Override
    public RestResponse updateDefaultViewConfigInfo(McuKdcConferenceContext conferenceContext, int splitScreenNum, boolean broadcast) {
     ...
     */
    @Override
    public RestResponse updateDefaultViewConfigInfo(McuKdcConferenceContext conferenceContext, int splitScreenNum, boolean broadcast, boolean showSelfView) {
        if (conferenceContext != null) {
     ...
     */
    @Override
    public RestResponse polling(McuKdcConferenceContext conferenceContext, int splitScreenNum, boolean broadcast) {
     ...
     */
    @Override
    public RestResponse polling(McuKdcConferenceContext conferenceContext, int splitScreenNum, boolean broadcast, boolean showSelfView) {
        if (conferenceContext != null) {
            SplitScreen splitScreen = convertSplitScreen(splitScreenNum);
     ...
     */
    @Override
    public RestResponse discuss(McuKdcConferenceContext conferenceContext) {
        if (conferenceContext != null) {
     ...
     */
    @Override
    public RestResponse recoveryLastDefaultView(McuKdcConferenceContext conferenceContext) {
        if (conferenceContext != null) {
            AttendeeOperation old = conferenceContext.getAttendeeOperation();
     ...
     */
    @Override
    public RestResponse raiseHand(McuKdcConferenceContext conferenceContext, String attendeeId, RaiseHandStatus raiseHandStatus) {
        if (conferenceContext != null) {
            attendeeForMcuKdcService.raiseHand(conferenceContext.getId(), attendeeId, raiseHandStatus);
        }
        return RestResponse.success();
    }
     ...
     */
    @Override
    public RestResponse setBanner(McuKdcConferenceContext conferenceContext, String text) {
        if (conferenceContext != null) {
            attendeeForMcuKdcService.setMessageBannerText(conferenceContext.getConferenceNumber(), text);
        }
        return RestResponse.success();
    }
     ...
     */
    @Override
    public RestResponse talk(McuKdcConferenceContext conferenceContext, String attendeeId)
    {
        if (conferenceContext.getMasterAttendee() == null || !conferenceContext.getMasterAttendee().isMeetingJoined())
        {
