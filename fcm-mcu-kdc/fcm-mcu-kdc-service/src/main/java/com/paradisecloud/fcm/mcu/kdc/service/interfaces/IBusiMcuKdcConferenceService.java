 ...
 * @date 2021-02-02
 */
public interface IBusiMcuKdcConferenceService
{
     ...
     */
    McuKdcConferenceContext buildTemplateConferenceContext(long templateConferenceId);
     ...
     */
    @Transactional
    BusiMcuKdcConferenceAppointment extendMinutes(String conferenceId, int minutes);
     ...
     */
    void stream(McuKdcConferenceContext mainConferenceContext, Boolean streaming, String streamUrl);
