...
public class McuKdcSendJoinConferenceToTerminalTask extends DelayTask {

    private McuKdcConferenceContext conferenceContext;
    private AttendeeForMcuKdc attendee;

    public McuKdcSendJoinConferenceToTerminalTask(String id, long delayInMilliseconds, McuKdcConferenceContext conferenceContext, AttendeeForMcuKdc attendee) {
        super("join_c_" + id, delayInMilliseconds);
    ...
    public void run() {
        if (conferenceContext != null) {
            if (attendee != null) {
                ...
                try {
                    String action = TerminalTopic.JOIN_CONFERENCE;
