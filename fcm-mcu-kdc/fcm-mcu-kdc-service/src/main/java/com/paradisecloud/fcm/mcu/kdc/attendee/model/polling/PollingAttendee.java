 ...
 * @version  V1.0
 */ 
package com.paradisecloud.fcm.mcu.kdc.attendee.model.polling;
...
public class PollingAttendee implements Comparable<PollingAttendee>
{
     ...
     * @param attendee 
     */
    public PollingAttendee(AttendeeForMcuKdc attendee)
    {
        super();
     ...
     * @param attendee
     */
    public void setAttendee(AttendeeForMcuKdc attendee)
    {
        this.attendee = attendee;
    }
