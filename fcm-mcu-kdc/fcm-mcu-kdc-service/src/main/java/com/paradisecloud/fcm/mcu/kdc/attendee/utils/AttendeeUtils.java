...
public class AttendeeUtils
{
    ...
    public static TerminalAttendeeForMcuKdc packTerminalAttendee(long terminalId, AttendType attendType, Map<String, Object> businessProperties, int weight, String uuid)
    {
        BusiTerminal terminal = TerminalCache.getInstance().get(terminalId);
        TerminalAttendeeForMcuKdc ta = new TerminalAttendeeForMcuKdc();
    ...
    public static TerminalAttendeeForMcuKdc packTerminalAttendee(long terminalId)
    {
        return packTerminalAttendee(terminalId, null, null, 1, UUID.randomUUID().toString());
    }
    
    public static TerminalAttendeeForMcuKdc packTerminalAttendee(BusiMcuKdcTemplateParticipant busiMcuKdcTemplateParticipant)
    {
        return packTerminalAttendee(busiMcuKdcTemplateParticipant.getTerminalId(), AttendType.convert(busiMcuKdcTemplateParticipant.getAttendType()), busiMcuKdcTemplateParticipant.getBusinessProperties(), busiMcuKdcTemplateParticipant.getWeight(), busiMcuKdcTemplateParticipant.getUuid());
    }
