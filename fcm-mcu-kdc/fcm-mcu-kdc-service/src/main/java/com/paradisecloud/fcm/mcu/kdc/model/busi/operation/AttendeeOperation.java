...
public abstract class AttendeeOperation extends BaseAttendeeOperation implements Serializable
{
     ...
     */
    @JsonIgnore
    protected volatile McuKdcConferenceContext conferenceContext;
     ...
     */
    protected volatile List<AttendeeForMcuKdc> attendees;
    ...
    @JsonIgnore
    protected List<AttendeeForMcuKdc> operatedAttendees = new ArrayList<>();
     ...
     */
    protected AttendeeOperation(McuKdcConferenceContext conferenceContext)
    {
        super();
     ...
     * @param splitScreen 
     */
    protected AttendeeOperation(McuKdcConferenceContext conferenceContext, SplitScreen splitScreen)
    {
     ...
     * @param attendees 
     */
    protected AttendeeOperation(McuKdcConferenceContext conferenceContext, SplitScreen splitScreen, List<AttendeeForMcuKdc> attendees)
    {
     ...
     */
    public List<AttendeeForMcuKdc> getOperatedAttendees()
    {
        return operatedAttendees;
    }
    ...
    public void addOperatedAttendee(AttendeeForMcuKdc a)
    {
