...
public class AttendeeCountingStatistics
{
    ...
    public AttendeeCountingStatistics(McuKdcConferenceContext cc)
    {
        ...
        for (AttendeeForMcuKdc terminalAttendee : cc.getAttendees())
        {
            total++;
        ...
        for (AttendeeForMcuKdc masterAttendee0 : cc.getMasterAttendees())
        {
            total++;
