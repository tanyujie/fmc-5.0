 ...
 * @date 2021-01-20
 */
public interface IBusiHistoryConferenceForMcuKdcService
{
    /**
     * 查询历史会议，每次挂断会保存该历史记录
     * 
     ...
     */
    BusiHistoryConference saveHistory(McuKdcConferenceContext conferenceContext);
     ...
     * @param conferenceContext void
     */
    BusiHistoryConference saveHistory(BusiHistoryConference busiHistoryConference, McuKdcConferenceContext conferenceContext);
     ...
     * @param attendee
     */
    void updateBusiHistoryParticipant(McuKdcConferenceContext conferenceContext, AttendeeForMcuKdc attendee, boolean updateMediaInfo);
