...
public abstract class AttendeePollingStrategy
{
     ...
     */
    public abstract List<PollingAttendee> parse(McuKdcConferenceContext conferenceContext, List<DeptPollingAttendees> deptPollingAttendeesList, SplitScreen splitScreen);
    
    protected List<PollingAttendee> parseSpecifiedRangeAndDeptFirst(McuKdcConferenceContext conferenceContext, List<DeptPollingAttendees> deptPollingAttendeesList)
    {
     ...
     * @return List<PollingAttendee>
     */
    protected List<PollingAttendee> parseGlobalPolling(McuKdcConferenceContext conferenceContext, Map<String, PollingAttendee> m, SplitScreen splitScreen)
    {
        List<PollingAttendee> pollingAttendeeList = new ArrayList<>();
        if (conferenceContext.getMasterAttendee() != null)
        {
            ...
            {
                List<AttendeeForMcuKdc> as = conferenceContext.getCascadeAttendeesMap().get(conferenceContext.getMasterAttendee().getDeptId());
                if (as != null)
                {
                    for (AttendeeForMcuKdc attendee : new ArrayList<>(as))
                    {
        ...
        {
            add(pollingAttendeeList, attendee, m, splitScreen);
            List<AttendeeForMcuKdc> as = conferenceContext.getCascadeAttendeesMap().get(attendee.getDeptId());
            if (as != null)
            {
                for (AttendeeForMcuKdc a : new ArrayList<>(as))
                {
     ...
     * @return List<PollingAttendee>
     */
    protected List<PollingAttendee> parseGlobalPollingAndDeptFirst(McuKdcConferenceContext conferenceContext, Map<String, PollingAttendee> m, SplitScreen splitScreen)
    {
        List<PollingAttendee> pollingAttendeeList = new ArrayList<>();
        if (conferenceContext.getMasterAttendee() != null)
        {
        ...
        for (AttendeeForMcuKdc attendee : new ArrayList<>(conferenceContext.getMasterAttendees()))
        {
            add(pollingAttendeeList, attendee, m, splitScreen);
        }
    ...
    private void add(List<PollingAttendee> pollingAttendeeList, AttendeeForMcuKdc a, Map<String, PollingAttendee> m, SplitScreen splitScreen)
    {
