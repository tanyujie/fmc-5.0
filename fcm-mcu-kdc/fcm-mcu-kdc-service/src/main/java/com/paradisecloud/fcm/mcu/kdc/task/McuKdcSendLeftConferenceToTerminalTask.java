...
public class McuKdcSendLeftConferenceToTerminalTask extends DelayTask {

    private McuKdcConferenceContext conferenceContext;
    private AttendeeForMcuKdc attendee;

    public McuKdcSendLeftConferenceToTerminalTask(String id, long delayInMilliseconds, McuKdcConferenceContext conferenceContext, AttendeeForMcuKdc attendee) {
