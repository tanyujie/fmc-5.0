...
public class McuKdcMuteStatusCheckTask extends DelayTask {

    private McuKdcConferenceContext conferenceContext;

    public McuKdcMuteStatusCheckTask(String id, long delayInMilliseconds, McuKdcConferenceContext conferenceContext) {
    ...
    public void run() {
        if (conferenceContext != null) {
            ...
            if (conferenceContext.getMasterAttendee() != null) {
                AttendeeForMcuKdc attendee = conferenceContext.getMasterAttendee();
