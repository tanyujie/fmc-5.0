...
public class CcRemoveMixingTerminalRequest extends CommonRequest {

    private String conf_id;
    private String mix_id;

    private List<CcAddMixingTerminalRequest.Mt> members;
    ...
    public List<CcAddMixingTerminalRequest.Mt> getMembers() {
        return members;
    }

    public void setMembers(List<CcAddMixingTerminalRequest.Mt> members) {
