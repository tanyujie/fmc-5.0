 ...
 * @version  V1.0
 */ 
package com.paradisecloud.fcm.mcu.kdc.model.busi.layout;
...
public class CellScreen implements Serializable
{
     ...
     * 分屏单元格需要渲染的参会者
     */
    private List<AttendeeForMcuKdc> attendees = new ArrayList<>();
     ...
     */
    @JsonIgnore
    private AttendeeForMcuKdc lastOperationAttendee;
    ...
    public void addAttendee(AttendeeForMcuKdc a)
    {
        attendees.add(a);
    }
     ...
     */
    public AttendeeForMcuKdc getLastOperationAttendee()
    {
        return lastOperationAttendee;
    }
     ...
     */
    public void setLastOperationAttendee(AttendeeForMcuKdc lastOperationAttendee)
    {
     ...
     */
    @JsonIgnore
    public AttendeeForMcuKdc getPollingAttendee()
    {
