...
public class RollCallAttendeeOperation extends AttendeeOperation {
    ...
    private AttendeeForMcuKdc rollCallAttendee;
     ...
     */
    public RollCallAttendeeOperation(McuKdcConferenceContext conferenceContext, AttendeeForMcuKdc rollCallAttendee) {
        ...
        if (currentTimeMillis - getLastUpdateTime() >= 10000) {
            ...
            if (masterAttendee != null && StringUtils.isNotEmpty(masterAttendee.getParticipantUuid())) {
                ...
                if (masterAttendee != null && StringUtils.isNotEmpty(masterAttendee.getParticipantUuid())) {
                    ...
                    ccUpdateMrMosicConfigRequest.setLayout(Integer.valueOf(McuKdcLayoutTemplates.SCREEN_2_1.getCode()));
            ...
            if (success) {
                ...
                for (AttendeeForMcuKdc attendeeForMcuKdc : updateAttendeeList) {
                    if (attendeeForMcuKdc != null) {
                        if (attendeeForMcuKdc == rollCallAttendee) {
                            StringBuilder messageTip = new StringBuilder();
                            messageTip.append("正在点名【").append(getViewName(SysDeptCache.getInstance().get(attendeeForMcuKdc.getDeptId()).getDeptName(), attendeeForMcuKdc.getName())).append("】");
