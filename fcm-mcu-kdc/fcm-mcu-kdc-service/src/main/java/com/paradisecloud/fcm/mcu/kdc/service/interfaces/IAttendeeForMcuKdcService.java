 ...
 * @version V1.0  
 */
public interface IAttendeeForMcuKdcService
{
     ...
     * @since 2021-02-09 11:32  void
     */
    void defaultChooseSee(McuKdcConferenceContext mainConferenceContext);
     ...
     */
    void cancelCurrentOperation(McuKdcConferenceContext conferenceContext);
     ...
     * @param conferenceId
     * @param attendeeId
     * @see IAttendeeForMcuKdcService#callTheRoll(String, String)
     */
     ...
     * @since 2021-02-22 18:07
     */
    void openMixing(McuKdcConferenceContext cc);
     ...
     * @param cc void
     */
    void closeMixing(McuKdcConferenceContext cc, AttendeeForMcuKdc... excludes);
     ...
     * @param attendee void
     */
    JSONObject detail(McuKdcConferenceContext conferenceContext, AttendeeForMcuKdc attendee);
