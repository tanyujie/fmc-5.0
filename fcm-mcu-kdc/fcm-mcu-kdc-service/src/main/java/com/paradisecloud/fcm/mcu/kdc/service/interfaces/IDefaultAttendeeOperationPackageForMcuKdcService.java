 ...
 * @version V1.0  
 */
public interface IDefaultAttendeeOperationPackageForMcuKdcService
{
     ...
     */
    DefaultAttendeeOperation packing(McuKdcConferenceContext conferenceContext, BusiMcuKdcTemplateConference tc, Map<Long, BusiMcuKdcTemplateParticipant> busiTemplateParticipantMap);
