...
public abstract class SplitScreen implements Serializable
{
     ...
     * 分屏需要渲染的参会者
     */
    protected List<AttendeeForMcuKdc> attendees = new ArrayList<>();
     ...
     */
    public void processImportance(List<AttendeeForMcuKdc> as, ImportanceProcessor importanceProcessor)
    {
