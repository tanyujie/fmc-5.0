 ...
 * @version V1.0
 */
public class NoAvailableFmeBridgeException extends RuntimeException
{
     ...
     * @param message
     */
    public NoAvailableFmeBridgeException(String message)
    {
        super(message);
    }
     ...
     * @param cause 
     */
    public NoAvailableFmeBridgeException(String message, Throwable cause)
    {
        super(message, cause);
     ...
     * @param message
     */
    public NoAvailableFmeBridgeException(long code, String message)
    {
        super(message);
        this.code = code;
    }
