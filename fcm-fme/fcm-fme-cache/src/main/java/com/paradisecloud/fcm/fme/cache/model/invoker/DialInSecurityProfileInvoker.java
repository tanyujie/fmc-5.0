...
/**  
 * <pre>DialInSecurity调用器</pre>
 * @author lilinhai
 * @since 2021-01-28 18:51
 * @version V1.0  
 */
public class DialInSecurityProfileInvoker extends FmeApiInvoker
{
     ...
     * @param rootUrl 
     */
    public DialInSecurityProfileInvoker(HttpRequester httpRequester, String rootUrl)
    {
     ...
     */
    public DialInSecurityProfilesResponse getDialInSecurityProfiles(int offset)
    {
        return getEntity("dialInSecurityProfiles?offset=" + offset, DialInSecurityProfilesResponse.class);
    }
     ...
     * @return CallLegProfilesResponse
     */
    public DialInSecurityProfileInfoResponse getDialInSecurityProfile(String id)
    {
        return getEntity("dialInSecurityProfiles/" + id, DialInSecurityProfileInfoResponse.class);
    }
     ...
     * @return String
     */
    public String createDialInSecurityProfile(List<NameValuePair> nameValuePairs)
    {
        GenericValue<FailureDetailsInfo> genericValue = new GenericValue<>();
        StringBuilder idBuilder = new StringBuilder();
        String url = rootUrl + "dialInSecurityProfiles";
        httpRequester.post(url, nameValuePairs, new HttpResponseProcessorAdapter()
        {
            public void success(HttpResponse httpResponse, ContentType contentType)
            {
                ...
                if (locationHeader != null)
                {
                    ...
                    {
                        idBuilder.append(location.replaceAll("^/api/v1/dialInSecurityProfiles/", ""));
                    }
                }
            }
     ...
     * @return String
     */
    public RestResponse updateDialInSecurityProfile(String id, List<NameValuePair> nameValuePairs)
    {
        GenericValue<FailureDetailsInfo> genericValue = new GenericValue<>();
        StringBuilder resultBuilder = new StringBuilder();
        String url = rootUrl + "dialInSecurityProfiles/" + id;
     ...
     * @return String
     */
    public RestResponse deleteDialInSecurityProfile(String id)
    {
        GenericValue<FailureDetailsInfo> genericValue = new GenericValue<>();
        StringBuilder resultBuilder = new StringBuilder();
        String url = rootUrl + "dialInSecurityProfiles/" + id;
