...
/**  
 * <pre>OutboundDialPlanRule调用器</pre>
 * @author lilinhai
 * @since 2021-01-28 18:51
 * @version V1.0  
 */
public class OutboundDialPlanRuleInvoker extends FmeApiInvoker
{
     ...
     * @param rootUrl 
     */
    public OutboundDialPlanRuleInvoker(HttpRequester httpRequester, String rootUrl)
    {
     ...
     */
    public OutboundDialPlanRulesResponse getOutboundDialPlanRules(int offset)
    {
        return getEntityABC("outboundDialPlanRules?offset=" + offset, OutboundDialPlanRulesResponse.class);
    }
    /**
     * <pre>获取单个入会方案</pre>
     * @author lilinhai
     ...
     * @return CallLegProfilesResponse
     */
    public OutboundDialPlanRuleInfoResponse getOutboundDialPlanRule(String id)
    {
        return getEntity("outboundDialPlanRules/" + id, OutboundDialPlanRuleInfoResponse.class);
    }
     ...
     * @return String
     */
    public String createOutboundDialPlanRule(List<NameValuePair> nameValuePairs)
    {
        GenericValue<FailureDetailsInfo> genericValue = new GenericValue<>();
        StringBuilder idBuilder = new StringBuilder();
        String url = rootUrl + "outboundDialPlanRules";
        httpRequester.post(url, nameValuePairs, new HttpResponseProcessorAdapter()
        {
            public void success(HttpResponse httpResponse, ContentType contentType)
            {
                ...
                if (locationHeader != null)
                {
                    ...
                    {
                        idBuilder.append(location.replaceAll("^/api/v1/outboundDialPlanRules/", ""));
                    }
                }
            }
     ...
     * @return String
     */
    public RestResponse updateOutboundDialPlanRule(String id, List<NameValuePair> nameValuePairs)
    {
        GenericValue<FailureDetailsInfo> genericValue = new GenericValue<>();
        StringBuilder resultBuilder = new StringBuilder();
        String url = rootUrl + "outboundDialPlanRules/" + id;
     ...
     * @return String
     */
    public RestResponse deleteOutboundDialPlanRule(String id)
    {
        GenericValue<FailureDetailsInfo> genericValue = new GenericValue<>();
        StringBuilder resultBuilder = new StringBuilder();
        String url = rootUrl + "outboundDialPlanRules/" + id;
