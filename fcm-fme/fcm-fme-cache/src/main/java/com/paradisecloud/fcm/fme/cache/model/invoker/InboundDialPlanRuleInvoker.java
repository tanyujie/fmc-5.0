 ...
 * @version V1.0  
 */
public class InboundDialPlanRuleInvoker extends FmeApiInvoker
{
     ...
     * @param rootUrl 
     */
    public InboundDialPlanRuleInvoker(HttpRequester httpRequester, String rootUrl)
    {
     ...
     */
    public InboundDialPlanRulesResponse getInboundDialPlanRules(int offset)
    {
        return getEntity("inboundDialPlanRules?offset=" + offset, InboundDialPlanRulesResponse.class);
    }
     ...
     * @return CallLegProfilesResponse
     */
    public InboundDialPlanRuleInfoResponse getInboundDialPlanRule(String id)
    {
        return getEntity("inboundDialPlanRules/" + id, InboundDialPlanRuleInfoResponse.class);
    }
     ...
     * @return String
     */
    public String createInboundDialPlanRule(List<NameValuePair> nameValuePairs)
    {
        GenericValue<FailureDetailsInfo> genericValue = new GenericValue<>();
        StringBuilder idBuilder = new StringBuilder();
        String url = rootUrl + "inboundDialPlanRules";
        httpRequester.post(url, nameValuePairs, new HttpResponseProcessorAdapter()
        {
            public void success(HttpResponse httpResponse, ContentType contentType)
            {
                ...
                if (locationHeader != null)
                {
                    ...
                    {
                        idBuilder.append(location.replaceAll("^/api/v1/inboundDialPlanRules/", ""));
                    }
                }
            }
     ...
     * @return String
     */
    public RestResponse updateInboundDialPlanRule(String id, List<NameValuePair> nameValuePairs)
    {
        GenericValue<FailureDetailsInfo> genericValue = new GenericValue<>();
        StringBuilder resultBuilder = new StringBuilder();
        String url = rootUrl + "inboundDialPlanRules/" + id;
     ...
     * @return String
     */
    public RestResponse deleteInboundDialPlanRule(String id)
    {
        GenericValue<FailureDetailsInfo> genericValue = new GenericValue<>();
        StringBuilder resultBuilder = new StringBuilder();
        String url = rootUrl + "inboundDialPlanRules/" + id;
