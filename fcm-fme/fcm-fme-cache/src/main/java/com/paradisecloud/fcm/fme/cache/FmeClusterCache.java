 ...
 * @version V1.0  
 */
public class FmeClusterCache extends JavaCache<Long, BusiFmeCluster>
{
    ...
    private static final FmeClusterCache INSTANCE = new FmeClusterCache();
     ...
     */
    private FmeClusterCache()
    {
    }
    
    public static FmeClusterCache getInstance()
    {
        return INSTANCE;
    }
}
