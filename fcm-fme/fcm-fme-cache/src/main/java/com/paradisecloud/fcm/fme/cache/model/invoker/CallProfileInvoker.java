 ...
 * @version V1.0  
 */
public class CallProfileInvoker extends FmeApiInvoker
{
     ...
     * @param rootUrl 
     */
    public CallProfileInvoker(HttpRequester httpRequester, String rootUrl)
    {
     ...
     */
    public CallProfilesResponse getCallProfiles(int offset)
    {
        return getEntity("callProfiles?offset=" + offset, CallProfilesResponse.class);
    }
     ...
     * @return CallLegProfilesResponse
     */
    public CallProfileInfoResponse getCallProfile(String id)
    {
        return getEntity("callProfiles/" + id, CallProfileInfoResponse.class);
    }
     ...
     * @return String
     */
    public String createCallProfile(List<NameValuePair> nameValuePairs)
    {
        GenericValue<FailureDetailsInfo> genericValue = new GenericValue<>();
        StringBuilder idBuilder = new StringBuilder();
        String url = rootUrl + "callProfiles";
        httpRequester.post(url, nameValuePairs, new HttpResponseProcessorAdapter()
        {
            public void success(HttpResponse httpResponse, ContentType contentType)
            {
                ...
                if (locationHeader != null)
                {
                    ...
                    {
                        idBuilder.append(location.replaceAll("^/api/v1/callProfiles/", ""));
                    }
                }
            }
     ...
     * @return String
     */
    public RestResponse updateCallProfile(String id, List<NameValuePair> nameValuePairs)
    {
        GenericValue<FailureDetailsInfo> genericValue = new GenericValue<>();
        StringBuilder resultBuilder = new StringBuilder();
        String url = rootUrl + "callProfiles/" + id;
     ...
     * @return String
     */
    public RestResponse deleteCallProfile(String id)
    {
        GenericValue<FailureDetailsInfo> genericValue = new GenericValue<>();
        StringBuilder resultBuilder = new StringBuilder();
        String url = rootUrl + "callProfiles/" + id;
