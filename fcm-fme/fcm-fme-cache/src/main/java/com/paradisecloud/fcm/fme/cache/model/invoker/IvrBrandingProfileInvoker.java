...
/**  
 * <pre>IvrBranding调用器</pre>
 * @author lilinhai
 * @since 2021-01-28 18:51
 * @version V1.0  
 */
public class IvrBrandingProfileInvoker extends FmeApiInvoker
{
     ...
     * @param rootUrl 
     */
    public IvrBrandingProfileInvoker(HttpRequester httpRequester, String rootUrl)
    {
     ...
     */
    public IvrBrandingProfilesResponse getIvrBrandingProfiles(int offset)
    {
        return getEntity("ivrBrandingProfiles?offset=" + offset, IvrBrandingProfilesResponse.class);
    }
     ...
     * @return CallLegProfilesResponse
     */
    public IvrBrandingProfileInfoResponse getIvrBrandingProfile(String id)
    {
        return getEntity("ivrBrandingProfiles/" + id, IvrBrandingProfileInfoResponse.class);
    }
     ...
     * @return String
     */
    public String createIvrBrandingProfile(List<NameValuePair> nameValuePairs)
    {
        GenericValue<FailureDetailsInfo> genericValue = new GenericValue<>();
        StringBuilder idBuilder = new StringBuilder();
        String url = rootUrl + "ivrBrandingProfiles";
        httpRequester.post(url, nameValuePairs, new HttpResponseProcessorAdapter()
        {
            public void success(HttpResponse httpResponse, ContentType contentType)
            {
                ...
                if (locationHeader != null)
                {
                    ...
                    {
                        idBuilder.append(location.replaceAll("^/api/v1/ivrBrandingProfiles/", ""));
                    }
                }
            }
     ...
     * @return String
     */
    public RestResponse updateIvrBrandingProfile(String id, List<NameValuePair> nameValuePairs)
    {
        GenericValue<FailureDetailsInfo> genericValue = new GenericValue<>();
        StringBuilder resultBuilder = new StringBuilder();
        String url = rootUrl + "ivrBrandingProfiles/" + id;
     ...
     * @return String
     */
    public RestResponse deleteIvrBrandingProfile(String id)
    {
        GenericValue<FailureDetailsInfo> genericValue = new GenericValue<>();
        StringBuilder resultBuilder = new StringBuilder();
        String url = rootUrl + "ivrBrandingProfiles/" + id;
