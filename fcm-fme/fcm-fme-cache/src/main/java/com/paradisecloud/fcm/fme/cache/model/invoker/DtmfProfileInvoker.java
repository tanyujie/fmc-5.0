 ...
 * @version V1.0  
 */
public class DtmfProfileInvoker extends FmeApiInvoker
{
     ...
     * @param rootUrl 
     */
    public DtmfProfileInvoker(HttpRequester httpRequester, String rootUrl)
    {
     ...
     */
    public DtmfProfilesResponse getDtmfProfiles(int offset)
    {
        return getEntity("dtmfProfiles?offset=" + offset, DtmfProfilesResponse.class);
    }
     ...
     * @return CallLegProfilesResponse
     */
    public DtmfProfileInfoResponse getDtmfProfile(String id)
    {
        return getEntity("dtmfProfiles/" + id, DtmfProfileInfoResponse.class);
    }
     ...
     * @return String
     */
    public String createDtmfProfile(List<NameValuePair> nameValuePairs)
    {
        GenericValue<FailureDetailsInfo> genericValue = new GenericValue<>();
        StringBuilder idBuilder = new StringBuilder();
        String url = rootUrl + "dtmfProfiles";
        httpRequester.post(url, nameValuePairs, new HttpResponseProcessorAdapter()
        {
            public void success(HttpResponse httpResponse, ContentType contentType)
            {
                ...
                if (locationHeader != null)
                {
                    ...
                    {
                        idBuilder.append(location.replaceAll("^/api/v1/dtmfProfiles/", ""));
                    }
                }
            }
     ...
     * @return String
     */
    public RestResponse updateDtmfProfile(String id, List<NameValuePair> nameValuePairs)
    {
        GenericValue<FailureDetailsInfo> genericValue = new GenericValue<>();
        StringBuilder resultBuilder = new StringBuilder();
        String url = rootUrl + "dtmfProfiles/" + id;
     ...
     * @return String
     */
    public RestResponse deleteDtmfProfile(String id)
    {
        GenericValue<FailureDetailsInfo> genericValue = new GenericValue<>();
        StringBuilder resultBuilder = new StringBuilder();
        String url = rootUrl + "dtmfProfiles/" + id;
