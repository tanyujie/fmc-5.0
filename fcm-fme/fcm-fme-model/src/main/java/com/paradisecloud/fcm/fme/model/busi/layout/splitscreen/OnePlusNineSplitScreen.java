 ...
 * @version V1.0  
 */
public class OnePlusNineSplitScreen extends SplitScreen
{
     ...
     * 布局
     */
    public static final String LAYOUT = "onePlusNine";
    public static final String LAYOUT_NAME = "一大九小";
     ...
     * @since 2021-02-09 14:38
     */
    public OnePlusNineSplitScreen(int maxImportance)
    {
        super(10, maxImportance);
        this.layout = LAYOUT;
