 ...
 * @version V1.0  
 */
public class OnePlusFiveSplitScreen extends SplitScreen
{
     ...
     * 布局
     */
    public static final String LAYOUT = "onePlusFive";
    public static final String LAYOUT_NAME = "一大五小";
     ...
     * @since 2021-02-09 14:38
     */
    public OnePlusFiveSplitScreen(int maxImportance)
    {
        super(6, maxImportance);
        this.layout = LAYOUT;
