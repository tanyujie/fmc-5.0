 ...
 * @version V1.0  
 */
public class OneSplitScreenCreater implements SplitScreenCreater<OneSplitScreen>
{

    @Override
    public OneSplitScreen create(int maxImportance)
    {
        return new OneSplitScreen(maxImportance);
    }
