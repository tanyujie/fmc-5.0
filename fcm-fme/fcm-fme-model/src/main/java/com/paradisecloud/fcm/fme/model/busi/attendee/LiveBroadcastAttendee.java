 ...
 * @version V1.0  
 */
public class LiveBroadcastAttendee extends SelfCallAttendee
{
    ...
    private String remotePartyOrigin;
    ...
    public String getRemotePartyOrigin() {
        return remotePartyOrigin;
    }

    public void setRemotePartyOrigin(String remotePartyOrigin) {
        this.remotePartyOrigin = remotePartyOrigin;
    }
}