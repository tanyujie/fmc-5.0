 ...
 * @version V1.0  
 */
public class OneSplitScreen extends SplitScreen
{
     ...
     * 布局
     */
    public static final String LAYOUT = "speakerOnly";
    public static final String LAYOUT_NAME = "一分屏";
     ...
     * @since 2021-02-09 14:38
     */
    public OneSplitScreen(int maxImportance)
    {
        super(1, maxImportance);
        this.layout = LAYOUT;
