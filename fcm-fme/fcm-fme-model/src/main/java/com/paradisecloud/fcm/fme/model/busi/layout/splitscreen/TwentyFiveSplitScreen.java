 ...
 * @version V1.0  
 */
public class TwentyFiveSplitScreen extends SplitScreen
{
     ...
     * 布局
     */
    public static final String LAYOUT = "allEqualTwentyFifths";
    public static final String LAYOUT_NAME = "二十五分屏";
     ...
     * @since 2021-02-09 14:38
     */
    public TwentyFiveSplitScreen(int maxImportance)
    {
        super(25, maxImportance);
        this.layout = LAYOUT;
