...
public class OnePlusNSplitScreen extends MainPaneSplitScreen
{
     ...
     * 布局
     */
    public static final String LAYOUT = "onePlusN";
    public static final String LAYOUT_NAME = "一大N小";
