...
public class ParticipantRequest
{
    ...
    /**
     * 仅用于POST, movedParticipant指定要移动到与<call ID >对应的会议的参与者的ID。callBridge和callBridgeGroup参数都被忽略，
     * 调用托管在移动参与者所在的callBridge或callBridgeGroup上
     * <p>
     * 注意:如果同时提供了remoteParty和movedParticipant，则会忽略movedParticipant参数。
     */
     ...
     */
    private String audioPacketSizeMs;
    
    /**
     * needsActivation操作在最后一个activator离开时调用legs
     */
    private String deactiviationMode;
    ...
    /**
     * call bridge group id
     */
    private String callBridgeGroup;
    
    /**
     * 要创建的参与者的重要价值。最大值为2,147,483,647。 若要删除重要性，请将重要性参数保留为未设置
     */
