...
public class StackedSplitScreen extends MainPaneSplitScreen
{
     ...
     * 布局
     */
    public static final String LAYOUT = "stacked";
    public static final String LAYOUT_NAME = "堆叠";
