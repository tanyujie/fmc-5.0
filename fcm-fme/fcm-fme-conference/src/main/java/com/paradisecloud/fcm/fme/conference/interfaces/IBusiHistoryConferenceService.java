 ...
 * @date 2021-01-20
 */
public interface IBusiHistoryConferenceService 
{
    /**
     * 查询历史会议，每次挂断会保存该历史记录
     * 
     ...
     */
    BusiHistoryConference saveHistory(CoSpace cosapce, Call call, ConferenceContext conferenceContext);
    
    BusiHistoryConference saveHistory(BusiHistoryConference busiHistoryConference, ConferenceContext conferenceContext);
    ...
    PaginationData<Map<String,Object>> selectHistoryPageDoc(ReportSearchVo reportSearchVo);
    /**
     * 统计每天发起会议的数量
     * @param searchVo
     * @return
