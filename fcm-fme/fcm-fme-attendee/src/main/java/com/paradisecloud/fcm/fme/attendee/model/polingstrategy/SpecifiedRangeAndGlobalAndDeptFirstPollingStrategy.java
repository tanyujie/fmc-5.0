...
/**  
 * <pre>选定范围+全局轮询+部门优先</pre>
 * @author sinhy
 * @since 2021-09-09 20:38
 * @version V1.0  
 */
public class SpecifiedRangeAndGlobalAndDeptFirstPollingStrategy extends AttendeePollingStrategy
{
    ...
    {
        List<PollingAttendee> all = parseSpecifiedRangeAndDeptFirst(conferenceContext, deptPollingAttendeesList);
        all.addAll(parseGlobalPollingAndDeptFirst(conferenceContext, toMap(all), splitScreen));
        return all;
    }
