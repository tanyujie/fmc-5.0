...
public class SendJoinConferenceToTerminalTask extends Task {

    private ConferenceContext conferenceContext;
    private Attendee attendee;

    public SendJoinConferenceToTerminalTask(String id, long delayInMilliseconds, ConferenceContext conferenceContext, Attendee attendee) {
