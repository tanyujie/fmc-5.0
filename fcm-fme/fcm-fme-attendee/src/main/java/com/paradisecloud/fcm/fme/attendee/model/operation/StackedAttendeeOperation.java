 ...
 * @version V1.0  
 */
public class StackedAttendeeOperation extends AttendeeOperation
{
     ...
     */
    public StackedAttendeeOperation(ConferenceContext conferenceContext)
    {
    ...
    public void operate()
    {
        ...
        messageTip1.append("当前已设置为" + StackedSplitScreen.LAYOUT + "分屏");
        ...
        BeanFactory.getBean(IAttendeeLayoutService.class).setAttendeeLayout(conferenceContext, StackedSplitScreen.LAYOUT, AttendeeLayoutSetMode.MASTER);
        BeanFactory.getBean(IAttendeeLayoutService.class).setAttendeeLayout(conferenceContext, StackedSplitScreen.LAYOUT, AttendeeLayoutSetMode.SUB);
        ...
        WebSocketMessagePusher.getInstance().pushSpecificConferenceMessage(conferenceContext, WebsocketMessageType.CONFERENCE_MODEL, "LECTURE");
