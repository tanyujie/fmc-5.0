...
//                    .setStaleConnectionCheckEnabled(true) //提交请求前测试连接是否可用
    ...
    public static void httpPostVoidHtml(String url, String requestBody, Map<String, String> header,String contentType) throws IOException {
        CloseableHttpClient httpclient = ClientAuthentication.createSSLClientDefault();
        HttpPost httpPost = new HttpPost(url);
        if(header!=null){
            for (Map.Entry<String, String> entry : header.entrySet()) {
...
//        }
    ...
    public static String httpGetHtml(String url,Map<String,String> param,Map<String,String> header) throws IOException {
        CloseableHttpClient httpclient = ClientAuthentication.createSSLClientDefault();
        String getUrl = null;
        if(param!=null&&param.size()>0){
            String data = "";
