 ...
 * @version  V1.0
 */ 
package com.paradisecloud.fcm.tencent.model.operation.polling;
...
public class PollingAttendee implements Comparable<PollingAttendee>
{
     ...
     * 参会者
     */
    private AttendeeTencent attendee;
     ...
     * @param attendee 
     */
    public PollingAttendee(AttendeeTencent attendee)
    {
        super();
     ...
     * @return attendee
     */
    public AttendeeTencent getAttendee()
    {
        return attendee;
    }
     ...
     * @param attendee
     */
    public void setAttendee(AttendeeTencent attendee)
    {
        this.attendee = attendee;
    }
