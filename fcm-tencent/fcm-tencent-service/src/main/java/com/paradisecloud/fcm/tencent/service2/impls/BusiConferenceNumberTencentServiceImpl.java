...
@Service
@Transactional
public class BusiConferenceNumberTencentServiceImpl implements IBusiConferenceNumberTencentService
{
    ...
    {
        long cn = busiConferenceNumberSectionService.autoGenerate(deptId,"Tencent");
    ...
    {
        busiConferenceNumberSectionService.validNumber(busiConferenceNumber.getId(), busiConferenceNumber.getDeptId(),"Tencent");
