 ...
 */
public class WaitingRoomParticipantSetiingReq extends AbstractModel {
    ...
    public String getPath() {
        return "/v1/real-control/meetings/" + this.meetingId+"/waiting-room";
    }
