...
public class TencentWebsocketMessage {
    /**
     * 消息类型
     */
    private String type;
     ...
     */
    public TencentWebsocketMessage()
    {
    }
     ...
     * @param data
     */
    public TencentWebsocketMessage(String type, Object data)
    {
        this.type = type;
        this.data = data;
    }
     ...
     * @param destination
     */
    public TencentWebsocketMessage(String type, Object data, String destination)
    {
        super();
        this.type = type;
        this.data = data;
