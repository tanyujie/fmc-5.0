...
public class RegisteredAttendeeUpdateProcessor extends AttendeeUpdateProcessor {
     ...
     */
    public RegisteredAttendeeUpdateProcessor(SmcParitipantsStateRep.ContentDTO participant, AttendeeTencent a, TencentConferenceContext conferenceContext) {
    ...
    public void process() {
        ...
        // FME类型的与会者
        else if (attendee instanceof McuAttendeeTencent) {
            processFmeAttendee();
        }
    }
    ...
    private void processFmeAttendee() {
        if (attendee instanceof McuAttendeeTencent) {
            processMcuAttendee();
        }
    }
    ...
    private void processMcuAttendee() {
        McuAttendeeTencent mcuAttendee = (McuAttendeeTencent) attendee;
