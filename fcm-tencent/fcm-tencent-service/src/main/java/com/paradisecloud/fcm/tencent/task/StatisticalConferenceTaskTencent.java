...
public class StatisticalConferenceTaskTencent extends TencentDelayTask {

    private static final Logger LOGGER = LoggerFactory.getLogger(StatisticalConferenceTaskTencent.class);

    private Long deptId;

    public StatisticalConferenceTaskTencent(String id, long delayInMilliseconds, Long deptId) {
