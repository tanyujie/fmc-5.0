...
public abstract class AttendeeOperation extends BaseAttendeeOperation implements Serializable
{
     ...
     */
    @JsonIgnore
    protected volatile TencentConferenceContext conferenceContext;
     ...
     */
    protected volatile List<AttendeeTencent> attendeeTencents;
     ...
     */
    public AttendeeOperation(TencentConferenceContext conferenceContext) {
        super();
     ...
     * @param splitScreen 
     */
    protected AttendeeOperation(TencentConferenceContext conferenceContext, SplitScreen splitScreen)
    {
     ...
     * @param attendees 
     */
    protected AttendeeOperation(TencentConferenceContext conferenceContext, SplitScreen splitScreen, List<SmcParitipantsStateRep.ContentDTO> attendees)
    {
