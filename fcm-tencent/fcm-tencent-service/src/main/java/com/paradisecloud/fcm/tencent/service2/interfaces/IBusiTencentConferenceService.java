 ...
 * @date 2021-02-02
 */
public interface IBusiTencentConferenceService
{
     ...
     */
    TencentConferenceContext buildTemplateConferenceContext(long templateConferenceId);
     ...
     */
    @Transactional
    BusiMcuTencentConferenceAppointment extendMinutes(String conferenceId, int minutes);
     ...
     */
    void stream(TencentConferenceContext mainConferenceContext, Boolean streaming, String streamUrl);
    ...
    void meetingstatus(ModifyConferenceRequest request);

    WaitingRoomResponse queryWaitingRoomParticipants(String conferenceId, int page, int pageSize);
