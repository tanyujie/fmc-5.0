 ...
 * @version V1.0  
 */
public interface IAttendeeTencentService
{
     ...
     * @since 2021-02-09 11:22  void
     */
    void defaultChooseSee(TencentConferenceContext mainConferenceContext);
    ...
    void cancelCurrentOperation(TencentConferenceContext conferenceContext);
     ...
     * @param conferenceId
     * @param attendeeId
     * @see IAttendeeTencentService#callTheRoll(String, String)
     */
     ...
     * @since 2021-02-22 18:07
     */
    void openMixing(TencentConferenceContext cc);
     ...
     * @param cc void
     */
    void closeMixing(TencentConferenceContext cc, AttendeeTencent... excludes);
     ...
     * @param attendee void
     */
    JSONObject detail(TencentConferenceContext conferenceContext, AttendeeTencent attendee);
     ...
     * @return
     */
    RoomResponse rooms(Long deptId, Integer pageIndex, Integer pageSize, String meetingRoomName);
     ...
     * @return
     */
    RoomResponse rooms(TencentBridge tencentBridge, Integer pageIndex, Integer pageSize, String meetingRoomName);

    Object roomsInvite(String conferenceId, List<String> roomIds);
}
