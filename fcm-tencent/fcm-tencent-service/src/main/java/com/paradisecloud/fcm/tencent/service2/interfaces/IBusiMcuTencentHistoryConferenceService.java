 ...
 * @date 2021-01-20
 */
public interface IBusiMcuTencentHistoryConferenceService
{
    /**
     * 查询历史会议，每次挂断会保存该历史记录
     * 
     ...
     */
    BusiHistoryConference saveHistory(CoSpace cosapce, Call call, TencentConferenceContext conferenceContext);
    
    BusiHistoryConference saveHistory(BusiHistoryConference busiHistoryConference, TencentConferenceContext conferenceContext);
    ...
    BusiHistoryConference saveHistory(TencentConferenceContext conferenceContext);
     ...
     * @param attendee
     */
    void updateBusiHistoryParticipant(TencentConferenceContext conferenceContext, AttendeeTencent attendee, boolean updateMediaInfo);
