 ...
 * 只用于MTR探测
 */
public abstract class SshRemoteServerOperateForMeetingFile
{
	private static final Logger LOGGER = LoggerFactory.getLogger(SshRemoteServerOperateForMeetingFile.class);
	private Session session;// JSCH session
	private boolean logined = false;// 是否登陆

	private static final SshRemoteServerOperateForMeetingFile INSTANCE = new SshRemoteServerOperateForMeetingFile()
	{

	};

	public static SshRemoteServerOperateForMeetingFile getInstance()
	{
		return INSTANCE;
	}
