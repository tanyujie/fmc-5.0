 ...
 * @date 2023/8/2 15:35
 */
public class McuPlcProcessor implements Processor{
    ...
    public McuPlcProcessor(AbstractConference conference, CascadeTemplate template) {
    ...
    public void execute(ProcessContext processContext) {
        conference.startConference(McuType.MCU_PLC, template.getTemplateId());
        ...
        if(parentTemplate==null){
            ...
            conference.processCascade("MCU_PLC级联",s,"");
        }
    }
