 ...
 * @date 2023/8/2 15:35
 */
public class McuZjProcessor implements Processor{
    ...
    public McuZjProcessor(AbstractConference conference, CascadeTemplate template) {
    ...
    public void execute(ProcessContext processContext) {
        conference.startConference(McuType.MCU_ZJ, template.getTemplateId());
        ...
        if(parentTemplate==null){
            ...
            conference.processCascade("MCU-ZJ级联",s,null);
        }
    }
