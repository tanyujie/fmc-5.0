package com.paradisecloud.fcm.service.notify;

import com.paradisecloud.fcm.service.eunm.NotifyType;
import com.paradisecloud.fcm.service.model.SmsResult;
...
public class NotifyService {
     ...
     */
    @Async
    public void notifyMail(String subject, String content, String mailUrl) {
        if (mailSender == null) {
            return;
        }
        sendTo = mailUrl;
