 ...
 * @date 2023/8/2 15:35
 */
public class Smc2Processor implements Processor{
    ...
    public Smc2Processor(AbstractConference conference, CascadeTemplate template) {
    ...
    public void execute(ProcessContext processContext) {
        conference.startConference(McuType.SMC2, template.getTemplateId());
        ...
        if(parentTemplate==null){
            ...
            conference.processCascade("SMC2级联",s,null);
        }
    }
