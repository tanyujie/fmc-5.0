 ...
 * @date 2021-01-20
 */
public interface IBusiConferenceNumberService 
{
     ...
     * @param deptId void
     */
    BusiConferenceNumber autoCreateConferenceNumber(Long deptId, String mcuType);
     ...
     * @param deptId void
     */
    BusiConferenceNumber autoCreateConferenceNumber(Long deptId, String mcuType, boolean random, boolean simpleCreate);
     ...
     */
    BusiConferenceNumber autoCreateConferenceNumber(Long deptId, String mcuType, long cn);
     ...
     * @return
     */
    BusiConferenceNumber autoCreateConferenceNumberIsMute(Long deptId, String mcuType,Boolean isMute);
