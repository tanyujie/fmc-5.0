...
public class HuaweiCloudUtil {
    ...
    private static final Logger log = LoggerFactory.getLogger(HuaweiCloudUtil.class);

//    public static Map<String,String> getConferenceNumber(String conferenceName) {
//
//        log.info("HuaweiCloudTask获取SN任务。"+conferenceName);
//
...
//            HttpsURLConnection.setDefaultHostnameVerifier(new HuaweiCloudUtil.NoopHostnameVerifier());
//
//
...
//                    paramMap.put("mcuType", McuType.MCU_HWCLOUD.getCode());
//                    paramMap.put("muteType", 1);
//                    paramMap.put("name", "HW_" + conferenceName);
...
//                            String conferenceId = EncryptIdUtil.generateConferenceId(busiTemplateConference.getId(), McuType.MCU_HWCLOUD.getCode());
//
...
//                                    map.put("conferenceName", "HW_" + conferenceName);
//                                    return map;
//                                }
//
//                            }
...
//
//        log.info("HWCloudTask endConference。"+cloudConference.getConferenceNumber());
//
//        String cloudUrl = ExternalConfigCache.getInstance().getCloudUrl();
//        if(Strings.isBlank(cloudUrl)){
//            cloudUrl="https://218.28.249.134:8899/fcm";
