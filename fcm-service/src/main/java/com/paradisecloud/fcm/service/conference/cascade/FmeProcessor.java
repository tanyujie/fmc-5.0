 ...
 * @date 2023/8/2 15:35
 */
public class FmeProcessor implements Processor{
    ...
    public FmeProcessor(AbstractConference conference, CascadeTemplate template) {
    ...
    public void execute(ProcessContext processContext) {
        conference.startConference(McuType.FME, template.getTemplateId());
        ...
        if(parentTemplate==null){
            ...
            conference.processCascade("fme级联",s,"");
        }
    }
