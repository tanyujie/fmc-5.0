 ...
 * @version  V1.0
 */ 
package com.paradisecloud.fcm.mcu.zj.attendee.model.polling;
...
public class PollingAttendee implements Comparable<PollingAttendee>
{
     ...
     * @param attendee 
     */
    public PollingAttendee(AttendeeForMcuZj attendee)
    {
        super();
     ...
     * @param attendee
     */
    public void setAttendee(AttendeeForMcuZj attendee)
    {
        this.attendee = attendee;
    }
