...
public class CellScreen implements Serializable
{
     ...
     * 分屏单元格需要渲染的参会者
     */
    private List<AttendeeForMcuZj> attendees = new ArrayList<>();
     ...
     */
    @JsonIgnore
    private AttendeeForMcuZj lastOperationAttendee;
    ...
    public void addAttendee(AttendeeForMcuZj a)
    {
        attendees.add(a);
    }
     ...
     */
    public AttendeeForMcuZj getLastOperationAttendee()
    {
        return lastOperationAttendee;
    }
     ...
     */
    public void setLastOperationAttendee(AttendeeForMcuZj lastOperationAttendee)
    {
     ...
     */
    @JsonIgnore
    public AttendeeForMcuZj getPollingAttendee()
    {
