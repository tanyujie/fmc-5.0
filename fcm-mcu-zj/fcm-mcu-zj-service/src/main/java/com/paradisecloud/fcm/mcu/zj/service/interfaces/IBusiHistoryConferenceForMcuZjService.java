 ...
 * @date 2021-01-20
 */
public interface IBusiHistoryConferenceForMcuZjService
{
    /**
     * 查询历史会议，每次挂断会保存该历史记录
     * 
     ...
     */
    BusiHistoryConference saveHistory(McuZjConferenceContext conferenceContext);
     ...
     * @param conferenceContext void
     */
    BusiHistoryConference saveHistory(BusiHistoryConference busiHistoryConference, McuZjConferenceContext conferenceContext);
     ...
     * @param attendee
     */
    void updateBusiHistoryParticipant(McuZjConferenceContext conferenceContext, AttendeeForMcuZj attendee, boolean updateMediaInfo);
