 ...
 * @version V1.0  
 */
public interface IAttendeeForMcuZjService
{
     ...
     * @since 2021-02-09 11:32  void
     */
    void defaultChooseSee(McuZjConferenceContext mainConferenceContext);
    ...
    void cancelCurrentOperation(McuZjConferenceContext conferenceContext);
     ...
     * @param conferenceId
     * @param attendeeId
     * @see IAttendeeForMcuZjService#callTheRoll(String, String)
     */
     ...
     * @since 2021-02-22 18:07
     */
    void openMixing(McuZjConferenceContext cc);
     ...
     * @param cc void
     */
    void closeMixing(McuZjConferenceContext cc, AttendeeForMcuZj... excludes);
     ...
     * @param attendee void
     */
    JSONObject detail(McuZjConferenceContext conferenceContext, AttendeeForMcuZj attendee);
