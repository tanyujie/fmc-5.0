 ...
 * @version  V1.0
 */ 
package com.paradisecloud.fcm.mcu.zj.model.busi.operation;
...
public abstract class AttendeeOperation extends BaseAttendeeOperation implements Serializable
{
     ...
     */
    @JsonIgnore
    protected volatile McuZjConferenceContext conferenceContext;
     ...
     */
    protected volatile List<AttendeeForMcuZj> attendees;
    ...
    @JsonIgnore
    protected List<AttendeeForMcuZj> operatedAttendees = new ArrayList<>();
     ...
     */
    protected AttendeeOperation(McuZjConferenceContext conferenceContext)
    {
        super();
     ...
     * @param splitScreen 
     */
    protected AttendeeOperation(McuZjConferenceContext conferenceContext, SplitScreen splitScreen)
    {
     ...
     * @param attendees 
     */
    protected AttendeeOperation(McuZjConferenceContext conferenceContext, SplitScreen splitScreen, List<AttendeeForMcuZj> attendees)
    {
     ...
     */
    public List<AttendeeForMcuZj> getOperatedAttendees()
    {
        return operatedAttendees;
    }
    ...
    public void addOperatedAttendee(AttendeeForMcuZj a)
    {
