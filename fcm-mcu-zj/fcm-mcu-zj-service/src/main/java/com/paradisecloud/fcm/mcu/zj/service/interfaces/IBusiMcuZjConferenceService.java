 ...
 * @date 2021-02-02
 */
public interface IBusiMcuZjConferenceService
{
     ...
     */
    McuZjConferenceContext buildTemplateConferenceContext(long templateConferenceId);
     ...
     */
    @Transactional
    BusiMcuZjConferenceAppointment extendMinutes(String conferenceId, int minutes);
     ...
     */
    void stream(McuZjConferenceContext mainConferenceContext, Boolean streaming, String streamUrl);
