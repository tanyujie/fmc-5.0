...
public class McuZjSendJoinConferenceToTerminalTask extends DelayTask {

    private McuZjConferenceContext conferenceContext;
    private AttendeeForMcuZj attendee;

    public McuZjSendJoinConferenceToTerminalTask(String id, long delayInMilliseconds, McuZjConferenceContext conferenceContext, AttendeeForMcuZj attendee) {
