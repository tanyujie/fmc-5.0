...
public class AttendeeCountingStatistics
{
    ...
    public AttendeeCountingStatistics(McuZjConferenceContext cc)
    {
        ...
        for (AttendeeForMcuZj terminalAttendee : cc.getAttendees())
        {
            total++;
        ...
        for (AttendeeForMcuZj masterAttendee0 : cc.getMasterAttendees())
        {
            total++;
