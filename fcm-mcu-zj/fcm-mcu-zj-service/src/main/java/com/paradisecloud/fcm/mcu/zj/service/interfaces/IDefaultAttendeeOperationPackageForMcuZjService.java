 ...
 * @version V1.0  
 */
public interface IDefaultAttendeeOperationPackageForMcuZjService
{
     ...
     */
    DefaultAttendeeOperation packing(McuZjConferenceContext conferenceContext, BusiMcuZjTemplateConference tc, Map<Long, BusiMcuZjTemplateParticipant> busiTemplateParticipantMap);

    DefaultAttendeeOperationForGuest packingForGuest(McuZjConferenceContext conferenceContext, BusiMcuZjTemplateConference tc, Map<Long, BusiMcuZjTemplateParticipant> busiTemplateParticipantMap);
    ...
    void updateDefaultViewConfigInfoForGuest(String conferenceId, JSONObject jsonObj);
