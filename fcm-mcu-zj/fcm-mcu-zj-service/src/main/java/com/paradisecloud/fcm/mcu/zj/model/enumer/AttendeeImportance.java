...
public enum AttendeeImportance
{
    ...
    {
        public void processAttendeeWebsocketMessage(AttendeeForMcuZj attendee)
        {
    ...
    MASTER(7500000, 7500000, "主会场")
    {
        public void processAttendeeWebsocketMessage(AttendeeForMcuZj attendee)
        {
            ...
            if (!(attendee instanceof McuAttendeeForMcuZj))
            {
                McuZjConferenceContext mainConferenceContext = McuZjConferenceContextCache.getInstance().getMainConferenceContext(attendee.getConferenceNumber());
                if (mainConferenceContext != null && mainConferenceContext.getMasterAttendee() != attendee)
                {
                    AttendeeForMcuZj oldMasterAttendee = mainConferenceContext.getMasterAttendee();
     ...
     * @param attendee void
     */
    public abstract void processAttendeeWebsocketMessage(AttendeeForMcuZj attendee);
