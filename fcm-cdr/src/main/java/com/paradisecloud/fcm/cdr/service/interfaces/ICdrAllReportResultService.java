 ...
 */
public interface ICdrAllReportResultService
{
    /**
     ...
     * @return
     */
    Map<String, Object> reportConferenceOfIndex(String startTime, String endTime);
     ...
     * @return
     */
    List<Map<String, Object>> reportByReason(Date startTime, Date endTime);
     ...
     * @return
     */
    List<Map<String, Object>> reportByDeviceType();
     ...
     * @return
     */
    List<Map<String, Object>> usedRate(String fmeIp, String startTime, String endTime);
}
