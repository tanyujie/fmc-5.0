...
@Component
public class MessageInfoProcessorMessageDispatcher extends ProcessorMessageDispatcher<MessageInfoProcessorMessage>
{
     ...
     */
    public MessageInfoProcessorMessageDispatcher()
    {
        super("MessageInfo"
                , (MessageInfoProcessorMessageQueue) ReflectionUtils.invokeMethod(ReflectionUtils.findMethod(MessageInfoProcessorMessageQueue.class, "getInstance"), null)
