 ...
 */
@Service
public class BusiRecordsServiceForMcuHwcloudImpl implements IBusiRecordsForMcuHwcloudService {
    ...
    @Resource
    private IBusiHwcloudConferenceService iBusiHwcloudConferenceService;
    ...
    public int updateBusiRecords(boolean recording, String contextKey) {
        ...
        meetingControl.record(hwcloudMeetingBridge.getTokenInfo().getToken(),hwcloudMeetingBridge.getConfID(),recording?1:0);
        return 0;
    }
     ...
     * @param path
     */
    private void readRecordFileName(String conferenceNumber, HwcloudConferenceContext conferenceContext, BusiRecords busiRecords, String path) {
