...
public class CellScreen implements Serializable
{
     ...
     * 分屏单元格需要渲染的参会者
     */
    private List<AttendeeHwcloud> attendeeHwclouds = new ArrayList<>();
    /**
     * 轮询索引下标
     */
    ...
    @JsonIgnore
    private AttendeeHwcloud lastOperationAttendeeHwcloud;
    /**
     * 单元格参会者操作枚举选项
     */
    ...
    public void addAttendeeHwcloud(AttendeeHwcloud a)
    {
        attendeeHwclouds.add(a);
    }
    ...
    public AttendeeHwcloud getLastOperationAttendeeHwcloud()
    {
        return lastOperationAttendeeHwcloud;
    }
    /**
    ...
    @JsonIgnore
    public AttendeeHwcloud getPollingAttendeeHwcloud()
    {
        if (ObjectUtils.isEmpty(attendeeHwclouds))
        {
            return null;
        }

        if (pollingIndex >= attendeeHwclouds.size())
        {
            pollingIndex = 0;
        }
        return attendeeHwclouds.get(pollingIndex++);
    }
