 ...
 */
public class DeptHwcloudMappingCache extends JavaCache<Long, BusiMcuHwcloudDept> {

    private static final long serialVersionUID = 1L;
    private static final DeptHwcloudMappingCache INSTANCE = new DeptHwcloudMappingCache();
     ...
     */
    private DeptHwcloudMappingCache() {
    }

    public static DeptHwcloudMappingCache getInstance() {
        return INSTANCE;
    }

    public BusiMcuHwcloudDept getBindSmc(Long key) {
        BusiMcuHwcloudDept busiSmc2Dept = super.get(key);
    ...
    public boolean isBindSameFme(long... deptIds) {
        ...
        BusiMcuHwcloudDept last = getBindSmc(deptIds[0]);
        for (int i = 1; i < deptIds.length; i++) {
            BusiMcuHwcloudDept busiSmc2Dept = getBindSmc(deptIds[i]);
    ...
    public int getBindDeptCount(FmeType fmeType, long fmeId) {
        int c = 0;
        for (BusiMcuHwcloudDept busiSmc2Dept : values()) {
