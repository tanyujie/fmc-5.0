...
@Service
@Transactional
public class BusiConferenceNumberHwcloudServiceImpl implements IBusiConferenceNumberHwcloudService
{
    ...
    {
        long cn = busiConferenceNumberSectionService.autoGenerate(deptId,"Hwcloud");
    ...
    {
        busiConferenceNumberSectionService.validNumber(busiConferenceNumber.getId(), busiConferenceNumber.getDeptId(),"Hwcloud");
