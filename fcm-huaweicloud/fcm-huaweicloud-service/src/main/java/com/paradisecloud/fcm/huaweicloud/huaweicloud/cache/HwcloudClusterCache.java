 ...
 * @version V1.0  
 */
public class HwcloudClusterCache extends JavaCache<Long, BusiMcuHwcloudCluster>
{
    ...
    private static final HwcloudClusterCache INSTANCE = new HwcloudClusterCache();
     ...
     */
    private HwcloudClusterCache()
    {
    }
    
    public static HwcloudClusterCache getInstance()
    {
        return INSTANCE;
    }
}
