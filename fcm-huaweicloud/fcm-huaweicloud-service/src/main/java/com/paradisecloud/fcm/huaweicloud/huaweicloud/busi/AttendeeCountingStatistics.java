...
public class AttendeeCountingStatistics
{
    ...
    public AttendeeCountingStatistics(HwcloudConferenceContext cc)
    {
        ...
        for (AttendeeHwcloud terminalAttendee : cc.getAttendees())
        {
            total++;
        ...
        for (AttendeeHwcloud masterAttendee0 : cc.getMasterAttendees())
        {
            total++;
