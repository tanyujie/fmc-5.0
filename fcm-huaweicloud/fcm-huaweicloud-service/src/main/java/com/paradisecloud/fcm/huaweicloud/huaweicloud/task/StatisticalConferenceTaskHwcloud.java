...
public class StatisticalConferenceTaskHwcloud extends HwcloudDelayTask {

    private static final Logger LOGGER = LoggerFactory.getLogger(StatisticalConferenceTaskHwcloud.class);

    private Long deptId;

    public StatisticalConferenceTaskHwcloud(String id, long delayInMilliseconds, Long deptId) {
    ...
    @Override
    public void run() {
        LOGGER.info("tencent会议统计开始,ID:" + getId());
