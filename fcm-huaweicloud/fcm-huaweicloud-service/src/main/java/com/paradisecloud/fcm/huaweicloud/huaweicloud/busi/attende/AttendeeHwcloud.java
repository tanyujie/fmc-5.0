 ...
 * @version V1.0
 */
public abstract class AttendeeHwcloud extends BaseAttendee implements Serializable, Comparable<AttendeeHwcloud>,Cloneable
{

    private static AttendeeHwcloud instanceWithTrueValue = null;
    private static Vector<AttendeeHwcloud> allInstances = new Vector<>();
    /**
    ...
    private void operationCancel() {
        try {
            HwcloudConferenceContext HwcloudConferenceContext = HwcloudConferenceContextCache.getInstance().get(getContextKey());
            AttendeeOperation attendeeOperation = HwcloudConferenceContext.getAttendeeOperation();
    ...
    public void syncTo(AttendeeHwcloud attendee)
    {
        ...
        // 已配置的终端与会者
        if (attendee instanceof TerminalAttendeeHwcloud && this instanceof TerminalAttendeeHwcloud)
        {
            TerminalAttendeeHwcloud terminalAttendee = (TerminalAttendeeHwcloud) attendee;
            TerminalAttendeeHwcloud thisTerminalAttendee = (TerminalAttendeeHwcloud) this;
    ...
    @Override
    public int compareTo(AttendeeHwcloud o)
    {
    ...
    public boolean equals(Object o) {
        ...
        AttendeeHwcloud that = (AttendeeHwcloud) o;
        return Objects.equals(accountId, that.accountId) && Objects.equals(loginType, that.loginType);
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), accountId, loginType);
    }
    ...
    private static void resetOtherInstances() {
        for (AttendeeHwcloud instance : allInstances) {
