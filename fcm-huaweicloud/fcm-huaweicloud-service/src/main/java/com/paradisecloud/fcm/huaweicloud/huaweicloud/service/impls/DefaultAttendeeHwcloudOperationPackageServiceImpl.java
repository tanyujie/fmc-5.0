...
import com.paradisecloud.fcm.dao.mapper.BusiMcuHwcloudTemplateConferenceDefaultViewCellScreenMapper;
import com.paradisecloud.fcm.dao.mapper.BusiMcuHwcloudTemplateConferenceDefaultViewDeptMapper;
import com.paradisecloud.fcm.dao.mapper.BusiMcuHwcloudTemplateConferenceDefaultViewPaticipantMapper;
...
import com.paradisecloud.fcm.huaweicloud.huaweicloud.model.operation.CellScreen;
...
import com.paradisecloud.fcm.huaweicloud.huaweicloud.service.interfaces.IDefaultAttendeeHwcloudOperationPackageService;
...
@Transactional
@Service
public class DefaultAttendeeHwcloudOperationPackageServiceImpl implements IDefaultAttendeeHwcloudOperationPackageService
{
    ...
    @Override
    public DefaultAttendeeOperation packing(HwcloudConferenceContext conferenceContext, BusiMcuHwcloudTemplateConference tc, Map<Long, BusiMcuHwcloudTemplateParticipant> busiTemplateParticipantMap)
    {
        ...
        for (BusiMcuHwcloudTemplateConferenceDefaultViewCellScreen busiTemplateConferenceDefaultViewCellScreen : defaultViewCellScreens)
        {
        ...
        Collections.sort(defaultViewDepts, new Comparator<BusiMcuHwcloudTemplateConferenceDefaultViewDept>()
        {
            @Override
            public int compare(BusiMcuHwcloudTemplateConferenceDefaultViewDept o1, BusiMcuHwcloudTemplateConferenceDefaultViewDept o2)
            {
        ...
        Map<Integer, List<BusiMcuHwcloudTemplateConferenceDefaultViewPaticipant>> busiTemplateConferenceDefaultViewPaticipantsMap = new HashMap<>();
        Map<Long, List<BusiMcuHwcloudTemplateConferenceDefaultViewPaticipant>> deptDefaultViewPaticipantsMap = new HashMap<>();
        for (BusiMcuHwcloudTemplateConferenceDefaultViewPaticipant busiTemplateConferenceDefaultViewPaticipant : defaultViewPaticipants)
        {
            ...
            {
                List<BusiMcuHwcloudTemplateConferenceDefaultViewPaticipant> busiTemplateConferenceDefaultViewPaticipants = busiTemplateConferenceDefaultViewPaticipantsMap.get(busiTemplateConferenceDefaultViewPaticipant.getCellSequenceNumber());
                ...
                BusiMcuHwcloudTemplateParticipant busiTemplateParticipant = busiTemplateParticipantMap.get(busiTemplateConferenceDefaultViewPaticipant.getTemplateParticipantId());
                if (!Objects.isNull(busiTemplateParticipant)) {
                    ...
                    List<BusiMcuHwcloudTemplateConferenceDefaultViewPaticipant> allBusiTemplateConferenceDefaultViewPaticipants = deptDefaultViewPaticipantsMap.get(deptId);
        ...
        Comparator<BusiMcuHwcloudTemplateConferenceDefaultViewPaticipant> c = new Comparator<BusiMcuHwcloudTemplateConferenceDefaultViewPaticipant>()
        {
            @Override
            public int compare(BusiMcuHwcloudTemplateConferenceDefaultViewPaticipant o1, BusiMcuHwcloudTemplateConferenceDefaultViewPaticipant o2)
            {
                return o2.getWeight().compareTo(o1.getWeight());
            }
        };
        ...
        busiTemplateConferenceDefaultViewPaticipantsMap.forEach((screenNumber, v) -> {
            ...
            for (BusiMcuHwcloudTemplateConferenceDefaultViewPaticipant busiTemplateConferenceDefaultViewPaticipant : v)
            {
                BusiMcuHwcloudTemplateParticipant busiTemplateParticipant = busiTemplateParticipantMap.get(busiTemplateConferenceDefaultViewPaticipant.getTemplateParticipantId());
                if (!Objects.isNull(busiTemplateParticipant)) {
                    cellScreen.addAttendeeHwcloud(conferenceContext.getAttendeeById(busiTemplateParticipantMap.get(busiTemplateConferenceDefaultViewPaticipant.getTemplateParticipantId()).getUuid()));
                }
            }
        });
        ...
        List<AttendeeHwcloud> attendees = new ArrayList<>();
        ...
        defaultAttendeeOperation.setAttendeeHwclouds(attendees);
    ...
    public void updateDefaultViewConfigInfo(String conferenceId, JSONObject jsonObj)
    {
        ...
        busiTemplateConferenceDefaultViewPaticipantsMap.forEach((screenNumber, v) -> {
            ...
            for (JSONObject jo : v)
            {
                cellScreen.addAttendeeHwcloud(conferenceContext.getAttendeeById(jo.getString("participantUuId")));
            }
        });
...
//        checkRepeatAttendee(defaultAttendeeOperation, attendees);
    ...
    public JSONObject defaultViewData(String conferenceId)
    {
        ...
        List<AttendeeHwcloud> as = new ArrayList<>(conferenceContext.getAttendees());
        ...
        for (Iterator<String> iterator = conferenceContext.getMasterAttendeeIdSet().iterator(); iterator.hasNext();)
        {
            ...
            Set<AttendeeHwcloud> as0 = new HashSet<>();
            as0.add(a);
            List<AttendeeHwcloud> as00 = conferenceContext.getCascadeAttendeesMap().get(a.getDeptId());
            if (as00 != null)
            {
                as0.addAll(as00);
            }
        ...
        List<AttendeeHwcloud> attendees = defaultViewOperation.getAttendeeHwclouds();
    ...
    private void checkRepeatAttendee(DefaultAttendeeOperation defaultAttendeeOperation, List<AttendeeHwcloud> attendees)
    {
        ...
        if (defaultAttendeeOperation.getSplitScreen() != null) {
            for (CellScreen cellScreen : defaultAttendeeOperation.getSplitScreen().getCellScreens()) {
                if (!ObjectUtils.isEmpty(cellScreen.getAttendeeHwclouds())) {
                    for (AttendeeHwcloud a : cellScreen.getAttendeeHwclouds()) {
                        if (!ids.add(a.getId())) {
        ...
        for (AttendeeHwcloud a : attendees)
        {
            if (!ids.add(a.getId()))
            {
                throw new SystemException(1005247, "显示布局所选参会者存在重复：" + a.getName());
