 ...
 * @date 2021-01-20
 */
public interface IBusiMcuHwcloudHistoryConferenceService
{
    /**
     * 查询历史会议，每次挂断会保存该历史记录
     * 
     ...
     */
    BusiHistoryConference saveHistory(CoSpace cosapce, Call call, HwcloudConferenceContext conferenceContext);
    
    BusiHistoryConference saveHistory(BusiHistoryConference busiHistoryConference, HwcloudConferenceContext conferenceContext);
    ...
    BusiHistoryConference saveHistory(HwcloudConferenceContext conferenceContext);
     ...
     * @param attendee
     */
    void updateBusiHistoryParticipant(HwcloudConferenceContext conferenceContext, AttendeeHwcloud attendee, boolean updateMediaInfo);
