 ...
 * @version V1.0  
 */
public interface IDefaultAttendeeHwcloudOperationPackageService
{
     ...
     */
    DefaultAttendeeOperation packing(HwcloudConferenceContext conferenceContext, BusiMcuHwcloudTemplateConference tc, Map<Long, BusiMcuHwcloudTemplateParticipant> busiTemplateParticipantMap);
