 ...
 * @date 2021-02-17
 */
public interface IBusiMcuHwcloudDeptService
{
    ...
    ModelBean selectBusiMcuHwcloudDeptByDeptId(Long deptId);
    ...
    ModelBean toModelBean(BusiMcuHwcloudDept busiMcuHwcloudDept);
}
