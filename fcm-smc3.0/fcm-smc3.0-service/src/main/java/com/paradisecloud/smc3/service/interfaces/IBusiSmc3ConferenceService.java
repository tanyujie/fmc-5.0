 ...
 * @date 2021-02-02
 */
public interface IBusiSmc3ConferenceService
{
     ...
     */
    Smc3ConferenceContext buildTemplateConferenceContext(long templateConferenceId);
     ...
     * @param endType
     */
    void endConference(String encryptConferenceId, int endType, boolean forceEnd, boolean pushMessage);
     ...
     */
    @Transactional
    BusiMcuSmc3ConferenceAppointment extendMinutes(String conferenceId, int minutes);
     ...
     */
    void stream(Smc3ConferenceContext mainConferenceContext, Boolean streaming, String streamUrl);
    ...
    void voiceActive(String conferenceId, JSONObject jsonObject);

    void changeQuiet(String conferenceId, JSONObject jsonObject);

    void changeConferencesStatusTextTipsCaption(String conferenceId, JSONObject jsonObject);
    ...
    void lockPresenterParticipant(String conferenceId, String participantId, Boolean lock);
}
