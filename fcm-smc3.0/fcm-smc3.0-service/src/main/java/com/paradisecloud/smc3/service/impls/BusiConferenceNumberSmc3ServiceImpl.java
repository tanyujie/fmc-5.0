...
@Service
@Transactional
public class BusiConferenceNumberSmc3ServiceImpl implements IBusiConferenceNumberSmc3Service
{
    ...
    {
        long cn = busiConferenceNumberSectionService.autoGenerate(deptId,"smc3");
    ...
    {
        busiConferenceNumberSectionService.validNumber(busiConferenceNumber.getId(), busiConferenceNumber.getDeptId(),"smc3");
