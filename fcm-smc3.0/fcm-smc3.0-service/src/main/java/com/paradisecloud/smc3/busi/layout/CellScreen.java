...
public class CellScreen implements Serializable
{
     ...
     * 分屏单元格需要渲染的参会者
     */
    private List<AttendeeSmc3> attendees = new ArrayList<>();
     ...
     */
    @JsonIgnore
    private AttendeeSmc3 lastOperationAttendee;
    ...
    public void addAttendee(AttendeeSmc3 a)
    {
        attendees.add(a);
    }
     ...
     */
    public AttendeeSmc3 getLastOperationAttendee()
    {
        return lastOperationAttendee;
    }
     ...
     */
    public void setLastOperationAttendee(AttendeeSmc3 lastOperationAttendee)
    {
     ...
     */
    @JsonIgnore
    public AttendeeSmc3 getPollingAttendee()
    {
