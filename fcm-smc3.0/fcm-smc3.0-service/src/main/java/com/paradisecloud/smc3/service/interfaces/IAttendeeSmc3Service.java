 ...
 * @version V1.0  
 */
public interface IAttendeeSmc3Service
{
     ...
     * @since 2021-02-09 11:32  void
     */
    void defaultChooseSee(Smc3ConferenceContext mainConferenceContext);
    ...
    void cancelCurrentOperation(Smc3ConferenceContext conferenceContext);
     ...
     * @param conferenceId
     * @param attendeeId
     * @see IAttendeeSmc3Service#callTheRoll(String, String)
     */
     ...
     * @since 2021-02-22 18:07
     */
    void openMixing(Smc3ConferenceContext cc);
     ...
     * @param cc void
     */
    void closeMixing(Smc3ConferenceContext cc, AttendeeSmc3... excludes);
     ...
     */
    JSONObject sendMessage(String conferenceId, JSONObject jsonObject);
     ...
     * @param jsonObject void
     */
    JSONObject sendMessageForMinutes(String conferenceId, JSONObject jsonObject);
     ...
     * @param jsonObject void
     */
    JSONObject setMessageBannerText(String conferenceId, JSONObject jsonObject);
     ...
     * @param attendee void
     */
    JSONObject detail(Smc3ConferenceContext conferenceContext, AttendeeSmc3 attendee);
    ...
    void batchInvite(String conferenceId, List<BusiTerminal> attendeeSmc3s);
}
