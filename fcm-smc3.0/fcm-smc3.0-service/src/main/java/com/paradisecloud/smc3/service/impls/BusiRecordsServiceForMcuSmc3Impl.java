 ...
 */
@Service
public class BusiRecordsServiceForMcuSmc3Impl implements IBusiRecordsForMcuSmc3Service {
    ...
    public int updateBusiRecords(boolean recording, String contextKey) {
        ...
        boolean success = iBusiSmc3ConferenceService.updateCallRecordStatus(contextKey, recording);
     ...
     * @param path
     */
    private void readRecordFileName(String conferenceNumber, Smc3ConferenceContext conferenceContext, BusiRecords busiRecords, String path) {
