...
import com.paradisecloud.smc3.model.MasterPollTemplate;
...
public class SmcMultiPicPollInvoker extends SmcApiInvoker {
    ...
    public void createMultiPicPollCascade(String conferenceId, MultiPicPollRequest multiPicPollRequest, Map<String, String> headers) {
        String url = "/online/cascade-conferences/" + conferenceId + "/multiPicPoll";
        try {
            String multiPicPollRequestsTr = JSONObject.toJSONString(multiPicPollRequest);
            ClientAuthentication.httpPostVoid(meetingUrl + url, multiPicPollRequestsTr, headers);
        } catch (IOException e) {
    ...
    public void stopMultiPicPollCascade(String conferenceId, Map<String, String> headers){
        String url = "/online/cascade-conferences/" + conferenceId + "/multiPicPoll";
        try {
            JSONObject jsonObject = new JSONObject();
            jsonObject.put("pollStatus","STOP");
    ...
    public void startMultiPicPollCascade(String conferenceId, Map<String, String> headers){
        String url = "/online/cascade-conferences/" + conferenceId + "/multiPicPoll";
        try {
            JSONObject jsonObject = new JSONObject();
            jsonObject.put("pollStatus","START");
    ...
    public void cancelMultiPicPollCascade(String conferenceId, Map<String, String> headers){
        String url = "/online/cascade-conferences/" + conferenceId + "/multiPicPoll";
        try {
            JSONObject jsonObject = new JSONObject();
            jsonObject.put("pollStatus","CANCEL");
    ...
    public void pollStatusCascade(String conferenceId,String pollStatus, Map<String, String> headers){
        String url = "/online/cascade-conferences/" + conferenceId + "/multiPicPoll";
        try {
            JSONObject jsonObject = new JSONObject();
            jsonObject.put("pollStatus",pollStatus);
...
//            errorString(result);
    ...
    public MultiPicPollRequest queryMulitiPicPollCascade(String conferenceId, Map<String, String> headers) {
        String url = "/online/cascade-conferences/" + conferenceId + "/multiPicPoll";
        MultiPicPollRequest multiPicPollRequest = null;
        try {
            String result = ClientAuthentication.httpGet(meetingUrl + url, null, headers);
    ...
    public  void chairmanParticipantMultiPicPollCascade(String conferenceId, MultiPicPollRequest multiPicPollRequest, Map<String, String> meetingHeaders){
        String url = "/online/cascade-conferences/" + conferenceId + "/participants/participantMultiPicPoll";
        try {
            JSONObject jsonObject = new JSONObject();
            jsonObject.put("chairmanPoll",true);
            jsonObject.put("participantId","");
    ...
    public  void chairmanParticipantMultiPicPollOperate(String conferenceId,ChairmanPollOperateReq chairmanPollOperateReq,Map<String, String> meetingHeaders){
        ...
        try {
            ...
            if(Strings.isNotBlank(s)&&s.contains(ERROR_NO)){
                throw new CustomException("主席轮询错误");
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public  void chairmanParticipantMultiPicPollOperateCascade(String conferenceId,ChairmanPollOperateReq chairmanPollOperateReq,Map<String, String> meetingHeaders){
        String url = "/online/cascade-conferences/" + conferenceId + "/participants/participantMultiPicPoll";
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("chairmanPoll",true);
        jsonObject.put("participantId","");
