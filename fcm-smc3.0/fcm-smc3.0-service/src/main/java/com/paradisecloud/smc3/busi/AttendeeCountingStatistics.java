...
public class AttendeeCountingStatistics
{
    ...
    public AttendeeCountingStatistics(Smc3ConferenceContext cc)
    {
        ...
        for (AttendeeSmc3 terminalAttendee : cc.getAttendees())
        {
            total++;
        ...
        for (AttendeeSmc3 masterAttendee0 : cc.getMasterAttendees())
        {
            total++;
