...
public class StatisticalConferenceTaskSmc3 extends Smc3DelayTask {

    private static final Logger LOGGER = LoggerFactory.getLogger(StatisticalConferenceTaskSmc3.class);

    private Long deptId;

    public StatisticalConferenceTaskSmc3(String id, long delayInMilliseconds, Long deptId) {
    ...
    @Override
    public void run() {
        LOGGER.info("SMC3会议统计开始,ID:" + getId());
