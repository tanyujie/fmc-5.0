...
public abstract class AttendeeOperation extends BaseAttendeeOperation implements Serializable
{
     ...
     */
    @JsonIgnore
    protected volatile Smc3ConferenceContext conferenceContext;
     ...
     */
    protected volatile List<AttendeeSmc3> attendees;
    ...
    @JsonIgnore
    protected List<AttendeeSmc3> operatedAttendees = new ArrayList<>();
     ...
     */
    protected AttendeeOperation(Smc3ConferenceContext conferenceContext)
    {
        super();
     ...
     * @param splitScreen 
     */
    protected AttendeeOperation(Smc3ConferenceContext conferenceContext, SplitScreen splitScreen)
    {
    ...
    protected AttendeeOperation(Smc3ConferenceContext conferenceContext, List<AttendeeSmc3> attendees)
    {
        this(conferenceContext);
     ...
     * @param attendees 
     */
    protected AttendeeOperation(Smc3ConferenceContext conferenceContext, SplitScreen splitScreen, List<AttendeeSmc3> attendees)
    {
     ...
     */
    public List<AttendeeSmc3> getOperatedAttendees()
    {
        return operatedAttendees;
    }
    ...
    public void addOperatedAttendee(AttendeeSmc3 a)
    {
