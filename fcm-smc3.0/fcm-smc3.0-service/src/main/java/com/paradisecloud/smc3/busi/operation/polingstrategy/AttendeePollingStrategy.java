...
public abstract class AttendeePollingStrategy
{
     ...
     */
    public abstract List<PollingAttendee> parse(Smc3ConferenceContext conferenceContext, List<DeptPollingAttendees> deptPollingAttendeesList);
    
    protected List<PollingAttendee> parseSpecifiedRangeAndDeptFirst(Smc3ConferenceContext conferenceContext, List<DeptPollingAttendees> deptPollingAttendeesList)
    {
     ...
     * @return List<PollingAttendee>
     */
    protected List<PollingAttendee> parseGlobalPolling(Smc3ConferenceContext conferenceContext, Map<String, PollingAttendee> m)
    {
        List<PollingAttendee> pollingAttendeeList = new ArrayList<>();
     ...
     * @return List<PollingAttendee>
     */
    protected List<PollingAttendee> parseGlobalPollingAndDeptFirst(Smc3ConferenceContext conferenceContext, Map<String, PollingAttendee> m)
    {
        List<PollingAttendee> pollingAttendeeList = new ArrayList<>();
        if (conferenceContext.getMasterAttendee() != null)
        {
        ...
        for (AttendeeSmc3 attendee : new ArrayList<>(conferenceContext.getMasterAttendees()))
        {
            add(pollingAttendeeList, attendee, m);
        }
    ...
    private void add(List<PollingAttendee> pollingAttendeeList, AttendeeSmc3 a, Map<String, PollingAttendee> m)
    {
